/*
 * Library for PIC16CR84
 * 
 * Architecture: 16xxxx
 */
library microchip.PIC16CR84;
 ...
 ************************/
	 ...
	 */
		/* Code Protection Off */
		const uint16 CONFIG1_CP_OFF = 0x3f7*16;
	 ...
	 */
		/* Code Protection Off */
		const uint16 CONFIG1_DP_OFF = 0x1*16384;
		/* Data memory is code protected */
		const uint16 CONFIG1_DP_ON = 0x0*16384;
