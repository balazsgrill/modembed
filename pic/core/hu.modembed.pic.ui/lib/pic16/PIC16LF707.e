/*
 * Library for PIC16LF707
 * 
 * Architecture: 16xxxx
 */
library microchip.PIC16LF707{
 ...
 ************************/
	 ...
	 */
		...
		const uint8 CONFIG_FOSC_EXTRC = 0x7*1;
		...
		const uint8 CONFIG_FOSC_INTOSC = 0x5*1;
