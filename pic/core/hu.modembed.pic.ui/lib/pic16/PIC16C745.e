/*
 * Library for PIC16C745
 * 
 * Architecture: 16xxxx
 */
library microchip.PIC16C745;
 ...
 ************************/
	 ...
	 */
		...
		const uint16 CONFIG1_FOSC_E4 = 0x3*1;
		/* HS oscillator */
		const uint16 CONFIG1_FOSC_HS = 0x0*1;
		/* External clock. CLKOUT on OSC2 pin */
		const uint16 CONFIG1_FOSC_EC = 0x1*1;
		/* HS osc with 4x PLL enabled */
		const uint16 CONFIG1_FOSC_H4 = 0x2*1;
	/*
	 * Field: WDTE
