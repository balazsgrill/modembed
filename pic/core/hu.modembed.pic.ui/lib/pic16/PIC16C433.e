 ...
 ************************/
	 ...
	 */
		/* Code protection off */
		const uint16 CONFIG1_CP_OFF = 0x1fb*32;
		/* 0400h-07FEh code protected */
		const uint16 CONFIG1_CP_50 = 0x152*32;
		/* 0200h-07FEh code protected */
		const uint16 CONFIG1_CP_75 = 0xa9*32;
		/* All memory is code protected */
		const uint16 CONFIG1_CP_ALL = 0x0*32;
	/*
	 * Field: MCLRE
	 * Master Clear Enable
	 */
		/* External */
		const uint16 CONFIG1_MCLRE_ON = 0x1*16384;
		/* Internal */
		const uint16 CONFIG1_MCLRE_OFF = 0x0*16384;
