 ...
 ************************/
	 ...
	 */
		/* BOD enabled */
		const uint16 CONFIG_BOREN_ON = 0x1*64;
		/* BOD disabled */
		const uint16 CONFIG_BOREN_OFF = 0x0*64;
	/*
	 * Field: CP
	 * Code Protection bit
	 */
	 ...
	 */
		...
		const uint16 CONFIG_CPD_OFF = 0x1*256;
		/* Data memory code protection is enabled */
		const uint16 CONFIG_CPD_ON = 0x0*256;
	/*
	 * Field: BG
	 * Bandgap Calibration bits for BOD and POR voltage
	 */
		/* Highest bandgap voltage */
		const uint16 CONFIG_BG_3 = 0x3*512;
		/* . */
		const uint16 CONFIG_BG_2 = 0x2*512;
		/* . */
		const uint16 CONFIG_BG_1 = 0x1*512;
		/* Lowest bandgap voltage */
		const uint16 CONFIG_BG_0 = 0x0*512;
