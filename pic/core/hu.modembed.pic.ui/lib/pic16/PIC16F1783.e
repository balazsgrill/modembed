/*
 * Library for PIC16F1783
 * 
 * Architecture: 16Exxx
 */
library microchip.PIC16F1783;
 ...
 ************************/
	 ...
	 */
		...
		const uint16 CONFIG2_VCAPEN0_OFF = 0x1*4;
		/* Vcap functionality is enabled on RA0 (Vddcore is connected to the pad) */
		const uint16 CONFIG2_VCAPEN0_ON = 0x0*4;
	/*
	 * Field: VCAPEN1
	 * 
	 */
		/* Vcap finctionality is disabled on RA6 */
		const uint16 CONFIG2_VCAPEN1_OFF = 0x1*8;
		/* Vcap functionality is enabled on RA6 (Vddcore is connected to the pad) */
		const uint16 CONFIG2_VCAPEN1_ON = 0x0*8;
	/*
	 * Field: PLLEN
	 * PLL Enable
	 */
