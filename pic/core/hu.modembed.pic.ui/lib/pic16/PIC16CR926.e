/*
 * Library for PIC16CR926
 * 
 * Architecture: 16xxxx
 */
library microchip.PIC16CR926{
 ...
 ************************/
	 ...
	 */
		/* Code protection off */
		const uint8 CONFIG1_CP_OFF = 0x3*16;
		/* 0000h-0FFFh code protected */
		const uint8 CONFIG1_CP_50 = 0x2*16;
		/* 0000h-1EFFh code protected */
		const uint8 CONFIG1_CP_75 = 0x1*16;
