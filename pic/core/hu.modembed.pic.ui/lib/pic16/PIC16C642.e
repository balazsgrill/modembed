 ...
 ************************/
	 ...
	 */
		/* Code protection off */
		const uint16 CONFIG_CP_OFF = 0x3f3*16;
		/* 0800h-0FFFh code protected */
		const uint16 CONFIG_CP_50 = 0x2a2*16;
		/* 0400h-0FFFh code protected */
		const uint16 CONFIG_CP_75 = 0x151*16;
	 ...
	 */
		...
		const uint16 CONFIG_MPEEN_ON = 0x1*32768;
		/* Memory Parity Checking is disabled */
		const uint16 CONFIG_MPEEN_OFF = 0x0*32768;
