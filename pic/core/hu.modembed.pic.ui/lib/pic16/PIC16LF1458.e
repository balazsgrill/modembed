/*
 * Library for PIC16LF1458
 * 
 * Architecture: 16Exxx
 */
library microchip.PIC16LF1458{
 ...
 ************************/
	 ...
	 */
		...
		const uint8 CONFIG1_CLKOUTEN_OFF = 0x1*1024;
		/* CLKOUT function is enabled on the CLKOUT pin */
		const uint8 CONFIG1_CLKOUTEN_ON = 0x0*1024;
	/*
	 * Field: IESO
	 * Internal/External Switchover Mode
	 */
		/* Internal/External Switchover Mode is enabled */
		const uint8 CONFIG1_IESO_ON = 0x1*2048;
		/* Internal/External Switchover Mode is disabled */
		const uint8 CONFIG1_IESO_OFF = 0x0*2048;
	/*
	 * Field: FCMEN
	 * Fail-Safe Clock Monitor Enable
	 */
		/* Fail-Safe Clock Monitor is enabled */
		const uint8 CONFIG1_FCMEN_ON = 0x1*4096;
		/* Fail-Safe Clock Monitor is disabled */
		const uint8 CONFIG1_FCMEN_OFF = 0x0*4096;
	/*
	 * Field: WRT
