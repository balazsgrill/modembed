/*
 * Library for PIC16F873
 * 
 * Architecture: 16xxxx
 */
library microchip.PIC16F873{
 ...
 ************************/
	 ...
	 */
		/* RC oscillator */
		const uint8 CONFIG_FOSC_EXTRC = 0x3*1;
		/* HS oscillator */
