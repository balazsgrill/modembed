/*
 * Library for PIC16F886
 * 
 * Architecture: 16xxxx
 */
library microchip.PIC16F886{
 ...
 ************************/
	 ...
	 */
		...
		const uint8 CONFIG1_CPD_OFF = 0x1*128;
		/* Data memory code protection is enabled */
		const uint8 CONFIG1_CPD_ON = 0x0*128;
	/*
	 * Field: BOREN
	 ...
	 */
		...
		const uint8 CONFIG1_IESO_ON = 0x1*1024;
		/* Internal/External Switchover mode is disabled */
		const uint8 CONFIG1_IESO_OFF = 0x0*1024;
	/*
	 * Field: FCMEN
	 * Fail-Safe Clock Monitor Enabled bit
	 */
		/* Fail-Safe Clock Monitor is enabled */
		const uint8 CONFIG1_FCMEN_ON = 0x1*2048;
		/* Fail-Safe Clock Monitor is disabled */
		const uint8 CONFIG1_FCMEN_OFF = 0x0*2048;
	/*
	 * Field: LVP
	 * Low Voltage Programming Enable bit
	 */
		/* RB3/PGM pin has PGM function, low voltage programming enabled */
		const uint8 CONFIG1_LVP_ON = 0x1*4096;
		/* RB3 pin has digital I/O, HV on MCLR must be used for programming */
		const uint8 CONFIG1_LVP_OFF = 0x0*4096;
	/*
	 * Field: DEBUG
	 ...
	 */
		...
		const uint8 CONFIG2_BOR4V_BOR21V = 0x0*1;
		/* Brown-out Reset set to 4.0V */
		const uint8 CONFIG2_BOR4V_BOR40V = 0x1*1;
	/*
	 * Field: WRT
