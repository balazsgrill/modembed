/*
 * Library for PIC16F1933
 * 
 * Architecture: 16Exxx
 */
library microchip.PIC16F1933{
 ...
 ************************/
	 ...
	 */
		...
		const uint8 CONFIG2_VCAPEN_OFF = 0x3*4;
		/* VCAP functionality is enabled on RA6 */
		const uint8 CONFIG2_VCAPEN_RA6 = 0x2*4;
		/* VCAP functionality is enabled on RA5 */
		const uint8 CONFIG2_VCAPEN_RA5 = 0x1*4;
		/* VCAP functionality is enabled on RA0 */
		const uint8 CONFIG2_VCAPEN_RA0 = 0x0*4;
	/*
	 * Field: PLLEN
	 * PLL Enable
	 */
	 ...
	 */
		...
		const uint8 CONFIG2_DEBUG_OFF = 0x1*128;
		/* In-Circuit Debugger enabled, ICSPCLK and ICSPDAT are dedicated to the debugger */
		const uint8 CONFIG2_DEBUG_ON = 0x0*128;
	/*
	 * Field: LVP
	 * Low-Voltage Programming Enable
	 */
		/* Low-voltage programming enabled */
		const uint8 CONFIG2_LVP_ON = 0x1*256;
		/* High-voltage on MCLR/VPP must be used for programming */
		const uint8 CONFIG2_LVP_OFF = 0x0*256;
