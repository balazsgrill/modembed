/*
 * Library for PIC16C715
 * 
 * Architecture: 16xxxx
 */
library microchip.PIC16C715{
 ...
 ************************/
	 ...
	 */
		/* BOR enabled */
		const uint8 CONFIG1_BOREN_ON = 0x1*16384;
		/* BOR disabled */
		const uint8 CONFIG1_BOREN_OFF = 0x0*16384;
	/*
	 * Field: MPEEN
	 * Memory Parity Error Enable
	 */
		/* Memory Parity Checking is enabled */
		const uint8 CONFIG1_MPEEN_ON = 0x1*32768;
		/* Memory Parity Checking is disabled */
		const uint8 CONFIG1_MPEEN_OFF = 0x0*32768;
