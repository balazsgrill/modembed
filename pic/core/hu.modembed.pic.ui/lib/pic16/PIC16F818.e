/*
 * Library for PIC16F818
 * 
 * Architecture: 16xxxx
 */
library microchip.PIC16F818{
 ...
 ************************/
	 ...
	 */
		...
		const uint16 CONFIG_WRT_512 = 0x2*2048;
		/* 0000h to 03FFh write-protected */
		const uint16 CONFIG_WRT_1024 = 0x1*2048;
	/*
	 * Field: DEBUG
	 ...
	 */
		...
		const uint16 CONFIG_CCPMX_RB2 = 0x1*16384;
		/* CCP1 function on RB3 */
		const uint16 CONFIG_CCPMX_RB3 = 0x0*16384;
	/*
	 * Field: CP
	 * Flash Program Memory Code Protection bit
	 */
		/* Code protection off */
		const uint16 CONFIG_CP_OFF = 0x1*32768;
		/* All memory locations code-protected */
		const uint16 CONFIG_CP_ON = 0x0*32768;
