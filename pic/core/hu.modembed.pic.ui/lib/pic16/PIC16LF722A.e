/*
 * Library for PIC16LF722A
 * 
 * Architecture: 16xxxx
 */
library microchip.PIC16LF722A{
 ...
 ************************/
	 ...
	 */
		/* Reserved */
		const uint8 CONFIG1_RES_ = 0x1*128;
	/*
	 * Field: BOREN
	 ...
	 */
		...
		/* BOR disabled */
		const uint8 CONFIG1_BOREN_OFF = 0x1*256;
		/* BOR disabled */
