/*
 * Library for PIC16LF1829
 * 
 * Architecture: 16Exxx
 */
library microchip.PIC16LF1829{
 ...
 ************************/
	 ...
	 */
		...
		const uint8 CONFIG2_VCOREV_OFF = 0x1*4;
		/* VDDCORE pin functionality is enabled */
		const uint8 CONFIG2_VCOREV_ON = 0x0*4;
	/*
	 * Field: PLLEN
	 * PLL Enable
	 */
		/* 4x PLL enabled */
		const uint8 CONFIG2_PLLEN_ON = 0x1*8;
		/* 4x PLL disabled */
		const uint8 CONFIG2_PLLEN_OFF = 0x0*8;
	/*
	 * Field: STVREN
	 * Stack Overflow/Underflow Reset Enable
	 */
		/* Stack Overflow or Underflow will cause a Reset */
		const uint8 CONFIG2_STVREN_ON = 0x1*16;
		/* Stack Overflow or Underflow will not cause a Reset */
		const uint8 CONFIG2_STVREN_OFF = 0x0*16;
	/*
	 * Field: BORV
	 * Brown-out Reset Voltage Selection
	 */
		/* Brown-out Reset Voltage (Vbor), low trip point selected. */
		const uint8 CONFIG2_BORV_LO = 0x1*32;
		/* Brown-out Reset Voltage (Vbor), high trip point selected. */
		const uint8 CONFIG2_BORV_HI = 0x0*32;
	/*
	 * Field: DEBUG
