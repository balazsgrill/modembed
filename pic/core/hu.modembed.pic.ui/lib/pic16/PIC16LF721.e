/*
 * Library for PIC16LF721
 * 
 * Architecture: 16xxxx
 */
library microchip.PIC16LF721;
 ...
 ************************/
	 ...
	 */
		...
		const uint16 CONFIG1_MCLRE_ON = 0x1*16;
		/* RA3/MCLR/VPP pin function is digital input; MCLR internally disabled; Weak pull-up disabled */
		const uint16 CONFIG1_MCLRE_OFF = 0x0*16;
	/*
	 * Field: CP
	 * Flash Program Memory Code Protection bit
	 */
		/* 0000h to 0FFFh code protection on */
		const uint16 CONFIG1_CP_ON = 0x0*32;
		/* Code protection off */
		const uint16 CONFIG1_CP_OFF = 0x1*32;
	/*
	 * Field: BOREN
	 ...
	 */
		...
		const uint16 CONFIG1_BOREN_NSLEEP = 0x2*64;
		/* Brown-out Reset enabled */
		const uint16 CONFIG1_BOREN_ON = 0x3*64;
	/*
	 * Field: PLLEN
	 * INTOSC PLLEN Enable Bit
	 */
		/* INTOSC Frequency is 500 kHz */
		const uint16 CONFIG1_PLLEN_OFF = 0x0*256;
		/* INTOSC Frequency is 16 MHz (32x) */
		const uint16 CONFIG1_PLLEN_ON = 0x1*256;
	/*
	 * Field: DEBUG
	 * Debugger Mode
	 */
		/* Background debugger is enabled */
		const uint16 CONFIG1_DEBUG_ON = 0x0*512;
		/* Background debugger is disabled */
		const uint16 CONFIG1_DEBUG_OFF = 0x1*512;
	/*
	 * Field: WRTEN
