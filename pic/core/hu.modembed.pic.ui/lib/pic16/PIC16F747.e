/*
 * Library for PIC16F747
 * 
 * Architecture: 16xxxx
 */
library microchip.PIC16F747{
 ...
 ************************/
	 ...
	 */
		/* VBOR set to 2.0V */
		const uint16 CONFIG1_BORV_20 = 0x3*512;
		/* VBOR set to 2.7V */
		const uint16 CONFIG1_BORV_27 = 0x2*512;
		/* VBOR set to 4.2V */
		const uint16 CONFIG1_BORV_42 = 0x1*512;
		/* VBOR set to 4.5V */
		const uint16 CONFIG1_BORV_45 = 0x0*512;
	/*
	 * Field: DEBUG
	 * In-Circuit Debugger Mode bit
	 */
		/* In-Circuit Debugger disabled, RB6 and RB7 are general purpose I/O pins */
		const uint16 CONFIG1_DEBUG_OFF = 0x1*2048;
		/* In-Circuit Debugger enabled, RB6 and RB7 are dedicated to the debugger */
		const uint16 CONFIG1_DEBUG_ON = 0x0*2048;
	/*
	 * Field: CCP2MX
	 * CCP2 Multiplex bit
	 */
		/* CCP2 is on RC1 */
		const uint16 CONFIG1_CCP2MX_RC1 = 0x1*4096;
		/* CCP2 is on RB3 */
		const uint16 CONFIG1_CCP2MX_RB3 = 0x0*4096;
	/*
	 * Field: CP
	 * Flash Program Memory Code Protection bits
	 */
		/* Code protection off */
		const uint16 CONFIG1_CP_OFF = 0x1*8192;
		/* 0000h to 0FFFh code-protected */
		const uint16 CONFIG1_CP_ON = 0x0*8192;
	/*
	 * Field: FCMEN
	 ...
	 */
		/* Enabled */
		const uint16 CONFIG2_BORSEN_ON = 0x1*4;
		/* Disabled */
		const uint16 CONFIG2_BORSEN_OFF = 0x0*4;
