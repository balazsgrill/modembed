/*
 * Library for PIC18F65J50
 * 
 * Architecture: 18xxxx
 */
library microchip.PIC18F65J50;
 ...
 * 
 */
reg uint16 PMSTAT : 0xf40; 

/*
 * PMEN
 * 
 */
reg uint16 PMEN : 0xf42; 

/*
 * PMDIN2
 * 
 */
reg uint16 PMDIN2 : 0xf44; 

/*
 * PMDOUT2
 * 
 */
reg uint16 PMDOUT2 : 0xf46; 

/*
 * PMMODE
 * 
 */
reg uint16 PMMODE : 0xf48; 

/*
 * PMCON
 * 
 */
reg uint16 PMCON : 0xf4a; 

/*
 * UEP0
 * 
 */
reg uint8 UEP0 : 0xf4c; 

/*
 * UEP1
 * 
 */
reg uint8 UEP1 : 0xf4d; 

/*
 * UEP2
 * 
 */
reg uint8 UEP2 : 0xf4e; 

/*
 * UEP3
 * 
 */
reg uint8 UEP3 : 0xf4f; 

/*
 * UEP4
 * 
 */
reg uint8 UEP4 : 0xf50; 

/*
 * UEP5
 * 
 */
reg uint8 UEP5 : 0xf51; 

/*
 * UEP6
 * 
 */
reg uint8 UEP6 : 0xf52; 

/*
 * UEP7
 * 
 */
reg uint8 UEP7 : 0xf53; 

/*
 * UEP8
 * 
 */
reg uint8 UEP8 : 0xf54; 

/*
 * UEP9
 * 
 */
reg uint8 UEP9 : 0xf55; 

/*
 * UEP10
 * 
 */
reg uint8 UEP10 : 0xf56; 

/*
 * UEP11
 * 
 */
reg uint8 UEP11 : 0xf57; 

/*
 * UEP12
 * 
 */
reg uint8 UEP12 : 0xf58; 

/*
 * UEP13
 * 
 */
reg uint8 UEP13 : 0xf59; 

/*
 * UEP14
 * 
 */
reg uint8 UEP14 : 0xf5a; 

/*
 * UEP15
 * 
 */
reg uint8 UEP15 : 0xf5b; 
 ...
 * 
 */
reg uint8 UEIE : 0xf5d; 

/*
 * UADDR
 * 
 */
reg uint8 UADDR : 0xf5e; 

/*
 * UCFG
 * 
 */
reg uint8 UCFG : 0xf5f; 
 ...
 * 
 */
reg uint16 TMR1 : 0xfc7; 

/*
 * RCON
 * 
 */
reg uint8 RCON : 0xfc9; 

/*
 * CM2CON1
 * 
 */
reg uint8 CM2CON1 : 0xfca; 

/*
 * CM1CON1
 * 
 */
reg uint8 CM1CON1 : 0xfcb; 

/*
 * T0CON
 * 
 */
reg uint8 T0CON : 0xfcd; 

/*
 * TMR0
 * 
 */
reg uint16 TMR0 : 0xfce; 

/*
 * STATUS
 * 
 */
reg uint8 STATUS : 0xfd0; 

/*
 * FSR2
 * 
 */
reg uint16 FSR2 : 0xfd1; 

/*
 * PLUSW2
 * 
 */
reg uint8 PLUSW2 : 0xfd3; 

/*
 * PREINC2
 * 
 */
reg uint8 PREINC2 : 0xfd4; 

/*
 * POSTDEC2
 * 
 */
reg uint8 POSTDEC2 : 0xfd5; 

/*
 * POSTINC2
 * 
 */
reg uint8 POSTINC2 : 0xfd6; 

/*
 * INDF2
 * 
 */
reg uint8 INDF2 : 0xfd7; 
 ...
 * 
 */
reg uint16 FSR1 : 0xfd9; 

/*
 * PLUSW1
 * 
 */
reg uint8 PLUSW1 : 0xfdb; 

/*
 * PREINC1
 * 
 */
reg uint8 PREINC1 : 0xfdc; 

/*
 * POSTDEC1
 * 
 */
reg uint8 POSTDEC1 : 0xfdd; 

/*
 * POSTINC1
 * 
 */
reg uint8 POSTINC1 : 0xfde; 

/*
 * INDF1
 * 
 */
reg uint8 INDF1 : 0xfdf; 

/*
 * WREG
 * 
 */
reg uint8 WREG : 0xfe0; 

/*
 * FSR0
 * 
 */
reg uint16 FSR0 : 0xfe1; 

/*
 * PLUSW0
 * 
 */
reg uint8 PLUSW0 : 0xfe3; 

/*
 * PREINC0
 * 
 */
reg uint8 PREINC0 : 0xfe4; 

/*
 * POSTDEC0
 * 
 */
reg uint8 POSTDEC0 : 0xfe5; 

/*
 * POSTINC0
 * 
 */
reg uint8 POSTINC0 : 0xfe6; 

/*
 * INDF0
 * 
 */
reg uint8 INDF0 : 0xfe7; 

/*
 * INTCON3
 * 
 */
reg uint8 INTCON3 : 0xfe8; 

/*
 * INTCON2
 * 
 */
reg uint8 INTCON2 : 0xfe9; 

/*
 * INTCON
 * 
 */
reg uint8 INTCON : 0xfea; 

/*
 * PROD
 * 
 */
reg uint16 PROD : 0xfeb; 

/*
 * TABLAT
 * 
 */
reg uint8 TABLAT : 0xfed; 

/*
 * TBLPTR
 * 
 */
reg uint8 TBLPTR : 0xfee; 

/*
 * PCLAT
 * 
 */
reg uint8 PCLAT : 0xff1; 

/*
 * STKPTR
 * 
 */
reg uint8 STKPTR : 0xff4; 
