 ...
 * <ul>
 *   <li>{@link hu.modembed.model.pic.impl.ConfigLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConfigLiteralImpl extends NamedElementImpl implements ConfigLiteral {
	...
	protected EClass eStaticClass() {
		return PicPackage.Literals.CONFIG_LITERAL;
	}
	...
	public void setValue(long newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PicPackage.CONFIG_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PicPackage.CONFIG_LITERAL__VALUE:
				return getValue();
		}
