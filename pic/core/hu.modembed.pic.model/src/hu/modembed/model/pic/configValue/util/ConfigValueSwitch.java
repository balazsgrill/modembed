 ...
 * @generated
 */
public class ConfigValueSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ConfigValuePackage.PIC_CONFIGURATION_VALUE: {
				PICConfigurationValue picConfigurationValue = (PICConfigurationValue)theEObject;
				T result = casePICConfigurationValue(picConfigurationValue);
				if (result == null) result = caseRootElement(picConfigurationValue);
				if (result == null) result = caseNamedElement(picConfigurationValue);
				if (result == null) result = caseMODembedElement(picConfigurationValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConfigValuePackage.CONFIGURATION_SELECTION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>PIC Configuration Value</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>PIC Configuration Value</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePICConfigurationValue(PICConfigurationValue object) {
		return null;
	}
