...
public class PortPeripheral implements IPeripheral, IMemory {
	...
	/* (non-Javadoc)
	 * @see hu.cubussapiens.modembed.pic.simulator.IPeripheral#register(hu.cubussapiens.modembed.pic.simulator.generic.ram.MappedRAM, hu.cubussapiens.modembed.pic.simulator.IProgramContext)
	 */
	@Override
