...
import hu.cubussapiens.modembed.pic.simulator.ICore;
...
import hu.cubussapiens.modembed.pic.simulator.generic.IOperation;
...
public class PicBaselineCore implements ICore, IRegisters{
	...
	/* (non-Javadoc)
	 * @see hu.cubussapiens.modembed.pic.simulator.ICore#setProgramMem(hu.cubussapiens.modembed.pic.simulator.IMemory)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see hu.cubussapiens.modembed.pic.simulator.ICore#getProgramMem()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see hu.cubussapiens.modembed.pic.simulator.ICore#execute(long, hu.cubussapiens.modembed.pic.simulator.IProgramContext)
	 */
	@Override
