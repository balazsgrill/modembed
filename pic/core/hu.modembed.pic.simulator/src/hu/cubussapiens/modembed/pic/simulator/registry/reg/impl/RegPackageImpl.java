...
import hu.cubussapiens.modembed.pic.simulator.registry.reg.Category;
import hu.cubussapiens.modembed.pic.simulator.registry.reg.Device;
import hu.cubussapiens.modembed.pic.simulator.registry.reg.RegFactory;
import hu.cubussapiens.modembed.pic.simulator.registry.reg.RegPackage;
...
public class RegPackageImpl extends EPackageImpl implements RegPackage {
	 ...
	 * @see hu.cubussapiens.modembed.pic.simulator.registry.reg.RegPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getCategory_Devices() {
	 ...
	 * @generated
	 */
	public EAttribute getDevice_Unit() {
	...
	public void createPackageContents() {
		...
		createEReference(categoryEClass, CATEGORY__DEVICES);

		deviceEClass = createEClass(DEVICE);
		createEAttribute(deviceEClass, DEVICE__NAME);
		createEAttribute(deviceEClass, DEVICE__UNIT);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getCategory_Devices(), this.getDevice(), null, "devices", null, 0, -1, Category.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDevice_Unit(), ecorePackage.getEString(), "unit", null, 0, 1, Device.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
