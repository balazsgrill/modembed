...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Cal Data Zone Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link crownking.edc.impl.CalDataZoneTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link crownking.edc.impl.CalDataZoneTypeImpl#getBeginaddr <em>Beginaddr</em>}</li>
 *   <li>{@link crownking.edc.impl.CalDataZoneTypeImpl#getEndaddr <em>Endaddr</em>}</li>
 *   <li>{@link crownking.edc.impl.CalDataZoneTypeImpl#getIssection <em>Issection</em>}</li>
 *   <li>{@link crownking.edc.impl.CalDataZoneTypeImpl#getRegionid <em>Regionid</em>}</li>
 *   <li>{@link crownking.edc.impl.CalDataZoneTypeImpl#getSectiondesc <em>Sectiondesc</em>}</li>
 *   <li>{@link crownking.edc.impl.CalDataZoneTypeImpl#getSectionname <em>Sectionname</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CalDataZoneTypeImpl extends EObjectImpl implements CalDataZoneType {
	/**
	...
	protected EClass eStaticClass() {
		return EdcPackage.eINSTANCE.getCalDataZoneType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.CAL_DATA_ZONE_TYPE__VALUE, oldValue, value));
	}
	...
	public void setBeginaddr(String newBeginaddr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.CAL_DATA_ZONE_TYPE__BEGINADDR, oldBeginaddr, beginaddr));
	}
	...
	public void setEndaddr(String newEndaddr) {
		...
		endaddr = newEndaddr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.CAL_DATA_ZONE_TYPE__ENDADDR, oldEndaddr, endaddr));
	}
	...
	public void setIssection(String newIssection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.CAL_DATA_ZONE_TYPE__ISSECTION, oldIssection, issection));
	}
	...
	public void setRegionid(String newRegionid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.CAL_DATA_ZONE_TYPE__REGIONID, oldRegionid, regionid));
	}
	...
	public void setSectiondesc(String newSectiondesc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.CAL_DATA_ZONE_TYPE__SECTIONDESC, oldSectiondesc, sectiondesc));
	}
	...
	public void setSectionname(String newSectionname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.CAL_DATA_ZONE_TYPE__SECTIONNAME, oldSectionname, sectionname));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EdcPackage.CAL_DATA_ZONE_TYPE__VALUE:
				return getValue();
			case EdcPackage.CAL_DATA_ZONE_TYPE__BEGINADDR:
				return getBeginaddr();
			case EdcPackage.CAL_DATA_ZONE_TYPE__ENDADDR:
				return getEndaddr();
			case EdcPackage.CAL_DATA_ZONE_TYPE__ISSECTION:
				return getIssection();
			case EdcPackage.CAL_DATA_ZONE_TYPE__REGIONID:
				return getRegionid();
			case EdcPackage.CAL_DATA_ZONE_TYPE__SECTIONDESC:
				return getSectiondesc();
			case EdcPackage.CAL_DATA_ZONE_TYPE__SECTIONNAME:
