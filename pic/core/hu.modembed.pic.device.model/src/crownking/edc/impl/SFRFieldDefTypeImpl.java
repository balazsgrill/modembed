...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>SFR Field Def Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getDCRFieldSemantic <em>DCR Field Semantic</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getAliasList <em>Alias List</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getSFRModeList <em>SFR Mode List</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getStimInfo <em>Stim Info</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getModuleMacro <em>Module Macro</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getModuleExclude <em>Module Exclude</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getSFRDef <em>SFR Def</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getChecksum <em>Checksum</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getSFRFieldSemantic <em>SFR Field Semantic</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getBegin <em>Begin</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getCname <em>Cname</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getDesc <em>Desc</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getEnd <em>End</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getImpl <em>Impl</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getIshidden <em>Ishidden</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getIsidehidden <em>Isidehidden</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getIsindirect <em>Isindirect</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getIslanghidden <em>Islanghidden</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getIslnaghidden <em>Islnaghidden</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getIsvolatile <em>Isvolatile</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getMask <em>Mask</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getMclr <em>Mclr</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getModsrc <em>Modsrc</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getNzsize <em>Nzsize</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getNzwidth <em>Nzwidth</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getPor <em>Por</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRFieldDefTypeImpl#getRegionidref <em>Regionidref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SFRFieldDefTypeImpl extends EObjectImpl implements SFRFieldDefType {
	/**
	...
	protected EClass eStaticClass() {
		return EdcPackage.eINSTANCE.getSFRFieldDefType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, EdcPackage.SFR_FIELD_DEF_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public FeatureMap getGroup() {
		return (FeatureMap)getMixed().<FeatureMap.Entry>list(EdcPackage.eINSTANCE.getSFRFieldDefType_Group());
	}
	...
	public EList<DCRFieldSemanticType> getDCRFieldSemantic() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRFieldDefType_DCRFieldSemantic());
	}
	 ...
	 * @generated
	 */
	public EList<AliasListType5> getAliasList() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRFieldDefType_AliasList());
	}
	...
	public EList<SFRModeListType> getSFRModeList() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRFieldDefType_SFRModeList());
	}
	...
	public EList<StimInfoType> getStimInfo() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRFieldDefType_StimInfo());
	}
	...
	public EList<ModuleMacroType> getModuleMacro() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRFieldDefType_ModuleMacro());
	}
	...
	public EList<ModuleExcludeType> getModuleExclude() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRFieldDefType_ModuleExclude());
	}
	...
	public EList<SFRDefType> getSFRDef() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRFieldDefType_SFRDef());
	}
	...
	public EList<ChecksumType> getChecksum() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRFieldDefType_Checksum());
	}
	...
	public EList<SFRFieldSemanticType> getSFRFieldSemantic() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRFieldDefType_SFRFieldSemantic());
	}
	...
	public void setAccess(String newAccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__ACCESS, oldAccess, access));
	}
	...
	public void setBegin(String newBegin) {
		...
		begin = newBegin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__BEGIN, oldBegin, begin));
	}
	...
	public void setCname(String newCname) {
		...
		cname = newCname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__CNAME, oldCname, cname));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__DESC, oldDesc, desc));
	}
	...
	public void setEnd(String newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__END, oldEnd, end));
	}
	...
	public void setImpl(String newImpl) {
		...
		impl = newImpl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__IMPL, oldImpl, impl));
	}
	...
	public void setIshidden(String newIshidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__ISHIDDEN, oldIshidden, ishidden));
	}
	...
	public void setIsidehidden(String newIsidehidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__ISIDEHIDDEN, oldIsidehidden, isidehidden));
	}
	...
	public void setIsindirect(String newIsindirect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__ISINDIRECT, oldIsindirect, isindirect));
	}
	...
	public void setIslanghidden(String newIslanghidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__ISLANGHIDDEN, oldIslanghidden, islanghidden));
	}
	...
	public void setIslnaghidden(String newIslnaghidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__ISLNAGHIDDEN, oldIslnaghidden, islnaghidden));
	}
	...
	public void setIsvolatile(String newIsvolatile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__ISVOLATILE, oldIsvolatile, isvolatile));
	}
	...
	public void setMask(String newMask) {
		...
		mask = newMask;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__MASK, oldMask, mask));
	}
	...
	public void setMclr(String newMclr) {
		...
		mclr = newMclr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__MCLR, oldMclr, mclr));
	}
	...
	public void setModsrc(String newModsrc) {
		...
		modsrc = newModsrc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__MODSRC, oldModsrc, modsrc));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__NAME, oldName, name));
	}
	...
	public void setNzsize(String newNzsize) {
		...
		nzsize = newNzsize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__NZSIZE, oldNzsize, nzsize));
	}
	...
	public void setNzwidth(String newNzwidth) {
		...
		nzwidth = newNzwidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__NZWIDTH, oldNzwidth, nzwidth));
	}
	...
	public void setOffset(String newOffset) {
		...
		offset = newOffset;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__OFFSET, oldOffset, offset));
	}
	...
	public void setPor(String newPor) {
		...
		por = newPor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__POR, oldPor, por));
	}
	...
	public void setRegionidref(String newRegionidref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_FIELD_DEF_TYPE__REGIONIDREF, oldRegionidref, regionidref));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EdcPackage.SFR_FIELD_DEF_TYPE__MIXED:
				return ((InternalEList<?>)getMixed()).basicRemove(otherEnd, msgs);
			case EdcPackage.SFR_FIELD_DEF_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case EdcPackage.SFR_FIELD_DEF_TYPE__DCR_FIELD_SEMANTIC:
				return ((InternalEList<?>)getDCRFieldSemantic()).basicRemove(otherEnd, msgs);
			case EdcPackage.SFR_FIELD_DEF_TYPE__ALIAS_LIST:
				return ((InternalEList<?>)getAliasList()).basicRemove(otherEnd, msgs);
			case EdcPackage.SFR_FIELD_DEF_TYPE__SFR_MODE_LIST:
				return ((InternalEList<?>)getSFRModeList()).basicRemove(otherEnd, msgs);
			case EdcPackage.SFR_FIELD_DEF_TYPE__STIM_INFO:
				return ((InternalEList<?>)getStimInfo()).basicRemove(otherEnd, msgs);
			case EdcPackage.SFR_FIELD_DEF_TYPE__MODULE_MACRO:
				return ((InternalEList<?>)getModuleMacro()).basicRemove(otherEnd, msgs);
			case EdcPackage.SFR_FIELD_DEF_TYPE__MODULE_EXCLUDE:
				return ((InternalEList<?>)getModuleExclude()).basicRemove(otherEnd, msgs);
			case EdcPackage.SFR_FIELD_DEF_TYPE__SFR_DEF:
				return ((InternalEList<?>)getSFRDef()).basicRemove(otherEnd, msgs);
			case EdcPackage.SFR_FIELD_DEF_TYPE__CHECKSUM:
				return ((InternalEList<?>)getChecksum()).basicRemove(otherEnd, msgs);
			case EdcPackage.SFR_FIELD_DEF_TYPE__SFR_FIELD_SEMANTIC:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EdcPackage.SFR_FIELD_DEF_TYPE__ACCESS:
				return getAccess();
			case EdcPackage.SFR_FIELD_DEF_TYPE__BEGIN:
				return getBegin();
			case EdcPackage.SFR_FIELD_DEF_TYPE__CNAME:
				return getCname();
			case EdcPackage.SFR_FIELD_DEF_TYPE__DESC:
				return getDesc();
			case EdcPackage.SFR_FIELD_DEF_TYPE__END:
				return getEnd();
			case EdcPackage.SFR_FIELD_DEF_TYPE__IMPL:
				return getImpl();
			case EdcPackage.SFR_FIELD_DEF_TYPE__ISHIDDEN:
				return getIshidden();
			case EdcPackage.SFR_FIELD_DEF_TYPE__ISIDEHIDDEN:
				return getIsidehidden();
			case EdcPackage.SFR_FIELD_DEF_TYPE__ISINDIRECT:
				return getIsindirect();
			case EdcPackage.SFR_FIELD_DEF_TYPE__ISLANGHIDDEN:
				return getIslanghidden();
			case EdcPackage.SFR_FIELD_DEF_TYPE__ISLNAGHIDDEN:
				return getIslnaghidden();
			case EdcPackage.SFR_FIELD_DEF_TYPE__ISVOLATILE:
				return getIsvolatile();
			case EdcPackage.SFR_FIELD_DEF_TYPE__MASK:
				return getMask();
			case EdcPackage.SFR_FIELD_DEF_TYPE__MCLR:
				return getMclr();
			case EdcPackage.SFR_FIELD_DEF_TYPE__MODSRC:
				return getModsrc();
			case EdcPackage.SFR_FIELD_DEF_TYPE__NAME:
				return getName();
			case EdcPackage.SFR_FIELD_DEF_TYPE__NZSIZE:
				return getNzsize();
			case EdcPackage.SFR_FIELD_DEF_TYPE__NZWIDTH:
				return getNzwidth();
			case EdcPackage.SFR_FIELD_DEF_TYPE__OFFSET:
				return getOffset();
			case EdcPackage.SFR_FIELD_DEF_TYPE__POR:
				return getPor();
			case EdcPackage.SFR_FIELD_DEF_TYPE__REGIONIDREF:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EdcPackage.SFR_FIELD_DEF_TYPE__ALIAS_LIST:
				getAliasList().clear();
				getAliasList().addAll((Collection<? extends AliasListType5>)newValue);
				return;
			case EdcPackage.SFR_FIELD_DEF_TYPE__SFR_MODE_LIST:
