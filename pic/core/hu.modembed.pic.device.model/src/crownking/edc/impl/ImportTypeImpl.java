 ...
 * <ul>
 *   <li>{@link crownking.edc.impl.ImportTypeImpl#getModuleImport <em>Module Import</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImportTypeImpl extends EObjectImpl implements ImportType {
	 ...
	 * @ordered
	 */
	protected EList<ModuleImportType> moduleImport;
	...
	protected EClass eStaticClass() {
		return EdcPackage.eINSTANCE.getImportType();
	}
	 ...
	 * @generated
	 */
	public EList<ModuleImportType> getModuleImport() {
		if (moduleImport == null) {
			moduleImport = new EObjectContainmentEList<ModuleImportType>(ModuleImportType.class, this, EdcPackage.IMPORT_TYPE__MODULE_IMPORT);
		}
		return moduleImport;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EdcPackage.IMPORT_TYPE__MODULE_IMPORT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case EdcPackage.IMPORT_TYPE__MODULE_IMPORT:
				...
				getModuleImport().addAll((Collection<? extends ModuleImportType>)newValue);
				return;
		}
