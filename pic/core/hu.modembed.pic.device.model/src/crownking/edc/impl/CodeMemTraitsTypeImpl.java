...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Code Mem Traits Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link crownking.edc.impl.CodeMemTraitsTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link crownking.edc.impl.CodeMemTraitsTypeImpl#getLocsize <em>Locsize</em>}</li>
 *   <li>{@link crownking.edc.impl.CodeMemTraitsTypeImpl#getWordimpl <em>Wordimpl</em>}</li>
 *   <li>{@link crownking.edc.impl.CodeMemTraitsTypeImpl#getWordinit <em>Wordinit</em>}</li>
 *   <li>{@link crownking.edc.impl.CodeMemTraitsTypeImpl#getWordsafe <em>Wordsafe</em>}</li>
 *   <li>{@link crownking.edc.impl.CodeMemTraitsTypeImpl#getWordsize <em>Wordsize</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CodeMemTraitsTypeImpl extends EObjectImpl implements CodeMemTraitsType {
	/**
	 ...
	 * @generated
	 */
	protected CodeMemTraitsTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EdcPackage.eINSTANCE.getCodeMemTraitsType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.CODE_MEM_TRAITS_TYPE__VALUE, oldValue, value));
	}
	...
	public void setLocsize(String newLocsize) {
		...
		locsize = newLocsize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.CODE_MEM_TRAITS_TYPE__LOCSIZE, oldLocsize, locsize));
	}
	...
	public void setWordimpl(String newWordimpl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.CODE_MEM_TRAITS_TYPE__WORDIMPL, oldWordimpl, wordimpl));
	}
	...
	public void setWordinit(String newWordinit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.CODE_MEM_TRAITS_TYPE__WORDINIT, oldWordinit, wordinit));
	}
	...
	public void setWordsafe(String newWordsafe) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.CODE_MEM_TRAITS_TYPE__WORDSAFE, oldWordsafe, wordsafe));
	}
	...
	public void setWordsize(String newWordsize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.CODE_MEM_TRAITS_TYPE__WORDSIZE, oldWordsize, wordsize));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EdcPackage.CODE_MEM_TRAITS_TYPE__VALUE:
				return getValue();
			case EdcPackage.CODE_MEM_TRAITS_TYPE__LOCSIZE:
				return getLocsize();
			case EdcPackage.CODE_MEM_TRAITS_TYPE__WORDIMPL:
				return getWordimpl();
			case EdcPackage.CODE_MEM_TRAITS_TYPE__WORDINIT:
				return getWordinit();
			case EdcPackage.CODE_MEM_TRAITS_TYPE__WORDSAFE:
				return getWordsafe();
			case EdcPackage.CODE_MEM_TRAITS_TYPE__WORDSIZE:
				return getWordsize();
		}
