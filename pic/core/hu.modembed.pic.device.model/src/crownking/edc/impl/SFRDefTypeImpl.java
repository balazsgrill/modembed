...
import crownking.edc.AliasListType4;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>SFR Def Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getDCRFieldSemantic <em>DCR Field Semantic</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getAliasList <em>Alias List</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getSFRModeList <em>SFR Mode List</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getStimInfo <em>Stim Info</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getModuleMacro <em>Module Macro</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getModuleExclude <em>Module Exclude</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getSFRDef <em>SFR Def</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getChecksum <em>Checksum</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getSFRFieldSemantic <em>SFR Field Semantic</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getBegin <em>Begin</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getCname <em>Cname</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getDesc <em>Desc</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getEnd <em>End</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getImpl <em>Impl</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getIshidden <em>Ishidden</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getIsidehidden <em>Isidehidden</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getIsindirect <em>Isindirect</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getIslanghidden <em>Islanghidden</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getIslnaghidden <em>Islnaghidden</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getIsvolatile <em>Isvolatile</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getMask <em>Mask</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getMclr <em>Mclr</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getModsrc <em>Modsrc</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getNzsize <em>Nzsize</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getNzwidth <em>Nzwidth</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getPor <em>Por</em>}</li>
 *   <li>{@link crownking.edc.impl.SFRDefTypeImpl#getRegionidref <em>Regionidref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SFRDefTypeImpl extends EObjectImpl implements SFRDefType {
	/**
	...
	protected EClass eStaticClass() {
		return EdcPackage.eINSTANCE.getSFRDefType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, EdcPackage.SFR_DEF_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public FeatureMap getGroup() {
		return (FeatureMap)getMixed().<FeatureMap.Entry>list(EdcPackage.eINSTANCE.getSFRDefType_Group());
	}
	...
	public EList<DCRFieldSemanticType> getDCRFieldSemantic() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRDefType_DCRFieldSemantic());
	}
	 ...
	 * @generated
	 */
	public EList<AliasListType4> getAliasList() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRDefType_AliasList());
	}
	...
	public EList<SFRModeListType> getSFRModeList() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRDefType_SFRModeList());
	}
	...
	public EList<StimInfoType> getStimInfo() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRDefType_StimInfo());
	}
	...
	public EList<ModuleMacroType> getModuleMacro() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRDefType_ModuleMacro());
	}
	...
	public EList<ModuleExcludeType> getModuleExclude() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRDefType_ModuleExclude());
	}
	...
	public EList<SFRDefType> getSFRDef() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRDefType_SFRDef());
	}
	...
	public EList<ChecksumType> getChecksum() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRDefType_Checksum());
	}
	...
	public EList<SFRFieldSemanticType> getSFRFieldSemantic() {
		return getGroup().list(EdcPackage.eINSTANCE.getSFRDefType_SFRFieldSemantic());
	}
	...
	public void setAccess(String newAccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__ACCESS, oldAccess, access));
	}
	...
	public void setBegin(String newBegin) {
		...
		begin = newBegin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__BEGIN, oldBegin, begin));
	}
	...
	public void setCname(String newCname) {
		...
		cname = newCname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__CNAME, oldCname, cname));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__DESC, oldDesc, desc));
	}
	...
	public void setEnd(String newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__END, oldEnd, end));
	}
	...
	public void setImpl(String newImpl) {
		...
		impl = newImpl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__IMPL, oldImpl, impl));
	}
	...
	public void setIshidden(String newIshidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__ISHIDDEN, oldIshidden, ishidden));
	}
	...
	public void setIsidehidden(String newIsidehidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__ISIDEHIDDEN, oldIsidehidden, isidehidden));
	}
	...
	public void setIsindirect(String newIsindirect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__ISINDIRECT, oldIsindirect, isindirect));
	}
	...
	public void setIslanghidden(String newIslanghidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__ISLANGHIDDEN, oldIslanghidden, islanghidden));
	}
	...
	public void setIslnaghidden(String newIslnaghidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__ISLNAGHIDDEN, oldIslnaghidden, islnaghidden));
	}
	...
	public void setIsvolatile(String newIsvolatile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__ISVOLATILE, oldIsvolatile, isvolatile));
	}
	...
	public void setMask(String newMask) {
		...
		mask = newMask;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__MASK, oldMask, mask));
	}
	...
	public void setMclr(String newMclr) {
		...
		mclr = newMclr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__MCLR, oldMclr, mclr));
	}
	...
	public void setModsrc(String newModsrc) {
		...
		modsrc = newModsrc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__MODSRC, oldModsrc, modsrc));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__NAME, oldName, name));
	}
	...
	public void setNzsize(String newNzsize) {
		...
		nzsize = newNzsize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__NZSIZE, oldNzsize, nzsize));
	}
	...
	public void setNzwidth(String newNzwidth) {
		...
		nzwidth = newNzwidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__NZWIDTH, oldNzwidth, nzwidth));
	}
	...
	public void setOffset(String newOffset) {
		...
		offset = newOffset;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__OFFSET, oldOffset, offset));
	}
	...
	public void setPor(String newPor) {
		...
		por = newPor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__POR, oldPor, por));
	}
	...
	public void setRegionidref(String newRegionidref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.SFR_DEF_TYPE__REGIONIDREF, oldRegionidref, regionidref));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EdcPackage.SFR_DEF_TYPE__ACCESS:
				return getAccess();
			case EdcPackage.SFR_DEF_TYPE__BEGIN:
				return getBegin();
			case EdcPackage.SFR_DEF_TYPE__CNAME:
				return getCname();
			case EdcPackage.SFR_DEF_TYPE__DESC:
				return getDesc();
			case EdcPackage.SFR_DEF_TYPE__END:
				return getEnd();
			case EdcPackage.SFR_DEF_TYPE__IMPL:
				return getImpl();
			case EdcPackage.SFR_DEF_TYPE__ISHIDDEN:
				return getIshidden();
			case EdcPackage.SFR_DEF_TYPE__ISIDEHIDDEN:
				return getIsidehidden();
			case EdcPackage.SFR_DEF_TYPE__ISINDIRECT:
				return getIsindirect();
			case EdcPackage.SFR_DEF_TYPE__ISLANGHIDDEN:
				return getIslanghidden();
			case EdcPackage.SFR_DEF_TYPE__ISLNAGHIDDEN:
				return getIslnaghidden();
			case EdcPackage.SFR_DEF_TYPE__ISVOLATILE:
				return getIsvolatile();
			case EdcPackage.SFR_DEF_TYPE__MASK:
				return getMask();
			case EdcPackage.SFR_DEF_TYPE__MCLR:
				return getMclr();
			case EdcPackage.SFR_DEF_TYPE__MODSRC:
				return getModsrc();
			case EdcPackage.SFR_DEF_TYPE__NAME:
				return getName();
			case EdcPackage.SFR_DEF_TYPE__NZSIZE:
				return getNzsize();
			case EdcPackage.SFR_DEF_TYPE__NZWIDTH:
				return getNzwidth();
			case EdcPackage.SFR_DEF_TYPE__OFFSET:
				return getOffset();
			case EdcPackage.SFR_DEF_TYPE__POR:
				return getPor();
			case EdcPackage.SFR_DEF_TYPE__REGIONIDREF:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EdcPackage.SFR_DEF_TYPE__ALIAS_LIST:
				getAliasList().clear();
				getAliasList().addAll((Collection<? extends AliasListType4>)newValue);
				return;
			case EdcPackage.SFR_DEF_TYPE__SFR_MODE_LIST:
