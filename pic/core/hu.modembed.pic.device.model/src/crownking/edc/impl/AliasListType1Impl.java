...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Alias List Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link crownking.edc.impl.AliasListType1Impl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType1Impl#getGroup <em>Group</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType1Impl#getLegacyAlias <em>Legacy Alias</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType1Impl#getMigrationAlias <em>Migration Alias</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType1Impl#getAliasList <em>Alias List</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType1Impl#getChecksum <em>Checksum</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType1Impl#getBeginaddr <em>Beginaddr</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType1Impl#getChecksumalgo <em>Checksumalgo</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType1Impl#getCname <em>Cname</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType1Impl#getDesc <em>Desc</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType1Impl#getEndaddr <em>Endaddr</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType1Impl#getIshidden <em>Ishidden</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType1Impl#getIslanghidden <em>Islanghidden</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType1Impl#getOscmodeidref <em>Oscmodeidref</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType1Impl#getWhen <em>When</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AliasListType1Impl extends EObjectImpl implements AliasListType1 {
	/**
	...
	protected EClass eStaticClass() {
		return EdcPackage.eINSTANCE.getAliasListType1();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, EdcPackage.ALIAS_LIST_TYPE1__MIXED);
		}
		return mixed;
	}
	...
	public FeatureMap getGroup() {
		return (FeatureMap)getMixed().<FeatureMap.Entry>list(EdcPackage.eINSTANCE.getAliasListType1_Group());
	}
	...
	public EList<LegacyAliasType> getLegacyAlias() {
		return getGroup().list(EdcPackage.eINSTANCE.getAliasListType1_LegacyAlias());
	}
	...
	public EList<MigrationAliasType> getMigrationAlias() {
		return getGroup().list(EdcPackage.eINSTANCE.getAliasListType1_MigrationAlias());
	}
	...
	public EList<AliasListType8> getAliasList() {
		return getGroup().list(EdcPackage.eINSTANCE.getAliasListType1_AliasList());
	}
	...
	public EList<ChecksumType> getChecksum() {
		return getGroup().list(EdcPackage.eINSTANCE.getAliasListType1_Checksum());
	}
	...
	public void setBeginaddr(String newBeginaddr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE1__BEGINADDR, oldBeginaddr, beginaddr));
	}
	...
	public void setChecksumalgo(String newChecksumalgo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE1__CHECKSUMALGO, oldChecksumalgo, checksumalgo));
	}
	...
	public void setCname(String newCname) {
		...
		cname = newCname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE1__CNAME, oldCname, cname));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE1__DESC, oldDesc, desc));
	}
	...
	public void setEndaddr(String newEndaddr) {
		...
		endaddr = newEndaddr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE1__ENDADDR, oldEndaddr, endaddr));
	}
	...
	public void setIshidden(String newIshidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE1__ISHIDDEN, oldIshidden, ishidden));
	}
	...
	public void setIslanghidden(String newIslanghidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE1__ISLANGHIDDEN, oldIslanghidden, islanghidden));
	}
	...
	public void setOscmodeidref(byte newOscmodeidref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE1__OSCMODEIDREF, oldOscmodeidref, oscmodeidref, !oldOscmodeidrefESet));
	}
	...
	public void unsetOscmodeidref() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EdcPackage.ALIAS_LIST_TYPE1__OSCMODEIDREF, oldOscmodeidref, OSCMODEIDREF_EDEFAULT, oldOscmodeidrefESet));
	}
	...
	public void setWhen(String newWhen) {
		...
		when = newWhen;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE1__WHEN, oldWhen, when));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EdcPackage.ALIAS_LIST_TYPE1__MIXED:
				return ((InternalEList<?>)getMixed()).basicRemove(otherEnd, msgs);
			case EdcPackage.ALIAS_LIST_TYPE1__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case EdcPackage.ALIAS_LIST_TYPE1__LEGACY_ALIAS:
				return ((InternalEList<?>)getLegacyAlias()).basicRemove(otherEnd, msgs);
			case EdcPackage.ALIAS_LIST_TYPE1__MIGRATION_ALIAS:
				return ((InternalEList<?>)getMigrationAlias()).basicRemove(otherEnd, msgs);
			case EdcPackage.ALIAS_LIST_TYPE1__ALIAS_LIST:
				return ((InternalEList<?>)getAliasList()).basicRemove(otherEnd, msgs);
			case EdcPackage.ALIAS_LIST_TYPE1__CHECKSUM:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EdcPackage.ALIAS_LIST_TYPE1__CHECKSUM:
				return getChecksum();
			case EdcPackage.ALIAS_LIST_TYPE1__BEGINADDR:
				return getBeginaddr();
			case EdcPackage.ALIAS_LIST_TYPE1__CHECKSUMALGO:
				return getChecksumalgo();
			case EdcPackage.ALIAS_LIST_TYPE1__CNAME:
				return getCname();
			case EdcPackage.ALIAS_LIST_TYPE1__DESC:
				return getDesc();
			case EdcPackage.ALIAS_LIST_TYPE1__ENDADDR:
				return getEndaddr();
			case EdcPackage.ALIAS_LIST_TYPE1__ISHIDDEN:
				return getIshidden();
			case EdcPackage.ALIAS_LIST_TYPE1__ISLANGHIDDEN:
				return getIslanghidden();
			case EdcPackage.ALIAS_LIST_TYPE1__OSCMODEIDREF:
				return getOscmodeidref();
			case EdcPackage.ALIAS_LIST_TYPE1__WHEN:
				return getWhen();
		}
