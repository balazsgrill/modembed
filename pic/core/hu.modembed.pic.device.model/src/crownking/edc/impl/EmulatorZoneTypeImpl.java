...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Emulator Zone Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link crownking.edc.impl.EmulatorZoneTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link crownking.edc.impl.EmulatorZoneTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link crownking.edc.impl.EmulatorZoneTypeImpl#getSFRDef <em>SFR Def</em>}</li>
 *   <li>{@link crownking.edc.impl.EmulatorZoneTypeImpl#getAdjustPoint <em>Adjust Point</em>}</li>
 *   <li>{@link crownking.edc.impl.EmulatorZoneTypeImpl#getBank <em>Bank</em>}</li>
 *   <li>{@link crownking.edc.impl.EmulatorZoneTypeImpl#getBeginaddr <em>Beginaddr</em>}</li>
 *   <li>{@link crownking.edc.impl.EmulatorZoneTypeImpl#getEndaddr <em>Endaddr</em>}</li>
 *   <li>{@link crownking.edc.impl.EmulatorZoneTypeImpl#getRegionid <em>Regionid</em>}</li>
 *   <li>{@link crownking.edc.impl.EmulatorZoneTypeImpl#getShadowidref <em>Shadowidref</em>}</li>
 *   <li>{@link crownking.edc.impl.EmulatorZoneTypeImpl#getShadowoffset <em>Shadowoffset</em>}</li>
 *   <li>{@link crownking.edc.impl.EmulatorZoneTypeImpl#getShadowoffset1 <em>Shadowoffset1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EmulatorZoneTypeImpl extends EObjectImpl implements EmulatorZoneType {
	/**
	 ...
	 * @generated
	 */
	protected EmulatorZoneTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EdcPackage.eINSTANCE.getEmulatorZoneType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, EdcPackage.EMULATOR_ZONE_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public FeatureMap getGroup() {
		return (FeatureMap)getMixed().<FeatureMap.Entry>list(EdcPackage.eINSTANCE.getEmulatorZoneType_Group());
	}
	...
	public EList<SFRDefType> getSFRDef() {
		return getGroup().list(EdcPackage.eINSTANCE.getEmulatorZoneType_SFRDef());
	}
	...
	public EList<AdjustPointType> getAdjustPoint() {
		return getGroup().list(EdcPackage.eINSTANCE.getEmulatorZoneType_AdjustPoint());
	}
	...
	public void setBank(byte newBank) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.EMULATOR_ZONE_TYPE__BANK, oldBank, bank, !oldBankESet));
	}
	...
	public void unsetBank() {
		...
		bankESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EdcPackage.EMULATOR_ZONE_TYPE__BANK, oldBank, BANK_EDEFAULT, oldBankESet));
	}
	...
	public void setBeginaddr(String newBeginaddr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.EMULATOR_ZONE_TYPE__BEGINADDR, oldBeginaddr, beginaddr));
	}
	...
	public void setEndaddr(String newEndaddr) {
		...
		endaddr = newEndaddr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.EMULATOR_ZONE_TYPE__ENDADDR, oldEndaddr, endaddr));
	}
	...
	public void setRegionid(String newRegionid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.EMULATOR_ZONE_TYPE__REGIONID, oldRegionid, regionid));
	}
	...
	public void setShadowidref(String newShadowidref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.EMULATOR_ZONE_TYPE__SHADOWIDREF, oldShadowidref, shadowidref));
	}
	...
	public void setShadowoffset(String newShadowoffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.EMULATOR_ZONE_TYPE__SHADOWOFFSET, oldShadowoffset, shadowoffset));
	}
	...
	public void setShadowoffset1(byte newShadowoffset1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.EMULATOR_ZONE_TYPE__SHADOWOFFSET1, oldShadowoffset1, shadowoffset1, !oldShadowoffset1ESet));
	}
	...
	public void unsetShadowoffset1() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EdcPackage.EMULATOR_ZONE_TYPE__SHADOWOFFSET1, oldShadowoffset1, SHADOWOFFSET1_EDEFAULT, oldShadowoffset1ESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EdcPackage.EMULATOR_ZONE_TYPE__MIXED:
				return ((InternalEList<?>)getMixed()).basicRemove(otherEnd, msgs);
			case EdcPackage.EMULATOR_ZONE_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case EdcPackage.EMULATOR_ZONE_TYPE__SFR_DEF:
				return ((InternalEList<?>)getSFRDef()).basicRemove(otherEnd, msgs);
			case EdcPackage.EMULATOR_ZONE_TYPE__ADJUST_POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EdcPackage.EMULATOR_ZONE_TYPE__BANK:
				return getBank();
			case EdcPackage.EMULATOR_ZONE_TYPE__BEGINADDR:
				return getBeginaddr();
			case EdcPackage.EMULATOR_ZONE_TYPE__ENDADDR:
				return getEndaddr();
			case EdcPackage.EMULATOR_ZONE_TYPE__REGIONID:
				return getRegionid();
			case EdcPackage.EMULATOR_ZONE_TYPE__SHADOWIDREF:
				return getShadowidref();
			case EdcPackage.EMULATOR_ZONE_TYPE__SHADOWOFFSET:
				return getShadowoffset();
			case EdcPackage.EMULATOR_ZONE_TYPE__SHADOWOFFSET1:
