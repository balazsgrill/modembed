...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Module Ref Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getModuleMacro <em>Module Macro</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getModuleExclude <em>Module Exclude</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getDCRFieldSemantic <em>DCR Field Semantic</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getAliasList <em>Alias List</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getSFRModeList <em>SFR Mode List</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getStimInfo <em>Stim Info</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getSFRDef <em>SFR Def</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getChecksum <em>Checksum</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getSFRFieldSemantic <em>SFR Field Semantic</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getBegin <em>Begin</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getCname <em>Cname</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getDesc <em>Desc</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getEnd <em>End</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getImpl <em>Impl</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getIshidden <em>Ishidden</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getIsidehidden <em>Isidehidden</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getIsindirect <em>Isindirect</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getIslanghidden <em>Islanghidden</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getIslnaghidden <em>Islnaghidden</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getIsvolatile <em>Isvolatile</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getMask <em>Mask</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getMclr <em>Mclr</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getModsrc <em>Modsrc</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getNzsize <em>Nzsize</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getNzwidth <em>Nzwidth</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getPor <em>Por</em>}</li>
 *   <li>{@link crownking.edc.impl.ModuleRefTypeImpl#getRegionidref <em>Regionidref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ModuleRefTypeImpl extends EObjectImpl implements ModuleRefType {
	/**
	...
	protected EClass eStaticClass() {
		return EdcPackage.eINSTANCE.getModuleRefType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, EdcPackage.MODULE_REF_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public FeatureMap getGroup() {
		return (FeatureMap)getMixed().<FeatureMap.Entry>list(EdcPackage.eINSTANCE.getModuleRefType_Group());
	}
	...
	public EList<ModuleMacroType> getModuleMacro() {
		return getGroup().list(EdcPackage.eINSTANCE.getModuleRefType_ModuleMacro());
	}
	...
	public EList<ModuleExcludeType> getModuleExclude() {
		return getGroup().list(EdcPackage.eINSTANCE.getModuleRefType_ModuleExclude());
	}
	...
	public EList<DCRFieldSemanticType> getDCRFieldSemantic() {
		return getGroup().list(EdcPackage.eINSTANCE.getModuleRefType_DCRFieldSemantic());
	}
	 ...
	 * @generated
	 */
	public EList<AliasListType3> getAliasList() {
		return getGroup().list(EdcPackage.eINSTANCE.getModuleRefType_AliasList());
	}
	...
	public EList<SFRModeListType> getSFRModeList() {
		return getGroup().list(EdcPackage.eINSTANCE.getModuleRefType_SFRModeList());
	}
	...
	public EList<StimInfoType> getStimInfo() {
		return getGroup().list(EdcPackage.eINSTANCE.getModuleRefType_StimInfo());
	}
	...
	public EList<SFRDefType> getSFRDef() {
		return getGroup().list(EdcPackage.eINSTANCE.getModuleRefType_SFRDef());
	}
	...
	public EList<ChecksumType> getChecksum() {
		return getGroup().list(EdcPackage.eINSTANCE.getModuleRefType_Checksum());
	}
	...
	public EList<SFRFieldSemanticType> getSFRFieldSemantic() {
		return getGroup().list(EdcPackage.eINSTANCE.getModuleRefType_SFRFieldSemantic());
	}
	...
	public void setAccess(String newAccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__ACCESS, oldAccess, access));
	}
	...
	public void setBegin(String newBegin) {
		...
		begin = newBegin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__BEGIN, oldBegin, begin));
	}
	...
	public void setCname(String newCname) {
		...
		cname = newCname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__CNAME, oldCname, cname));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__DESC, oldDesc, desc));
	}
	...
	public void setEnd(String newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__END, oldEnd, end));
	}
	...
	public void setImpl(String newImpl) {
		...
		impl = newImpl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__IMPL, oldImpl, impl));
	}
	...
	public void setIshidden(String newIshidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__ISHIDDEN, oldIshidden, ishidden));
	}
	...
	public void setIsidehidden(String newIsidehidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__ISIDEHIDDEN, oldIsidehidden, isidehidden));
	}
	...
	public void setIsindirect(String newIsindirect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__ISINDIRECT, oldIsindirect, isindirect));
	}
	...
	public void setIslanghidden(String newIslanghidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__ISLANGHIDDEN, oldIslanghidden, islanghidden));
	}
	...
	public void setIslnaghidden(String newIslnaghidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__ISLNAGHIDDEN, oldIslnaghidden, islnaghidden));
	}
	...
	public void setIsvolatile(String newIsvolatile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__ISVOLATILE, oldIsvolatile, isvolatile));
	}
	...
	public void setMask(String newMask) {
		...
		mask = newMask;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__MASK, oldMask, mask));
	}
	...
	public void setMclr(String newMclr) {
		...
		mclr = newMclr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__MCLR, oldMclr, mclr));
	}
	...
	public void setModsrc(String newModsrc) {
		...
		modsrc = newModsrc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__MODSRC, oldModsrc, modsrc));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__NAME, oldName, name));
	}
	...
	public void setNzsize(String newNzsize) {
		...
		nzsize = newNzsize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__NZSIZE, oldNzsize, nzsize));
	}
	...
	public void setNzwidth(String newNzwidth) {
		...
		nzwidth = newNzwidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__NZWIDTH, oldNzwidth, nzwidth));
	}
	...
	public void setOffset(String newOffset) {
		...
		offset = newOffset;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__OFFSET, oldOffset, offset));
	}
	...
	public void setPor(String newPor) {
		...
		por = newPor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__POR, oldPor, por));
	}
	...
	public void setRegionidref(String newRegionidref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.MODULE_REF_TYPE__REGIONIDREF, oldRegionidref, regionidref));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EdcPackage.MODULE_REF_TYPE__ACCESS:
				return getAccess();
			case EdcPackage.MODULE_REF_TYPE__BEGIN:
				return getBegin();
			case EdcPackage.MODULE_REF_TYPE__CNAME:
				return getCname();
			case EdcPackage.MODULE_REF_TYPE__DESC:
				return getDesc();
			case EdcPackage.MODULE_REF_TYPE__END:
				return getEnd();
			case EdcPackage.MODULE_REF_TYPE__IMPL:
				return getImpl();
			case EdcPackage.MODULE_REF_TYPE__ISHIDDEN:
				return getIshidden();
			case EdcPackage.MODULE_REF_TYPE__ISIDEHIDDEN:
				return getIsidehidden();
			case EdcPackage.MODULE_REF_TYPE__ISINDIRECT:
				return getIsindirect();
			case EdcPackage.MODULE_REF_TYPE__ISLANGHIDDEN:
				return getIslanghidden();
			case EdcPackage.MODULE_REF_TYPE__ISLNAGHIDDEN:
				return getIslnaghidden();
			case EdcPackage.MODULE_REF_TYPE__ISVOLATILE:
				return getIsvolatile();
			case EdcPackage.MODULE_REF_TYPE__MASK:
				return getMask();
			case EdcPackage.MODULE_REF_TYPE__MCLR:
				return getMclr();
			case EdcPackage.MODULE_REF_TYPE__MODSRC:
				return getModsrc();
			case EdcPackage.MODULE_REF_TYPE__NAME:
				return getName();
			case EdcPackage.MODULE_REF_TYPE__NZSIZE:
				return getNzsize();
			case EdcPackage.MODULE_REF_TYPE__NZWIDTH:
				return getNzwidth();
			case EdcPackage.MODULE_REF_TYPE__OFFSET:
				return getOffset();
			case EdcPackage.MODULE_REF_TYPE__POR:
				return getPor();
			case EdcPackage.MODULE_REF_TYPE__REGIONIDREF:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EdcPackage.MODULE_REF_TYPE__ALIAS_LIST:
				getAliasList().clear();
				getAliasList().addAll((Collection<? extends AliasListType3>)newValue);
				return;
			case EdcPackage.MODULE_REF_TYPE__SFR_MODE_LIST:
