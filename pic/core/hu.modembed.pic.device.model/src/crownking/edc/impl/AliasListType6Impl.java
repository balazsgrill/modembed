...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Alias List Type6</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link crownking.edc.impl.AliasListType6Impl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType6Impl#getGroup <em>Group</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType6Impl#getLegacyAlias <em>Legacy Alias</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType6Impl#getMigrationAlias <em>Migration Alias</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType6Impl#getAliasList <em>Alias List</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType6Impl#getChecksum <em>Checksum</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType6Impl#getBeginaddr <em>Beginaddr</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType6Impl#getChecksumalgo <em>Checksumalgo</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType6Impl#getCname <em>Cname</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType6Impl#getDesc <em>Desc</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType6Impl#getEndaddr <em>Endaddr</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType6Impl#getIshidden <em>Ishidden</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType6Impl#getIslanghidden <em>Islanghidden</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType6Impl#getOscmodeidref <em>Oscmodeidref</em>}</li>
 *   <li>{@link crownking.edc.impl.AliasListType6Impl#getWhen <em>When</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AliasListType6Impl extends EObjectImpl implements AliasListType6 {
	/**
	...
	protected EClass eStaticClass() {
		return EdcPackage.eINSTANCE.getAliasListType6();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, EdcPackage.ALIAS_LIST_TYPE6__MIXED);
		}
		return mixed;
	}
	...
	public FeatureMap getGroup() {
		return (FeatureMap)getMixed().<FeatureMap.Entry>list(EdcPackage.eINSTANCE.getAliasListType6_Group());
	}
	...
	public EList<LegacyAliasType> getLegacyAlias() {
		return getGroup().list(EdcPackage.eINSTANCE.getAliasListType6_LegacyAlias());
	}
	...
	public EList<MigrationAliasType> getMigrationAlias() {
		return getGroup().list(EdcPackage.eINSTANCE.getAliasListType6_MigrationAlias());
	}
	...
	public EList<AliasListType8> getAliasList() {
		return getGroup().list(EdcPackage.eINSTANCE.getAliasListType6_AliasList());
	}
	...
	public EList<ChecksumType> getChecksum() {
		return getGroup().list(EdcPackage.eINSTANCE.getAliasListType6_Checksum());
	}
	...
	public void setBeginaddr(String newBeginaddr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE6__BEGINADDR, oldBeginaddr, beginaddr));
	}
	...
	public void setChecksumalgo(String newChecksumalgo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE6__CHECKSUMALGO, oldChecksumalgo, checksumalgo));
	}
	...
	public void setCname(String newCname) {
		...
		cname = newCname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE6__CNAME, oldCname, cname));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE6__DESC, oldDesc, desc));
	}
	...
	public void setEndaddr(String newEndaddr) {
		...
		endaddr = newEndaddr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE6__ENDADDR, oldEndaddr, endaddr));
	}
	...
	public void setIshidden(String newIshidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE6__ISHIDDEN, oldIshidden, ishidden));
	}
	...
	public void setIslanghidden(String newIslanghidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE6__ISLANGHIDDEN, oldIslanghidden, islanghidden));
	}
	...
	public void setOscmodeidref(byte newOscmodeidref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE6__OSCMODEIDREF, oldOscmodeidref, oscmodeidref, !oldOscmodeidrefESet));
	}
	...
	public void unsetOscmodeidref() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EdcPackage.ALIAS_LIST_TYPE6__OSCMODEIDREF, oldOscmodeidref, OSCMODEIDREF_EDEFAULT, oldOscmodeidrefESet));
	}
	...
	public void setWhen(String newWhen) {
		...
		when = newWhen;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ALIAS_LIST_TYPE6__WHEN, oldWhen, when));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EdcPackage.ALIAS_LIST_TYPE6__MIXED:
				return ((InternalEList<?>)getMixed()).basicRemove(otherEnd, msgs);
			case EdcPackage.ALIAS_LIST_TYPE6__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case EdcPackage.ALIAS_LIST_TYPE6__LEGACY_ALIAS:
				return ((InternalEList<?>)getLegacyAlias()).basicRemove(otherEnd, msgs);
			case EdcPackage.ALIAS_LIST_TYPE6__MIGRATION_ALIAS:
				return ((InternalEList<?>)getMigrationAlias()).basicRemove(otherEnd, msgs);
			case EdcPackage.ALIAS_LIST_TYPE6__ALIAS_LIST:
				return ((InternalEList<?>)getAliasList()).basicRemove(otherEnd, msgs);
			case EdcPackage.ALIAS_LIST_TYPE6__CHECKSUM:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EdcPackage.ALIAS_LIST_TYPE6__CHECKSUM:
				return getChecksum();
			case EdcPackage.ALIAS_LIST_TYPE6__BEGINADDR:
				return getBeginaddr();
			case EdcPackage.ALIAS_LIST_TYPE6__CHECKSUMALGO:
				return getChecksumalgo();
			case EdcPackage.ALIAS_LIST_TYPE6__CNAME:
				return getCname();
			case EdcPackage.ALIAS_LIST_TYPE6__DESC:
				return getDesc();
			case EdcPackage.ALIAS_LIST_TYPE6__ENDADDR:
				return getEndaddr();
			case EdcPackage.ALIAS_LIST_TYPE6__ISHIDDEN:
				return getIshidden();
			case EdcPackage.ALIAS_LIST_TYPE6__ISLANGHIDDEN:
				return getIslanghidden();
			case EdcPackage.ALIAS_LIST_TYPE6__OSCMODEIDREF:
				return getOscmodeidref();
			case EdcPackage.ALIAS_LIST_TYPE6__WHEN:
				return getWhen();
		}
