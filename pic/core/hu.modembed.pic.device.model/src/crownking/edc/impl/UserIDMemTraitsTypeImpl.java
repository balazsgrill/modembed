...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>User ID Mem Traits Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link crownking.edc.impl.UserIDMemTraitsTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link crownking.edc.impl.UserIDMemTraitsTypeImpl#getLocsize <em>Locsize</em>}</li>
 *   <li>{@link crownking.edc.impl.UserIDMemTraitsTypeImpl#getWordimpl <em>Wordimpl</em>}</li>
 *   <li>{@link crownking.edc.impl.UserIDMemTraitsTypeImpl#getWordinit <em>Wordinit</em>}</li>
 *   <li>{@link crownking.edc.impl.UserIDMemTraitsTypeImpl#getWordsafe <em>Wordsafe</em>}</li>
 *   <li>{@link crownking.edc.impl.UserIDMemTraitsTypeImpl#getWordsize <em>Wordsize</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class UserIDMemTraitsTypeImpl extends EObjectImpl implements UserIDMemTraitsType {
	/**
	 ...
	 * @generated
	 */
	protected UserIDMemTraitsTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EdcPackage.eINSTANCE.getUserIDMemTraitsType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.USER_ID_MEM_TRAITS_TYPE__VALUE, oldValue, value));
	}
	...
	public void setLocsize(String newLocsize) {
		...
		locsize = newLocsize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.USER_ID_MEM_TRAITS_TYPE__LOCSIZE, oldLocsize, locsize));
	}
	...
	public void setWordimpl(String newWordimpl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.USER_ID_MEM_TRAITS_TYPE__WORDIMPL, oldWordimpl, wordimpl));
	}
	...
	public void setWordinit(String newWordinit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.USER_ID_MEM_TRAITS_TYPE__WORDINIT, oldWordinit, wordinit));
	}
	...
	public void setWordsafe(String newWordsafe) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.USER_ID_MEM_TRAITS_TYPE__WORDSAFE, oldWordsafe, wordsafe));
	}
	...
	public void setWordsize(String newWordsize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.USER_ID_MEM_TRAITS_TYPE__WORDSIZE, oldWordsize, wordsize));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EdcPackage.USER_ID_MEM_TRAITS_TYPE__VALUE:
				return getValue();
			case EdcPackage.USER_ID_MEM_TRAITS_TYPE__LOCSIZE:
				return getLocsize();
			case EdcPackage.USER_ID_MEM_TRAITS_TYPE__WORDIMPL:
				return getWordimpl();
			case EdcPackage.USER_ID_MEM_TRAITS_TYPE__WORDINIT:
				return getWordinit();
			case EdcPackage.USER_ID_MEM_TRAITS_TYPE__WORDSAFE:
				return getWordsafe();
			case EdcPackage.USER_ID_MEM_TRAITS_TYPE__WORDSIZE:
				return getWordsize();
		}
