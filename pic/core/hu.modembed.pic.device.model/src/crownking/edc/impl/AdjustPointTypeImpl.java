...
import crownking.edc.AliasListType;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Adjust Point Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getDCRFieldSemantic <em>DCR Field Semantic</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getAliasList <em>Alias List</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getSFRModeList <em>SFR Mode List</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getStimInfo <em>Stim Info</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getModuleMacro <em>Module Macro</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getModuleExclude <em>Module Exclude</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getSFRDef <em>SFR Def</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getChecksum <em>Checksum</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getSFRFieldSemantic <em>SFR Field Semantic</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getBegin <em>Begin</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getCname <em>Cname</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getDesc <em>Desc</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getEnd <em>End</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getImpl <em>Impl</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getIshidden <em>Ishidden</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getIsidehidden <em>Isidehidden</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getIsindirect <em>Isindirect</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getIslanghidden <em>Islanghidden</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getIslnaghidden <em>Islnaghidden</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getIsvolatile <em>Isvolatile</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getMask <em>Mask</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getMclr <em>Mclr</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getModsrc <em>Modsrc</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getNzsize <em>Nzsize</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getNzwidth <em>Nzwidth</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getPor <em>Por</em>}</li>
 *   <li>{@link crownking.edc.impl.AdjustPointTypeImpl#getRegionidref <em>Regionidref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AdjustPointTypeImpl extends EObjectImpl implements AdjustPointType {
	/**
	...
	protected EClass eStaticClass() {
		return EdcPackage.eINSTANCE.getAdjustPointType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, EdcPackage.ADJUST_POINT_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public FeatureMap getGroup() {
		return (FeatureMap)getMixed().<FeatureMap.Entry>list(EdcPackage.eINSTANCE.getAdjustPointType_Group());
	}
	...
	public EList<DCRFieldSemanticType> getDCRFieldSemantic() {
		return getGroup().list(EdcPackage.eINSTANCE.getAdjustPointType_DCRFieldSemantic());
	}
	 ...
	 * @generated
	 */
	public EList<AliasListType> getAliasList() {
		return getGroup().list(EdcPackage.eINSTANCE.getAdjustPointType_AliasList());
	}
	...
	public EList<SFRModeListType> getSFRModeList() {
		return getGroup().list(EdcPackage.eINSTANCE.getAdjustPointType_SFRModeList());
	}
	...
	public EList<StimInfoType> getStimInfo() {
		return getGroup().list(EdcPackage.eINSTANCE.getAdjustPointType_StimInfo());
	}
	...
	public EList<ModuleMacroType> getModuleMacro() {
		return getGroup().list(EdcPackage.eINSTANCE.getAdjustPointType_ModuleMacro());
	}
	...
	public EList<ModuleExcludeType> getModuleExclude() {
		return getGroup().list(EdcPackage.eINSTANCE.getAdjustPointType_ModuleExclude());
	}
	...
	public EList<SFRDefType> getSFRDef() {
		return getGroup().list(EdcPackage.eINSTANCE.getAdjustPointType_SFRDef());
	}
	...
	public EList<ChecksumType> getChecksum() {
		return getGroup().list(EdcPackage.eINSTANCE.getAdjustPointType_Checksum());
	}
	...
	public EList<SFRFieldSemanticType> getSFRFieldSemantic() {
		return getGroup().list(EdcPackage.eINSTANCE.getAdjustPointType_SFRFieldSemantic());
	}
	...
	public void setAccess(String newAccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__ACCESS, oldAccess, access));
	}
	...
	public void setBegin(String newBegin) {
		...
		begin = newBegin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__BEGIN, oldBegin, begin));
	}
	...
	public void setCname(String newCname) {
		...
		cname = newCname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__CNAME, oldCname, cname));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__DESC, oldDesc, desc));
	}
	...
	public void setEnd(String newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__END, oldEnd, end));
	}
	...
	public void setImpl(String newImpl) {
		...
		impl = newImpl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__IMPL, oldImpl, impl));
	}
	...
	public void setIshidden(String newIshidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__ISHIDDEN, oldIshidden, ishidden));
	}
	...
	public void setIsidehidden(String newIsidehidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__ISIDEHIDDEN, oldIsidehidden, isidehidden));
	}
	...
	public void setIsindirect(String newIsindirect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__ISINDIRECT, oldIsindirect, isindirect));
	}
	...
	public void setIslanghidden(String newIslanghidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__ISLANGHIDDEN, oldIslanghidden, islanghidden));
	}
	...
	public void setIslnaghidden(String newIslnaghidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__ISLNAGHIDDEN, oldIslnaghidden, islnaghidden));
	}
	...
	public void setIsvolatile(String newIsvolatile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__ISVOLATILE, oldIsvolatile, isvolatile));
	}
	...
	public void setMask(String newMask) {
		...
		mask = newMask;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__MASK, oldMask, mask));
	}
	...
	public void setMclr(String newMclr) {
		...
		mclr = newMclr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__MCLR, oldMclr, mclr));
	}
	...
	public void setModsrc(String newModsrc) {
		...
		modsrc = newModsrc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__MODSRC, oldModsrc, modsrc));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__NAME, oldName, name));
	}
	...
	public void setNzsize(String newNzsize) {
		...
		nzsize = newNzsize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__NZSIZE, oldNzsize, nzsize));
	}
	...
	public void setNzwidth(String newNzwidth) {
		...
		nzwidth = newNzwidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__NZWIDTH, oldNzwidth, nzwidth));
	}
	...
	public void setOffset(String newOffset) {
		...
		offset = newOffset;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__OFFSET, oldOffset, offset));
	}
	...
	public void setPor(String newPor) {
		...
		por = newPor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__POR, oldPor, por));
	}
	...
	public void setRegionidref(String newRegionidref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.ADJUST_POINT_TYPE__REGIONIDREF, oldRegionidref, regionidref));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EdcPackage.ADJUST_POINT_TYPE__MIXED:
				return ((InternalEList<?>)getMixed()).basicRemove(otherEnd, msgs);
			case EdcPackage.ADJUST_POINT_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case EdcPackage.ADJUST_POINT_TYPE__DCR_FIELD_SEMANTIC:
				return ((InternalEList<?>)getDCRFieldSemantic()).basicRemove(otherEnd, msgs);
			case EdcPackage.ADJUST_POINT_TYPE__ALIAS_LIST:
				return ((InternalEList<?>)getAliasList()).basicRemove(otherEnd, msgs);
			case EdcPackage.ADJUST_POINT_TYPE__SFR_MODE_LIST:
				return ((InternalEList<?>)getSFRModeList()).basicRemove(otherEnd, msgs);
			case EdcPackage.ADJUST_POINT_TYPE__STIM_INFO:
				return ((InternalEList<?>)getStimInfo()).basicRemove(otherEnd, msgs);
			case EdcPackage.ADJUST_POINT_TYPE__MODULE_MACRO:
				return ((InternalEList<?>)getModuleMacro()).basicRemove(otherEnd, msgs);
			case EdcPackage.ADJUST_POINT_TYPE__MODULE_EXCLUDE:
				return ((InternalEList<?>)getModuleExclude()).basicRemove(otherEnd, msgs);
			case EdcPackage.ADJUST_POINT_TYPE__SFR_DEF:
				return ((InternalEList<?>)getSFRDef()).basicRemove(otherEnd, msgs);
			case EdcPackage.ADJUST_POINT_TYPE__CHECKSUM:
				return ((InternalEList<?>)getChecksum()).basicRemove(otherEnd, msgs);
			case EdcPackage.ADJUST_POINT_TYPE__SFR_FIELD_SEMANTIC:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EdcPackage.ADJUST_POINT_TYPE__ACCESS:
				return getAccess();
			case EdcPackage.ADJUST_POINT_TYPE__BEGIN:
				return getBegin();
			case EdcPackage.ADJUST_POINT_TYPE__CNAME:
				return getCname();
			case EdcPackage.ADJUST_POINT_TYPE__DESC:
				return getDesc();
			case EdcPackage.ADJUST_POINT_TYPE__END:
				return getEnd();
			case EdcPackage.ADJUST_POINT_TYPE__IMPL:
				return getImpl();
			case EdcPackage.ADJUST_POINT_TYPE__ISHIDDEN:
				return getIshidden();
			case EdcPackage.ADJUST_POINT_TYPE__ISIDEHIDDEN:
				return getIsidehidden();
			case EdcPackage.ADJUST_POINT_TYPE__ISINDIRECT:
				return getIsindirect();
			case EdcPackage.ADJUST_POINT_TYPE__ISLANGHIDDEN:
				return getIslanghidden();
			case EdcPackage.ADJUST_POINT_TYPE__ISLNAGHIDDEN:
				return getIslnaghidden();
			case EdcPackage.ADJUST_POINT_TYPE__ISVOLATILE:
				return getIsvolatile();
			case EdcPackage.ADJUST_POINT_TYPE__MASK:
				return getMask();
			case EdcPackage.ADJUST_POINT_TYPE__MCLR:
				return getMclr();
			case EdcPackage.ADJUST_POINT_TYPE__MODSRC:
				return getModsrc();
			case EdcPackage.ADJUST_POINT_TYPE__NAME:
				return getName();
			case EdcPackage.ADJUST_POINT_TYPE__NZSIZE:
				return getNzsize();
			case EdcPackage.ADJUST_POINT_TYPE__NZWIDTH:
				return getNzwidth();
			case EdcPackage.ADJUST_POINT_TYPE__OFFSET:
				return getOffset();
			case EdcPackage.ADJUST_POINT_TYPE__POR:
				return getPor();
			case EdcPackage.ADJUST_POINT_TYPE__REGIONIDREF:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EdcPackage.ADJUST_POINT_TYPE__ALIAS_LIST:
				getAliasList().clear();
				getAliasList().addAll((Collection<? extends AliasListType>)newValue);
				return;
			case EdcPackage.ADJUST_POINT_TYPE__SFR_MODE_LIST:
