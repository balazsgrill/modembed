...
import crownking.edc.AliasListType2;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Joined SFR Def Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getDCRFieldSemantic <em>DCR Field Semantic</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getAliasList <em>Alias List</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getSFRModeList <em>SFR Mode List</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getStimInfo <em>Stim Info</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getSFRDef <em>SFR Def</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getModuleMacro <em>Module Macro</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getModuleExclude <em>Module Exclude</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getChecksum <em>Checksum</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getSFRFieldSemantic <em>SFR Field Semantic</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getBegin <em>Begin</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getCname <em>Cname</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getDesc <em>Desc</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getEnd <em>End</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getImpl <em>Impl</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getIshidden <em>Ishidden</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getIsidehidden <em>Isidehidden</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getIsindirect <em>Isindirect</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getIslanghidden <em>Islanghidden</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getIslnaghidden <em>Islnaghidden</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getIsvolatile <em>Isvolatile</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getMask <em>Mask</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getMclr <em>Mclr</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getModsrc <em>Modsrc</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getNzsize <em>Nzsize</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getNzwidth <em>Nzwidth</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getPor <em>Por</em>}</li>
 *   <li>{@link crownking.edc.impl.JoinedSFRDefTypeImpl#getRegionidref <em>Regionidref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class JoinedSFRDefTypeImpl extends EObjectImpl implements JoinedSFRDefType {
	/**
	 ...
	 * @generated
	 */
	protected JoinedSFRDefTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EdcPackage.eINSTANCE.getJoinedSFRDefType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, EdcPackage.JOINED_SFR_DEF_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public FeatureMap getGroup() {
		return (FeatureMap)getMixed().<FeatureMap.Entry>list(EdcPackage.eINSTANCE.getJoinedSFRDefType_Group());
	}
	...
	public EList<DCRFieldSemanticType> getDCRFieldSemantic() {
		return getGroup().list(EdcPackage.eINSTANCE.getJoinedSFRDefType_DCRFieldSemantic());
	}
	 ...
	 * @generated
	 */
	public EList<AliasListType2> getAliasList() {
		return getGroup().list(EdcPackage.eINSTANCE.getJoinedSFRDefType_AliasList());
	}
	...
	public EList<SFRModeListType> getSFRModeList() {
		return getGroup().list(EdcPackage.eINSTANCE.getJoinedSFRDefType_SFRModeList());
	}
	...
	public EList<StimInfoType> getStimInfo() {
		return getGroup().list(EdcPackage.eINSTANCE.getJoinedSFRDefType_StimInfo());
	}
	...
	public EList<SFRDefType> getSFRDef() {
		return getGroup().list(EdcPackage.eINSTANCE.getJoinedSFRDefType_SFRDef());
	}
	...
	public EList<ModuleMacroType> getModuleMacro() {
		return getGroup().list(EdcPackage.eINSTANCE.getJoinedSFRDefType_ModuleMacro());
	}
	...
	public EList<ModuleExcludeType> getModuleExclude() {
		return getGroup().list(EdcPackage.eINSTANCE.getJoinedSFRDefType_ModuleExclude());
	}
	...
	public EList<ChecksumType> getChecksum() {
		return getGroup().list(EdcPackage.eINSTANCE.getJoinedSFRDefType_Checksum());
	}
	...
	public EList<SFRFieldSemanticType> getSFRFieldSemantic() {
		return getGroup().list(EdcPackage.eINSTANCE.getJoinedSFRDefType_SFRFieldSemantic());
	}
	...
	public void setAccess(String newAccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__ACCESS, oldAccess, access));
	}
	...
	public void setBegin(String newBegin) {
		...
		begin = newBegin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__BEGIN, oldBegin, begin));
	}
	...
	public void setCname(String newCname) {
		...
		cname = newCname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__CNAME, oldCname, cname));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__DESC, oldDesc, desc));
	}
	...
	public void setEnd(String newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__END, oldEnd, end));
	}
	...
	public void setImpl(String newImpl) {
		...
		impl = newImpl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__IMPL, oldImpl, impl));
	}
	...
	public void setIshidden(String newIshidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__ISHIDDEN, oldIshidden, ishidden));
	}
	...
	public void setIsidehidden(String newIsidehidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__ISIDEHIDDEN, oldIsidehidden, isidehidden));
	}
	...
	public void setIsindirect(String newIsindirect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__ISINDIRECT, oldIsindirect, isindirect));
	}
	...
	public void setIslanghidden(String newIslanghidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__ISLANGHIDDEN, oldIslanghidden, islanghidden));
	}
	...
	public void setIslnaghidden(String newIslnaghidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__ISLNAGHIDDEN, oldIslnaghidden, islnaghidden));
	}
	...
	public void setIsvolatile(String newIsvolatile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__ISVOLATILE, oldIsvolatile, isvolatile));
	}
	...
	public void setMask(String newMask) {
		...
		mask = newMask;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__MASK, oldMask, mask));
	}
	...
	public void setMclr(String newMclr) {
		...
		mclr = newMclr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__MCLR, oldMclr, mclr));
	}
	...
	public void setModsrc(String newModsrc) {
		...
		modsrc = newModsrc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__MODSRC, oldModsrc, modsrc));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__NAME, oldName, name));
	}
	...
	public void setNzsize(String newNzsize) {
		...
		nzsize = newNzsize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__NZSIZE, oldNzsize, nzsize));
	}
	...
	public void setNzwidth(String newNzwidth) {
		...
		nzwidth = newNzwidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__NZWIDTH, oldNzwidth, nzwidth));
	}
	...
	public void setOffset(String newOffset) {
		...
		offset = newOffset;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__OFFSET, oldOffset, offset));
	}
	...
	public void setPor(String newPor) {
		...
		por = newPor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__POR, oldPor, por));
	}
	...
	public void setRegionidref(String newRegionidref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdcPackage.JOINED_SFR_DEF_TYPE__REGIONIDREF, oldRegionidref, regionidref));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EdcPackage.JOINED_SFR_DEF_TYPE__MIXED:
				return ((InternalEList<?>)getMixed()).basicRemove(otherEnd, msgs);
			case EdcPackage.JOINED_SFR_DEF_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case EdcPackage.JOINED_SFR_DEF_TYPE__DCR_FIELD_SEMANTIC:
				return ((InternalEList<?>)getDCRFieldSemantic()).basicRemove(otherEnd, msgs);
			case EdcPackage.JOINED_SFR_DEF_TYPE__ALIAS_LIST:
				return ((InternalEList<?>)getAliasList()).basicRemove(otherEnd, msgs);
			case EdcPackage.JOINED_SFR_DEF_TYPE__SFR_MODE_LIST:
				return ((InternalEList<?>)getSFRModeList()).basicRemove(otherEnd, msgs);
			case EdcPackage.JOINED_SFR_DEF_TYPE__STIM_INFO:
				return ((InternalEList<?>)getStimInfo()).basicRemove(otherEnd, msgs);
			case EdcPackage.JOINED_SFR_DEF_TYPE__SFR_DEF:
				return ((InternalEList<?>)getSFRDef()).basicRemove(otherEnd, msgs);
			case EdcPackage.JOINED_SFR_DEF_TYPE__MODULE_MACRO:
				return ((InternalEList<?>)getModuleMacro()).basicRemove(otherEnd, msgs);
			case EdcPackage.JOINED_SFR_DEF_TYPE__MODULE_EXCLUDE:
				return ((InternalEList<?>)getModuleExclude()).basicRemove(otherEnd, msgs);
			case EdcPackage.JOINED_SFR_DEF_TYPE__CHECKSUM:
				return ((InternalEList<?>)getChecksum()).basicRemove(otherEnd, msgs);
			case EdcPackage.JOINED_SFR_DEF_TYPE__SFR_FIELD_SEMANTIC:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EdcPackage.JOINED_SFR_DEF_TYPE__ACCESS:
				return getAccess();
			case EdcPackage.JOINED_SFR_DEF_TYPE__BEGIN:
				return getBegin();
			case EdcPackage.JOINED_SFR_DEF_TYPE__CNAME:
				return getCname();
			case EdcPackage.JOINED_SFR_DEF_TYPE__DESC:
				return getDesc();
			case EdcPackage.JOINED_SFR_DEF_TYPE__END:
				return getEnd();
			case EdcPackage.JOINED_SFR_DEF_TYPE__IMPL:
				return getImpl();
			case EdcPackage.JOINED_SFR_DEF_TYPE__ISHIDDEN:
				return getIshidden();
			case EdcPackage.JOINED_SFR_DEF_TYPE__ISIDEHIDDEN:
				return getIsidehidden();
			case EdcPackage.JOINED_SFR_DEF_TYPE__ISINDIRECT:
				return getIsindirect();
			case EdcPackage.JOINED_SFR_DEF_TYPE__ISLANGHIDDEN:
				return getIslanghidden();
			case EdcPackage.JOINED_SFR_DEF_TYPE__ISLNAGHIDDEN:
				return getIslnaghidden();
			case EdcPackage.JOINED_SFR_DEF_TYPE__ISVOLATILE:
				return getIsvolatile();
			case EdcPackage.JOINED_SFR_DEF_TYPE__MASK:
				return getMask();
			case EdcPackage.JOINED_SFR_DEF_TYPE__MCLR:
				return getMclr();
			case EdcPackage.JOINED_SFR_DEF_TYPE__MODSRC:
				return getModsrc();
			case EdcPackage.JOINED_SFR_DEF_TYPE__NAME:
				return getName();
			case EdcPackage.JOINED_SFR_DEF_TYPE__NZSIZE:
				return getNzsize();
			case EdcPackage.JOINED_SFR_DEF_TYPE__NZWIDTH:
				return getNzwidth();
			case EdcPackage.JOINED_SFR_DEF_TYPE__OFFSET:
				return getOffset();
			case EdcPackage.JOINED_SFR_DEF_TYPE__POR:
				return getPor();
			case EdcPackage.JOINED_SFR_DEF_TYPE__REGIONIDREF:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EdcPackage.JOINED_SFR_DEF_TYPE__ALIAS_LIST:
				getAliasList().clear();
				getAliasList().addAll((Collection<? extends AliasListType2>)newValue);
				return;
			case EdcPackage.JOINED_SFR_DEF_TYPE__SFR_MODE_LIST:
