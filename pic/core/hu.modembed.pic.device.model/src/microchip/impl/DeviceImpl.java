 ...
 *   <li>{@link microchip.impl.DeviceImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeviceImpl extends EObjectImpl implements Device {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicrochipPackage.DEVICE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MicrochipPackage.DEVICE__NAME:
				return getName();
		}
