 ...
 * @generated
 */
public class ModembedconfigSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModembedconfigPackage.SCHEME: {
				Scheme scheme = (Scheme)theEObject;
				T result = caseScheme(scheme);
				if (result == null) result = caseParameterSet(scheme);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModembedconfigPackage.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModembedconfigPackage.ENUM_PARAM: {
				EnumParam enumParam = (EnumParam)theEObject;
				T result = caseEnumParam(enumParam);
				if (result == null) result = caseParameter(enumParam);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModembedconfigPackage.ENUM_PARAM_LITERAL: {
				EnumParamLiteral enumParamLiteral = (EnumParamLiteral)theEObject;
				T result = caseEnumParamLiteral(enumParamLiteral);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModembedconfigPackage.PARAMETER_SET: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Enum Param Literal</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Enum Param Literal</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEnumParamLiteral(EnumParamLiteral object) {
		return null;
	}
