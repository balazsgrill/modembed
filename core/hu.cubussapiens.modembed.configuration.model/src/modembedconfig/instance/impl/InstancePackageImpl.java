...
import modembedconfig.impl.ModembedconfigPackageImpl;
...
public class InstancePackageImpl extends EPackageImpl implements InstancePackage {
	 ...
	 * @see modembedconfig.instance.InstancePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static InstancePackage init() {
		...
		ModembedconfigPackageImpl theModembedconfigPackage = (ModembedconfigPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(ModembedconfigPackage.eNS_URI) instanceof ModembedconfigPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(ModembedconfigPackage.eNS_URI) : ModembedconfigPackage.eINSTANCE);
	 ...
	 * @generated
	 */
	public EReference getConfiguration_Scheme() {
	 ...
	 * @generated
	 */
	public EReference getConfiguration_Values() {
	...
	public void createPackageContents() {
		...
		createEReference(configurationEClass, CONFIGURATION__SCHEME);
		createEAttribute(configurationEClass, CONFIGURATION__NAME);
		createEReference(configurationEClass, CONFIGURATION__VALUES);
	...
	public void initializePackageContents() {
		...
		initEReference(getConfiguration_Scheme(), theModembedconfigPackage.getScheme(), null, "scheme", null, 0, 1, Configuration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getConfiguration_Values(), this.getValue(), null, "values", null, 0, -1, Configuration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(valueEClass, Value.class, "Value", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getValue_Parameter(), theModembedconfigPackage.getParameter(), null, "parameter", null, 1, 1, Value.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
