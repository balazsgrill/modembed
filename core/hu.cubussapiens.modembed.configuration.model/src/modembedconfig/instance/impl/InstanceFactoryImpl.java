...
public class InstanceFactoryImpl extends EFactoryImpl implements InstanceFactory {
	...
	public static InstanceFactory init() {
		try {
			InstanceFactory theInstanceFactory = (InstanceFactory)EPackage.Registry.INSTANCE.getEFactory("http://cubussapiens.hu/modembed/config/instance"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case InstancePackage.CONFIGURATION: return createConfiguration();
