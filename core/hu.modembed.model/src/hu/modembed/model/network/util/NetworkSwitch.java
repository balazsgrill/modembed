...
public class NetworkSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NetworkPackage.NETWORK_NODE: {
				NetworkNode networkNode = (NetworkNode)theEObject;
				T result = caseNetworkNode(networkNode);
				if (result == null) result = caseNamedElement(networkNode);
				if (result == null) result = caseMODembedElement(networkNode);
			...
			case NetworkPackage.CONNECTION: {
				Connection connection = (Connection)theEObject;
				T result = caseConnection(connection);
				if (result == null) result = caseNamedElement(connection);
				if (result == null) result = caseMODembedElement(connection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NetworkPackage.NETWORK_INTERFACE: {
				...
				if (result == null) result = caseMODembedElement(networkInterface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
