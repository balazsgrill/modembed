 ...
 * <ul>
 *   <li>{@link hu.modembed.model.network.impl.NetworkImpl#getNodes <em>Nodes</em>}</li>
 *   <li>{@link hu.modembed.model.network.impl.NetworkImpl#getConnections <em>Connections</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NetworkImpl extends PackagedElementImpl implements Network {
	...
	public EList<NetworkNode> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentEList<NetworkNode>(NetworkNode.class, this, NetworkPackage.NETWORK__NODES);
		}
		return nodes;
	}
	...
	public EList<Connection> getConnections() {
		if (connections == null) {
			connections = new EObjectContainmentEList<Connection>(Connection.class, this, NetworkPackage.NETWORK__CONNECTIONS);
		}
		return connections;
	}
