...
public class ObjectSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ObjectPackage.ASSEMBLER_OBJECT: {
				AssemblerObject assemblerObject = (AssemblerObject)theEObject;
				T result = caseAssemblerObject(assemblerObject);
				if (result == null) result = caseRootElement(assemblerObject);
				if (result == null) result = caseNamedElement(assemblerObject);
				if (result == null) result = caseMODembedElement(assemblerObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ObjectPackage.INSTRUCTION_CALL: {
			...
			case ObjectPackage.INSTRUCTION_CALL_PARAMETER: {
				InstructionCallParameter instructionCallParameter = (InstructionCallParameter)theEObject;
				T result = caseInstructionCallParameter(instructionCallParameter);
				if (result == null) result = caseMODembedElement(instructionCallParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Assembler Object</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Assembler Object</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAssemblerObject(AssemblerObject object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Instruction Call Parameter</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Instruction Call Parameter</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
