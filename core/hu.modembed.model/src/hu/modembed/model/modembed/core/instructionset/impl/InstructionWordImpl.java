 ...
 * <ul>
 *   <li>{@link hu.modembed.model.modembed.core.instructionset.impl.InstructionWordImpl#getSections <em>Sections</em>}</li>
 *   <li>{@link hu.modembed.model.modembed.core.instructionset.impl.InstructionWordImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InstructionWordImpl extends MODembedElementImpl implements InstructionWord {
	...
	public EList<InstructionWordCondition> getCondition() {
		if (condition == null) {
			condition = new EObjectContainmentEList<InstructionWordCondition>(InstructionWordCondition.class, this, InstructionsetPackage.INSTRUCTION_WORD__CONDITION);
		}
		return condition;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case InstructionsetPackage.INSTRUCTION_WORD__CONDITION:
