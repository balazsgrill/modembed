 ...
 * <ul>
 *   <li>{@link hu.modembed.model.modembed.core.instructionset.impl.InstructionWordMaskedValueConditionImpl#getMask <em>Mask</em>}</li>
 *   <li>{@link hu.modembed.model.modembed.core.instructionset.impl.InstructionWordMaskedValueConditionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link hu.modembed.model.modembed.core.instructionset.impl.InstructionWordMaskedValueConditionImpl#getArgument <em>Argument</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InstructionWordMaskedValueConditionImpl extends InstructionWordConditionImpl implements InstructionWordMaskedValueCondition {
	...
	protected EClass eStaticClass() {
		return InstructionsetPackage.Literals.INSTRUCTION_WORD_MASKED_VALUE_CONDITION;
	}
	...
	public void setMask(long newMask) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InstructionsetPackage.INSTRUCTION_WORD_MASKED_VALUE_CONDITION__MASK, oldMask, mask));
	}
	...
	public void setValue(long newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InstructionsetPackage.INSTRUCTION_WORD_MASKED_VALUE_CONDITION__VALUE, oldValue, value));
	}
	...
	public InstructionParameter getArgument() {
		if (argument != null && argument.eIsProxy()) {
			...
			if (argument != oldArgument) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InstructionsetPackage.INSTRUCTION_WORD_MASKED_VALUE_CONDITION__ARGUMENT, oldArgument, argument));
			}
		}
		return argument;
	}
	...
	public void setArgument(InstructionParameter newArgument) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InstructionsetPackage.INSTRUCTION_WORD_MASKED_VALUE_CONDITION__ARGUMENT, oldArgument, argument));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case InstructionsetPackage.INSTRUCTION_WORD_MASKED_VALUE_CONDITION__VALUE:
				return getValue();
			case InstructionsetPackage.INSTRUCTION_WORD_MASKED_VALUE_CONDITION__ARGUMENT:
