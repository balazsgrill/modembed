 ...
 * <ul>
 *   <li>{@link hu.modembed.model.modembed.abstraction.types.UnsignedTypeDefinition#getBits <em>Bits</em>}</li>
 * </ul>
 * </p>
 *
 * @see hu.modembed.model.modembed.abstraction.types.TypesPackage#getUnsignedTypeDefinition()
 * @model
 * @generated
 */
public interface UnsignedTypeDefinition extends PrimitiveTypeDefinition {
	 ...
	 * @see #setBits(int)
	 * @see hu.modembed.model.modembed.abstraction.types.TypesPackage#getUnsignedTypeDefinition_Bits()
	 * @model
	 * @generated
	 */
	int getBits();
	...
	/**
	 * Sets the value of the '{@link hu.modembed.model.modembed.abstraction.types.UnsignedTypeDefinition#getBits <em>Bits</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
