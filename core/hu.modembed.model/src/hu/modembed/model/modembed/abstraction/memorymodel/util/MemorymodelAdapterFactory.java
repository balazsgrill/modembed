/**
 */
package hu.modembed.model.modembed.abstraction.memorymodel.util;
 ...
 * @generated
 */
public class MemorymodelAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static MemorymodelPackage modelPackage;
	 ...
	 * @generated
	 */
	public MemorymodelAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = MemorymodelPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected MemorymodelSwitch<Adapter> modelSwitch =
		new MemorymodelSwitch<Adapter>() {
			@Override
			public Adapter caseMemoryType(MemoryType object) {
				return createMemoryTypeAdapter();
			}
			@Override
			public Adapter caseMemoryInstance(MemoryInstance object) {
				return createMemoryInstanceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.modembed.model.modembed.abstraction.memorymodel.MemoryType <em>Memory Type</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.modembed.model.modembed.abstraction.memorymodel.MemoryInstance <em>Memory Instance</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMemoryInstanceAdapter() {
		return null;
	}
