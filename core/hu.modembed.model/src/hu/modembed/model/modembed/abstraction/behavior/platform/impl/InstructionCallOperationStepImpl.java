 ...
 * <ul>
 *   <li>{@link hu.modembed.model.modembed.abstraction.behavior.platform.impl.InstructionCallOperationStepImpl#getInstruction <em>Instruction</em>}</li>
 *   <li>{@link hu.modembed.model.modembed.abstraction.behavior.platform.impl.InstructionCallOperationStepImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InstructionCallOperationStepImpl extends OperationStepImpl implements InstructionCallOperationStep {
	...
	public EList<Expression> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList<Expression>(Expression.class, this, PlatformPackage.INSTRUCTION_CALL_OPERATION_STEP__ARGUMENTS);
		}
		return arguments;
	}
