 ...
 * @generated
 */
public class AbstractionSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AbstractionPackage.DEVICE_ABSTRACTION: {
				DeviceAbstraction deviceAbstraction = (DeviceAbstraction)theEObject;
				T result = caseDeviceAbstraction(deviceAbstraction);
				if (result == null) result = caseRootElement(deviceAbstraction);
				if (result == null) result = caseNamedElement(deviceAbstraction);
				if (result == null) result = caseMODembedElement(deviceAbstraction);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Device Abstraction</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Device Abstraction</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDeviceAbstraction(DeviceAbstraction object) {
		return null;
	}
