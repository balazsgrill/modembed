 ...
 * <ul>
 *   <li>{@link hu.modembed.model.modembed.abstraction.types.PointerTypeDefinition#getPointerType <em>Pointer Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see hu.modembed.model.modembed.abstraction.types.TypesPackage#getPointerTypeDefinition()
 * @model
 * @generated
 */
public interface PointerTypeDefinition extends CompositeTypeDefinition {
	 ...
	 * @see hu.modembed.model.modembed.abstraction.types.TypesPackage#getPointerTypeDefinition_PointerType()
	...
	/**
	 * Sets the value of the '{@link hu.modembed.model.modembed.abstraction.types.PointerTypeDefinition#getPointerType <em>Pointer Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
