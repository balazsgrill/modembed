/**
 */
package hu.modembed.model.modembed.application.util;
...
public class ApplicationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ApplicationPackage.COMPONENT_ROLE: {
				ComponentRole componentRole = (ComponentRole)theEObject;
				T result = caseComponentRole(componentRole);
				if (result == null) result = caseRootElement(componentRole);
				if (result == null) result = caseNamedElement(componentRole);
				if (result == null) result = caseMODembedElement(componentRole);
