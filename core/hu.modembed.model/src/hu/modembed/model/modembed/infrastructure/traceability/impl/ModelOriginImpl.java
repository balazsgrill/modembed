 ...
 * <ul>
 *   <li>{@link hu.modembed.model.modembed.infrastructure.traceability.impl.ModelOriginImpl#getElement <em>Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelOriginImpl extends OriginImpl implements ModelOrigin {
	...
	protected EClass eStaticClass() {
		return TraceabilityPackage.Literals.MODEL_ORIGIN;
	}
		...
		if (element != null && element.eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TraceabilityPackage.MODEL_ORIGIN__ELEMENT, oldElement, element));
			}
		}
		return element;
	}
	...
	public void setElement(MODembedElement newElement) {
		...
		element = newElement;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TraceabilityPackage.MODEL_ORIGIN__ELEMENT, oldElement, element));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TraceabilityPackage.MODEL_ORIGIN__ELEMENT:
