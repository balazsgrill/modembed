...
public class ExpressionsFactoryImpl extends EFactoryImpl implements ExpressionsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ExpressionsPackage.INTEGER_CONSTANT_EXPRESSION: return createIntegerConstantExpression();
			case ExpressionsPackage.OPERATION_EXPRESSION: return createOperationExpression();
			default:
