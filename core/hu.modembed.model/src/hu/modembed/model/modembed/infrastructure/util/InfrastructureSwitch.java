/**
 */
package hu.modembed.model.modembed.infrastructure.util;
 ...
 * <!-- end-user-doc -->
 * @see hu.modembed.model.modembed.infrastructure.InfrastructurePackage
 * @generated
 */
public class InfrastructureSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case InfrastructurePackage.ROOT_ELEMENT: {
