 ...
 * <ul>
 *   <li>{@link hu.modembed.model.modembed.structured.impl.ExpressionOperationImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExpressionOperationImpl extends OperationImpl implements ExpressionOperation {
	...
	protected EClass eStaticClass() {
		return StructuredPackage.Literals.EXPRESSION_OPERATION;
	}
	...
	public void setExpression(Expression newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StructuredPackage.EXPRESSION_OPERATION__EXPRESSION, null, msgs);
			if (newExpression != null)
				msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StructuredPackage.EXPRESSION_OPERATION__EXPRESSION, null, msgs);
			msgs = basicSetExpression(newExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredPackage.EXPRESSION_OPERATION__EXPRESSION, newExpression, newExpression));
	}
