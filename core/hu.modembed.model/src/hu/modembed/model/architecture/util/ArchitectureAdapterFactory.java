/**
 */
package hu.modembed.model.architecture.util;

import hu.modembed.model.architecture.*;
...
public class ArchitectureAdapterFactory extends AdapterFactoryImpl {
	...
	protected ArchitectureSwitch<Adapter> modelSwitch =
		new ArchitectureSwitch<Adapter>() {
			...
			@Override
			public Adapter caseMemorySection(MemorySection object) {
				return createMemorySectionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.modembed.model.architecture.MemorySection <em>Memory Section</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMemorySectionAdapter() {
		return null;
	}
