...
public class Rs232Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Rs232Package.RS232_FRAME: {
				RS232Frame rs232Frame = (RS232Frame)theEObject;
				T result = caseRS232Frame(rs232Frame);
				if (result == null) result = caseFrame(rs232Frame);
				if (result == null) result = caseNamedElement(rs232Frame);
				if (result == null) result = caseMODembedElement(rs232Frame);
			...
			case Rs232Package.RS232_PROTOCOL: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>RS232 Frame</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>RS232 Frame</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRS232Frame(RS232Frame object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>RS232 Protocol</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>RS232 Protocol</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRS232Protocol(RS232Protocol object) {
		return null;
	}
