 ...
 * <ul>
 *   <li>{@link hu.modembed.model.core.assembler.impl.ParameterSectionImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterSectionImpl extends InstructionSectionImpl implements ParameterSection {
	...
	protected EClass eStaticClass() {
		return AssemblerPackage.Literals.PARAMETER_SECTION;
	}
		...
		if (parameter != null && parameter.eIsProxy()) {
			...
			if (parameter != oldParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AssemblerPackage.PARAMETER_SECTION__PARAMETER, oldParameter, parameter));
			}
		}
		return parameter;
	}
	...
	public void setParameter(InstructionParameter newParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.PARAMETER_SECTION__PARAMETER, oldParameter, parameter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssemblerPackage.PARAMETER_SECTION__PARAMETER:
