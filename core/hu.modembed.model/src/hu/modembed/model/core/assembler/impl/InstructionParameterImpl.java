 ...
 * <ul>
 *   <li>{@link hu.modembed.model.core.assembler.impl.InstructionParameterImpl#getId <em>Id</em>}</li>
 *   <li>{@link hu.modembed.model.core.assembler.impl.InstructionParameterImpl#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InstructionParameterImpl extends MODembedElementImpl implements InstructionParameter {
	...
	protected EClass eStaticClass() {
		return AssemblerPackage.Literals.INSTRUCTION_PARAMETER;
	}
	...
	public void setId(char newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.INSTRUCTION_PARAMETER__ID, oldId, id));
	}
	...
	public void setDefaultValue(int newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.INSTRUCTION_PARAMETER__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssemblerPackage.INSTRUCTION_PARAMETER__ID:
				return getId();
			case AssemblerPackage.INSTRUCTION_PARAMETER__DEFAULT_VALUE:
