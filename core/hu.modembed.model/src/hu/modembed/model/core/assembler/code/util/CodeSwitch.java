/**
 */
package hu.modembed.model.core.assembler.code.util;
...
public class CodeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CodePackage.ASSEMBLER_OBJECT: {
			...
			case CodePackage.INSTRUCTION_CALL: {
			...
			case CodePackage.INSTRUCTION_CALL_PARAMETER: {
