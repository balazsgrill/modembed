...
public class WorkflowSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WorkflowPackage.WORKFLOW: {
				...
				if (result == null) result = caseRootElement(workflow);
				if (result == null) result = caseNamedElement(workflow);
				if (result == null) result = caseMODembedElement(workflow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WorkflowPackage.WORKFLOW_TASK: {
				WorkflowTask workflowTask = (WorkflowTask)theEObject;
				T result = caseWorkflowTask(workflowTask);
				if (result == null) result = caseMODembedElement(workflowTask);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WorkflowPackage.TASK: {
				...
				if (result == null) result = caseWorkflowTask(task);
				if (result == null) result = caseMODembedElement(task);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WorkflowPackage.TASK_PARAMETER: {
				TaskParameter taskParameter = (TaskParameter)theEObject;
				T result = caseTaskParameter(taskParameter);
				if (result == null) result = caseMODembedElement(taskParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseWorkflowTask(WorkflowTask object) {
		return null;
	}
