...
public class WorkflowFactoryImpl extends EFactoryImpl implements WorkflowFactory {
	...
	public static WorkflowFactory init() {
		try {
			WorkflowFactory theWorkflowFactory = (WorkflowFactory)EPackage.Registry.INSTANCE.getEFactory("http://modembed.hu/core/workflow"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case WorkflowPackage.TASK_PARAMETER: return createTaskParameter();
			default:
