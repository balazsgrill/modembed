...
public class CodeAdapterFactory extends AdapterFactoryImpl {
	...
	protected CodeSwitch<Adapter> modelSwitch =
		new CodeSwitch<Adapter>() {
			@Override
			public Adapter caseCodeComponent(CodeComponent object) {
				return createCodeComponentAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.modembed.model.application.code.CodeComponent <em>Component</em>}'.
	 * <!-- begin-user-doc -->
