...
public class DatatypesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DatatypesPackage.DATATYPE: {
				Datatype datatype = (Datatype)theEObject;
				T result = caseDatatype(datatype);
				if (result == null) result = casePackagedElement(datatype);
				if (result == null) result = caseNamedElement(datatype);
				if (result == null) result = caseMODembedElement(datatype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DatatypesPackage.ATOMIC_TYPE: {
				AtomicType atomicType = (AtomicType)theEObject;
				T result = caseAtomicType(atomicType);
				if (result == null) result = caseDatatype(atomicType);
				if (result == null) result = casePackagedElement(atomicType);
				if (result == null) result = caseNamedElement(atomicType);
				if (result == null) result = caseMODembedElement(atomicType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DatatypesPackage.STRUCTURED_TYPE: {
				...
				if (result == null) result = casePackagedElement(structuredType);
				if (result == null) result = caseNamedElement(structuredType);
				if (result == null) result = caseMODembedElement(structuredType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DatatypesPackage.ARRAY_TYPE: {
				ArrayType arrayType = (ArrayType)theEObject;
				T result = caseArrayType(arrayType);
				if (result == null) result = caseStructuredType(arrayType);
				if (result == null) result = caseDatatype(arrayType);
				if (result == null) result = casePackagedElement(arrayType);
				if (result == null) result = caseNamedElement(arrayType);
				if (result == null) result = caseMODembedElement(arrayType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DatatypesPackage.STRUCT_TYPE: {
				StructType structType = (StructType)theEObject;
				T result = caseStructType(structType);
				if (result == null) result = caseStructuredType(structType);
				if (result == null) result = caseDatatype(structType);
				if (result == null) result = casePackagedElement(structType);
				if (result == null) result = caseNamedElement(structType);
				if (result == null) result = caseMODembedElement(structType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DatatypesPackage.STRUCT_ELEMENT: {
				StructElement structElement = (StructElement)theEObject;
				T result = caseStructElement(structElement);
				if (result == null) result = caseNamedElement(structElement);
				if (result == null) result = caseMODembedElement(structElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
