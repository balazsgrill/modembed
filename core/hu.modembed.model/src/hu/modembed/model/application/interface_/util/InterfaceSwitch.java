 ...
 * @generated
 */
public class InterfaceSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case InterfacePackage.COMPONENT_INTERFACE: {
			...
			case InterfacePackage.OPERATION_INTERFACE: {
				OperationInterface operationInterface = (OperationInterface)theEObject;
				T result = caseOperationInterface(operationInterface);
				if (result == null) result = caseComponentInterface(operationInterface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InterfacePackage.OPERATION: {
			...
			case InterfacePackage.ARGUMENT: {
				Argument argument = (Argument)theEObject;
				T result = caseArgument(argument);
				if (result == null) result = caseNamedElement(argument);
				if (result == null) result = caseMODembedElement(argument);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
