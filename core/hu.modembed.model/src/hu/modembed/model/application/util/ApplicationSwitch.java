...
public class ApplicationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ApplicationPackage.COMPONENT_TYPE: {
				ComponentType componentType = (ComponentType)theEObject;
				T result = caseComponentType(componentType);
				if (result == null) result = casePackagedElement(componentType);
				if (result == null) result = caseNamedElement(componentType);
				if (result == null) result = caseMODembedElement(componentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ApplicationPackage.COMPONENT_IMPLEMENTATION: {
				...
				if (result == null) result = casePackagedElement(componentImplementation);
				if (result == null) result = caseNamedElement(componentImplementation);
				if (result == null) result = caseMODembedElement(componentImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
