/**
 */
package hu.modembed.model.emodel.memorymap.util;
 ...
 * @generated
 */
public class MemorymapAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static MemorymapPackage modelPackage;
	 ...
	 * @generated
	 */
	public MemorymapAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = MemorymapPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected MemorymapSwitch<Adapter> modelSwitch =
		new MemorymapSwitch<Adapter>() {
			@Override
			public Adapter caseMemoryMap(MemoryMap object) {
				return createMemoryMapAdapter();
			}
			@Override
			public Adapter caseHeapLevel(HeapLevel object) {
				return createHeapLevelAdapter();
			}
			@Override
			public Adapter caseHeapVariableMapping(HeapVariableMapping object) {
				return createHeapVariableMappingAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.modembed.model.emodel.memorymap.MemoryMap <em>Memory Map</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.modembed.model.emodel.memorymap.HeapLevel <em>Heap Level</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createHeapLevelAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link hu.modembed.model.emodel.memorymap.HeapVariableMapping <em>Heap Variable Mapping</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createHeapVariableMappingAdapter() {
		return null;
	}
