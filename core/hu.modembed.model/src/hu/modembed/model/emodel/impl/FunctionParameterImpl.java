 ...
 * <ul>
 *   <li>{@link hu.modembed.model.emodel.impl.FunctionParameterImpl#isLazy <em>Lazy</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionParameterImpl extends VariableImpl implements FunctionParameter {
	...
	public void setLazy(boolean newLazy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmodelPackage.FUNCTION_PARAMETER__LAZY, oldLazy, lazy));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmodelPackage.FUNCTION_PARAMETER__LAZY:
				return isLazy();
		}
