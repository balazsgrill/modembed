 ...
 * <ul>
 *   <li>{@link hu.modembed.model.emodel.impl.LazyParameterImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LazyParameterImpl extends FunctionParameterImpl implements LazyParameter {
	...
	public EList<FunctionParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<FunctionParameter>(FunctionParameter.class, this, EmodelPackage.LAZY_PARAMETER__PARAMETERS);
		}
		return parameters;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmodelPackage.LAZY_PARAMETER__PARAMETERS:
