 ...
 * <ul>
 *   <li>{@link hu.modembed.model.emodel.expressions.impl.UnaryExpressionImpl#getOperand <em>Operand</em>}</li>
 *   <li>{@link hu.modembed.model.emodel.expressions.impl.UnaryExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnaryExpressionImpl extends ExpressionImpl implements UnaryExpression {
	...
	public void setOperand(Expression newOperand) {
		if (newOperand != operand) {
			...
			if (operand != null)
				msgs = ((InternalEObject)operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExpressionsPackage.UNARY_EXPRESSION__OPERAND, null, msgs);
			if (newOperand != null)
				msgs = ((InternalEObject)newOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ExpressionsPackage.UNARY_EXPRESSION__OPERAND, null, msgs);
			msgs = basicSetOperand(newOperand, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.UNARY_EXPRESSION__OPERAND, newOperand, newOperand));
	}
