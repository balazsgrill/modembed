...
/**
 * This is the item provider adapter for a {@link hu.e.compiler.list.ConditionalStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionalStepItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConditionalStep_condition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConditionalStep_condition_feature", "_UI_ConditionalStep_type"),
				 ListPackage.Literals.CONDITIONAL_STEP__CONDITION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ListPackage.Literals.CONDITIONAL_STEP__SUCCESS);
			childrenFeatures.add(ListPackage.Literals.CONDITIONAL_STEP__FAIL);
		}
