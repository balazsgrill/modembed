...
public class InstructionsetResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public InstructionsetResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (new hu.modembed.model.textnotations.instructionset.util.InstructionsetRuntimeUtil().isEclipsePlatformAvailable()) {
			new hu.modembed.model.textnotations.instructionset.util.InstructionsetEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new hu.modembed.model.textnotations.instructionset.mopp.InstructionsetResourceFactory());
		}
	}
