 ...
 * contains
 * <code>hu.modembed.model.textnotations.instructionset.IInstructionsetTextDiagnost
 * ic</code>s it uses the more precise information of this extended diagnostic
 * type.
 */
public class InstructionsetMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = hu.modembed.model.textnotations.instructionset.mopp.InstructionsetPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<hu.modembed.model.textnotations.instructionset.IInstructionsetCommand<Object>> commands = new java.util.ArrayList<hu.modembed.model.textnotations.instructionset.IInstructionsetCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(hu.modembed.model.textnotations.instructionset.IInstructionsetCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<hu.modembed.model.textnotations.instructionset.IInstructionsetCommand<Object>> commandsToProcess = new java.util.ArrayList<hu.modembed.model.textnotations.instructionset.IInstructionsetCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (hu.modembed.model.textnotations.instructionset.IInstructionsetCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, hu.modembed.model.textnotations.instructionset.IInstructionsetTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final hu.modembed.model.textnotations.instructionset.IInstructionsetTextDiagnostic diagnostic) {
		final hu.modembed.model.textnotations.instructionset.IInstructionsetProblem problem = diagnostic.getProblem();
		hu.modembed.model.textnotations.instructionset.InstructionsetEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new hu.modembed.model.textnotations.instructionset.IInstructionsetCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == hu.modembed.model.textnotations.instructionset.InstructionsetEProblemSeverity.ERROR) {
					...
					hu.modembed.model.textnotations.instructionset.IInstructionsetTextDiagnostic textDiagnostic = (hu.modembed.model.textnotations.instructionset.IInstructionsetTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof hu.modembed.model.textnotations.instructionset.mopp.InstructionsetResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((hu.modembed.model.textnotations.instructionset.mopp.InstructionsetResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<hu.modembed.model.textnotations.instructionset.IInstructionsetQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, hu.modembed.model.textnotations.instructionset.util.InstructionsetStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (hu.modembed.model.textnotations.instructionset.InstructionsetEProblemType nextType : hu.modembed.model.textnotations.instructionset.InstructionsetEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, hu.modembed.model.textnotations.instructionset.InstructionsetEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(hu.modembed.model.textnotations.instructionset.InstructionsetEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(hu.modembed.model.textnotations.instructionset.InstructionsetEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new hu.modembed.model.textnotations.instructionset.util.InstructionsetRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new hu.modembed.model.textnotations.instructionset.IInstructionsetCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					hu.modembed.model.textnotations.instructionset.mopp.InstructionsetPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
