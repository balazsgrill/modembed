...
public class InstructionsetTokenStyle implements hu.modembed.model.textnotations.instructionset.IInstructionsetTokenStyle {
	...
	public InstructionsetTokenStyle(int[] colorAsRGB, int[] backgroundColorAsRGB, boolean bold, boolean italic, boolean striketrough, boolean underline) {
		super();
	...
	public InstructionsetTokenStyle(hu.modembed.model.textnotations.instructionset.IInstructionsetTokenStyle styleToCopy) {
