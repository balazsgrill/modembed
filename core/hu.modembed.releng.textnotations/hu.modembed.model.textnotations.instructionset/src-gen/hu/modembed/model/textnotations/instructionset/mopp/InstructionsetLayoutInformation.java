...
/**
 * InstructionsetLayoutInformation objects are used to store layout information
 ...
 * other tokens.
 * InstructionsetLayoutInformations are aggregated in LayoutInformationAdapters.
 * One InstructionsetLayoutInformation contains the layout that was found before a
 * keyword, attribute or reference.
 */
public class InstructionsetLayoutInformation {
	 ...
	 */
	private final hu.modembed.model.textnotations.instructionset.grammar.InstructionsetSyntaxElement syntaxElement;
	...
	public InstructionsetLayoutInformation(hu.modembed.model.textnotations.instructionset.grammar.InstructionsetSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public hu.modembed.model.textnotations.instructionset.grammar.InstructionsetSyntaxElement getSyntaxElement() {
