 ...
 */
public class InstructionsetBracketPair implements hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair {
	...
	public InstructionsetBracketPair(String openingBracket, String closingBracket, boolean closingEnabledInside, boolean closeAfterEnter) {
		super();
		this.openingBracket = openingBracket;
		this.closingBracket = closingBracket;
		this.closingEnabledInside = closingEnabledInside;
