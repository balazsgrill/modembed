...
public class InstructionsetSyntaxErrorMessageConverter {
	
	private String[] tokenNames;
	
	public InstructionsetSyntaxErrorMessageConverter(String[] tokenNames) {
	 ...
	 */
	public hu.modembed.model.textnotations.instructionset.mopp.InstructionsetLocalizedMessage translateLexicalError(org.antlr.runtime3_4_0.RecognitionException e, java.util.List<org.antlr.runtime3_4_0.RecognitionException> lexerExceptions, java.util.List<Integer> lexerExceptionPositions)  {
		String message = getMessage(e);
		return new hu.modembed.model.textnotations.instructionset.mopp.InstructionsetLocalizedMessage(message, e.charPositionInLine, e.line, lexerExceptionPositions.get(lexerExceptions.indexOf(e)), lexerExceptionPositions.get(lexerExceptions.indexOf(e)));
	}
	
	/**
	 * Translates errors thrown by the parser into human readable messages.
	 */
	public hu.modembed.model.textnotations.instructionset.mopp.InstructionsetLocalizedMessage translateParseError(org.antlr.runtime3_4_0.RecognitionException e)  {
		String message = getMessage(e);
		
		if (e.token instanceof org.antlr.runtime3_4_0.CommonToken) {
			org.antlr.runtime3_4_0.CommonToken ct = (org.antlr.runtime3_4_0.CommonToken) e.token;
			return new hu.modembed.model.textnotations.instructionset.mopp.InstructionsetLocalizedMessage(message, ct.getCharPositionInLine(), ct.getLine(), ct.getStartIndex(), ct.getStopIndex());
		} else {
			int position = 1;
			int line = 1;
			if (e.token != null) {
			...
			return new hu.modembed.model.textnotations.instructionset.mopp.InstructionsetLocalizedMessage(message, position, line, 1, 5);
		}
	}
	...
	protected String getTokenName(int tokenType)  {
		...
		if (tokenType < 0) {
			...
			tokenName = hu.modembed.model.textnotations.instructionset.util.InstructionsetStringUtil.formatTokenName(tokenName);
		}
		return tokenName;
	}
