 ...
 */
public class InstructionsetStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, hu.modembed.model.textnotations.instructionset.IInstructionsetFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, hu.modembed.model.textnotations.instructionset.IInstructionsetFunction1<String, T> toStringFunction) {
