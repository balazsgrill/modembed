 ...
 * to 4 bytes).
 */
public class InstructionsetUnicodeConverter extends hu.modembed.model.textnotations.instructionset.mopp.InstructionsetInputStreamProcessor {
	 ...
	 */
	public InstructionsetUnicodeConverter(java.io.InputStream inputStream) {
