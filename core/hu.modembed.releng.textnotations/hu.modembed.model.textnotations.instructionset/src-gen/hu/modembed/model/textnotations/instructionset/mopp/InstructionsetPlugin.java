 ...
 */
public class InstructionsetPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "hu.modembed.model.textnotations.instructionset";
	/**
	...
	private static InstructionsetPlugin plugin;
	
	public InstructionsetPlugin() {
		super();
	}
	...
	public static InstructionsetPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, InstructionsetPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, InstructionsetPlugin.PLUGIN_ID, message);
		}
		final InstructionsetPlugin pluginInstance = InstructionsetPlugin.getDefault();
