...
public class TypeNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private hu.modembed.model.textnotations.type.ui.TypeNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public TypeNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new hu.modembed.model.textnotations.type.ui.TypeNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			hu.modembed.model.textnotations.type.ui.TypeUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			hu.modembed.model.textnotations.type.ui.TypeUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new hu.modembed.model.textnotations.type.mopp.TypeMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new hu.modembed.model.textnotations.type.mopp.TypeMetaInformation().getSyntaxName();
	}
