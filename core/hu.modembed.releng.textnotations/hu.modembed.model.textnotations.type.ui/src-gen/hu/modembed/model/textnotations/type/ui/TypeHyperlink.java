 ...
 */
public class TypeHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public TypeHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				hu.modembed.model.textnotations.type.mopp.TypePlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
