 ...
 */
public class TypeCompletionProposal implements java.lang.Comparable<TypeCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private hu.modembed.model.textnotations.type.mopp.TypeExpectedTerminal expectedTerminal;
	...
	public TypeCompletionProposal(hu.modembed.model.textnotations.type.mopp.TypeExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public hu.modembed.model.textnotations.type.mopp.TypeExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof TypeCompletionProposal) {
			TypeCompletionProposal other = (TypeCompletionProposal) object;
	...
	public int compareTo(TypeCompletionProposal object) {
		if (object instanceof TypeCompletionProposal) {
			TypeCompletionProposal other = (TypeCompletionProposal) object;
