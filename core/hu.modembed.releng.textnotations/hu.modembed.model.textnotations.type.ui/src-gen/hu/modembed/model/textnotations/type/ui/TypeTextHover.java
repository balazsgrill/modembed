 ...
 */
public class TypeTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private hu.modembed.model.textnotations.type.ITypeHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final hu.modembed.model.textnotations.type.ui.TypeBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(hu.modembed.model.textnotations.type.ui.TypeBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			hu.modembed.model.textnotations.type.ui.TypeDocBrowserInformationControlInput infoInput = (hu.modembed.model.textnotations.type.ui.TypeDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					hu.modembed.model.textnotations.type.ui.TypeHyperlink hyperlink = new hu.modembed.model.textnotations.type.ui.TypeHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (hu.modembed.model.textnotations.type.ui.TypeBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				hu.modembed.model.textnotations.type.ui.TypeBrowserInformationControl iControl = new hu.modembed.model.textnotations.type.ui.TypeBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof hu.modembed.model.textnotations.type.ui.TypeDocBrowserInformationControlInput) {
							hu.modembed.model.textnotations.type.ui.TypeDocBrowserInformationControlInput input = (hu.modembed.model.textnotations.type.ui.TypeDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (hu.modembed.model.textnotations.type.ui.TypeBrowserInformationControl.isAvailable(parent)) {
				hu.modembed.model.textnotations.type.ui.TypeBrowserInformationControl iControl = new hu.modembed.model.textnotations.type.ui.TypeBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public TypeTextHover(hu.modembed.model.textnotations.type.ITypeResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new hu.modembed.model.textnotations.type.ui.TypeUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((hu.modembed.model.textnotations.type.ui.TypeDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private hu.modembed.model.textnotations.type.ui.TypeDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private hu.modembed.model.textnotations.type.ui.TypeDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, hu.modembed.model.textnotations.type.ui.TypeDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				hu.modembed.model.textnotations.type.ui.TypeHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			hu.modembed.model.textnotations.type.ui.TypeHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			hu.modembed.model.textnotations.type.ui.TypeHTMLPrinter.insertPageProlog(buffer, 0, hu.modembed.model.textnotations.type.ui.TypeTextHover.getStyleSheet());
			hu.modembed.model.textnotations.type.ui.TypeHTMLPrinter.addPageEpilog(buffer);
			return new hu.modembed.model.textnotations.type.ui.TypeDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = hu.modembed.model.textnotations.type.ui.TypeHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(hu.modembed.model.textnotations.type.ui.TypeUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return hu.modembed.model.textnotations.type.util.TypeStreamUtil.getContent(styleSheetURL.openStream());
