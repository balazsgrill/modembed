 ...
 */
public class TypeCodeFoldingManager {
	
	private class FoldingUpdateListener implements hu.modembed.model.textnotations.type.ITypeBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(hu.modembed.model.textnotations.type.ui.TypeEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof hu.modembed.model.textnotations.type.ui.TypeEditor) {
				hu.modembed.model.textnotations.type.ui.TypeEditor editor = (hu.modembed.model.textnotations.type.ui.TypeEditor) workbenchPart;
	...
	protected hu.modembed.model.textnotations.type.ui.TypeEditor editor;
	 ...
	 */
	public TypeCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,hu.modembed.model.textnotations.type.ui.TypeEditor textEditor) {
	...
	private void addCloseListener(final hu.modembed.model.textnotations.type.ui.TypeEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			hu.modembed.model.textnotations.type.ui.TypeUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		hu.modembed.model.textnotations.type.ITypeTextResource textResource = (hu.modembed.model.textnotations.type.ITypeTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
