 ...
 * olInput</code>.
 */
public class TypeDocBrowserInformationControlInput {
	
	private final TypeDocBrowserInformationControlInput fPrevious;
	private TypeDocBrowserInformationControlInput fNext;
	 ...
	 */
	public TypeDocBrowserInformationControlInput(TypeDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public TypeDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public TypeDocBrowserInformationControlInput getNext() {
		return fNext;
	}
