 ...
 * a specified depth.
 */
public class TypeOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public TypeOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof hu.modembed.model.textnotations.type.ui.TypeEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			hu.modembed.model.textnotations.type.mopp.TypePlugin.logError("Exception while refreshing outline view", e);
		}
	}
