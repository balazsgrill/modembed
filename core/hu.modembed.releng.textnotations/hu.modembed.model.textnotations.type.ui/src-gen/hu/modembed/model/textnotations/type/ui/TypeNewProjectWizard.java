 ...
 */
public class TypeNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new hu.modembed.model.textnotations.type.mopp.TypeMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("hu.modembed.model.textnotations.type.ui");
							...
							String natureID = hu.modembed.model.textnotations.type.mopp.TypeNature.NATURE_ID;
							...
							for (String builderID : hu.modembed.model.textnotations.type.mopp.TypeNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								hu.modembed.model.textnotations.type.mopp.TypeMetaInformation info = new hu.modembed.model.textnotations.type.mopp.TypeMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = hu.modembed.model.textnotations.type.ui.TypeUIPlugin.getDefault().getBundle();
