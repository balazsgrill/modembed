 ...
 */
public class TypeNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public TypeNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new type file");
