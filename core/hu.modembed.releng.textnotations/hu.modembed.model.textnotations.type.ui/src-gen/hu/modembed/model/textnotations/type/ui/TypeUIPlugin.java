 ...
 */
public class TypeUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "hu.modembed.model.textnotations.type.ui";
	public static final String EDITOR_ID = "hu.modembed.model.textnotations.type.ui.TypeEditor";
	...
	private static TypeUIPlugin plugin;
	...
	public static TypeUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, TypeUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, TypeUIPlugin.PLUGIN_ID, message);
		}
		final TypeUIPlugin pluginInstance = TypeUIPlugin.getDefault();
