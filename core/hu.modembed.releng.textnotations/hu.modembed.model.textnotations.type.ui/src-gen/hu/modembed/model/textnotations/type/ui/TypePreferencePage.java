 ...
 */
public class TypePreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(hu.modembed.model.textnotations.type.ui.TypeUIPlugin.getDefault().getPreferenceStore());
		setDescription("Type Text Editor Preferences");
	}
