 ...
 */
public class TypeSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public TypeSyntaxColoringPreferencePage() {
		super();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = hu.modembed.model.textnotations.type.ui.TypeSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.type.ui.TypeSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = hu.modembed.model.textnotations.type.ui.TypeSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.type.ui.TypeSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = hu.modembed.model.textnotations.type.ui.TypeSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.type.ui.TypeSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = hu.modembed.model.textnotations.type.ui.TypeSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.type.ui.TypeSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = hu.modembed.model.textnotations.type.ui.TypeSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.type.ui.TypeSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = hu.modembed.model.textnotations.type.ui.TypeSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.type.ui.TypeSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		hu.modembed.model.textnotations.type.ui.TypePixelConverter pixelConverter = new hu.modembed.model.textnotations.type.ui.TypePixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof hu.modembed.model.textnotations.type.ui.TypeEditor) {
			hu.modembed.model.textnotations.type.ui.TypeEditor emfTextEditor = (hu.modembed.model.textnotations.type.ui.TypeEditor) editor;
