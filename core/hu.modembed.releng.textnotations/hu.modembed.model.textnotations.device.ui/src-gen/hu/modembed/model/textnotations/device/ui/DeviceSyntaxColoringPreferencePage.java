 ...
 */
public class DeviceSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public DeviceSyntaxColoringPreferencePage() {
		super();
		
		hu.modembed.model.textnotations.device.mopp.DeviceMetaInformation metaInformation = new hu.modembed.model.textnotations.device.mopp.DeviceMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = hu.modembed.model.textnotations.device.ui.DeviceSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.device.ui.DeviceSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = hu.modembed.model.textnotations.device.ui.DeviceSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.device.ui.DeviceSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = hu.modembed.model.textnotations.device.ui.DeviceSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.device.ui.DeviceSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = hu.modembed.model.textnotations.device.ui.DeviceSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.device.ui.DeviceSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = hu.modembed.model.textnotations.device.ui.DeviceSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.device.ui.DeviceSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = hu.modembed.model.textnotations.device.ui.DeviceSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.device.ui.DeviceSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		hu.modembed.model.textnotations.device.ui.DevicePixelConverter pixelConverter = new hu.modembed.model.textnotations.device.ui.DevicePixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof hu.modembed.model.textnotations.device.ui.DeviceEditor) {
			hu.modembed.model.textnotations.device.ui.DeviceEditor emfTextEditor = (hu.modembed.model.textnotations.device.ui.DeviceEditor) editor;
