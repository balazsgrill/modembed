 ...
 */
public class DeviceCodeFoldingManager {
	
	private class FoldingUpdateListener implements hu.modembed.model.textnotations.device.IDeviceBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(hu.modembed.model.textnotations.device.ui.DeviceEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof hu.modembed.model.textnotations.device.ui.DeviceEditor) {
				hu.modembed.model.textnotations.device.ui.DeviceEditor editor = (hu.modembed.model.textnotations.device.ui.DeviceEditor) workbenchPart;
	...
	protected hu.modembed.model.textnotations.device.ui.DeviceEditor editor;
	 ...
	 */
	public DeviceCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,hu.modembed.model.textnotations.device.ui.DeviceEditor textEditor) {
	...
	private void addCloseListener(final hu.modembed.model.textnotations.device.ui.DeviceEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			hu.modembed.model.textnotations.device.ui.DeviceUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		hu.modembed.model.textnotations.device.IDeviceTextResource textResource = (hu.modembed.model.textnotations.device.IDeviceTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
