 ...
 * olInput</code>.
 */
public class DeviceDocBrowserInformationControlInput {
	
	private final DeviceDocBrowserInformationControlInput fPrevious;
	private DeviceDocBrowserInformationControlInput fNext;
	 ...
	 */
	public DeviceDocBrowserInformationControlInput(DeviceDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public DeviceDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public DeviceDocBrowserInformationControlInput getNext() {
		return fNext;
	}
