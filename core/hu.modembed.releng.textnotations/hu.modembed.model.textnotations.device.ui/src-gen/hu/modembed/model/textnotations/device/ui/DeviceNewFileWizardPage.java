 ...
 */
public class DeviceNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public DeviceNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new device file");
