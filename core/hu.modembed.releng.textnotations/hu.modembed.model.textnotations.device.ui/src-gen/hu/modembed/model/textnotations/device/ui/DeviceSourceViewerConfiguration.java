 ...
 */
public class DeviceSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private hu.modembed.model.textnotations.device.ui.DeviceQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public DeviceSourceViewerConfiguration(hu.modembed.model.textnotations.device.IDeviceResourceProvider resourceProvider, hu.modembed.model.textnotations.device.ui.IDeviceAnnotationModelProvider annotationModelProvider, hu.modembed.model.textnotations.device.ui.DeviceColorManager colorManager) {
		super(hu.modembed.model.textnotations.device.ui.DeviceUIPlugin.getDefault().getPreferenceStore());
	 ...
	 * hu.modembed.model.textnotations.device.ui.DeviceAutoEditStrategy.
	 */
	public org.eclipse.jface.text.IAutoEditStrategy[] getAutoEditStrategies(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.eclipse.jface.text.IAutoEditStrategy[] {new hu.modembed.model.textnotations.device.ui.DeviceAutoEditStrategy()};
	}
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new hu.modembed.model.textnotations.device.ui.DeviceCompletionProcessor(resourceProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new hu.modembed.model.textnotations.device.ui.DeviceUIMetaInformation().createTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new hu.modembed.model.textnotations.device.ui.DeviceTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new hu.modembed.model.textnotations.device.ui.DeviceHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new hu.modembed.model.textnotations.device.ui.DeviceQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new hu.modembed.model.textnotations.device.ui.DeviceIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
