 ...
 */
public class DevicePreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(hu.modembed.model.textnotations.device.ui.DeviceUIPlugin.getDefault().getPreferenceStore());
		setDescription("Device Text Editor Preferences");
	}
