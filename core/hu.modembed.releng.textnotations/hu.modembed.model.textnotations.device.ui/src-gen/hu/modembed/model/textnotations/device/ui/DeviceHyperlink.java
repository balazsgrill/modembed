 ...
 */
public class DeviceHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public DeviceHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				hu.modembed.model.textnotations.device.mopp.DevicePlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
