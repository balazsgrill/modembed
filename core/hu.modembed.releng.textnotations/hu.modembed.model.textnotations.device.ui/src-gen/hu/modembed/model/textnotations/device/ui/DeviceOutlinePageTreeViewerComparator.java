...
public class DeviceOutlinePageTreeViewerComparator extends org.eclipse.jface.viewers.ViewerComparator {
	...
	public int compare(org.eclipse.jface.viewers.Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof org.eclipse.emf.ecore.EObject && o2 instanceof org.eclipse.emf.ecore.EObject) {
			...
			hu.modembed.model.textnotations.device.IDeviceNameProvider nameProvider = new hu.modembed.model.textnotations.device.mopp.DeviceMetaInformation().createNameProvider();
