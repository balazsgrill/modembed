...
public class DevicePropertySheetPage extends org.eclipse.ui.views.properties.PropertySheetPage implements org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	public void selectionChanged(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection iSelection) {
		...
		if (iSelection instanceof hu.modembed.model.textnotations.device.ui.DeviceEObjectSelection) {
			final hu.modembed.model.textnotations.device.ui.DeviceEObjectSelection selection = (hu.modembed.model.textnotations.device.ui.DeviceEObjectSelection) iSelection;
