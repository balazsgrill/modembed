 ...
 * a specified depth.
 */
public class DeviceOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public DeviceOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof hu.modembed.model.textnotations.device.ui.DeviceEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			hu.modembed.model.textnotations.device.mopp.DevicePlugin.logError("Exception while refreshing outline view", e);
		}
	}
