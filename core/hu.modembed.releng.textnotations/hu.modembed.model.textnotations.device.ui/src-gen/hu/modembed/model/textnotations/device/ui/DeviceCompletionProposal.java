 ...
 */
public class DeviceCompletionProposal implements java.lang.Comparable<DeviceCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private hu.modembed.model.textnotations.device.mopp.DeviceExpectedTerminal expectedTerminal;
	...
	public DeviceCompletionProposal(hu.modembed.model.textnotations.device.mopp.DeviceExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public DeviceCompletionProposal(hu.modembed.model.textnotations.device.mopp.DeviceExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
	...
	public hu.modembed.model.textnotations.device.mopp.DeviceExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof DeviceCompletionProposal) {
			DeviceCompletionProposal other = (DeviceCompletionProposal) object;
	...
	public int compareTo(DeviceCompletionProposal object) {
		if (object instanceof DeviceCompletionProposal) {
			DeviceCompletionProposal other = (DeviceCompletionProposal) object;
