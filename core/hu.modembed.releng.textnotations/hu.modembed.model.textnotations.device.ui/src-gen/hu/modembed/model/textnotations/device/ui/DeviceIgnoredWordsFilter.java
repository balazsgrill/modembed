 ...
 */
public class DeviceIgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
