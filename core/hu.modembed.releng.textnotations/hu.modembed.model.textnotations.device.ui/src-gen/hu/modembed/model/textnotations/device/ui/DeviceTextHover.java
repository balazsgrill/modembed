 ...
 */
public class DeviceTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private hu.modembed.model.textnotations.device.IDeviceHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final hu.modembed.model.textnotations.device.ui.DeviceBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(hu.modembed.model.textnotations.device.ui.DeviceBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			hu.modembed.model.textnotations.device.ui.DeviceDocBrowserInformationControlInput infoInput = (hu.modembed.model.textnotations.device.ui.DeviceDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					hu.modembed.model.textnotations.device.ui.DeviceHyperlink hyperlink = new hu.modembed.model.textnotations.device.ui.DeviceHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (hu.modembed.model.textnotations.device.ui.DeviceBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				hu.modembed.model.textnotations.device.ui.DeviceBrowserInformationControl iControl = new hu.modembed.model.textnotations.device.ui.DeviceBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof hu.modembed.model.textnotations.device.ui.DeviceDocBrowserInformationControlInput) {
							hu.modembed.model.textnotations.device.ui.DeviceDocBrowserInformationControlInput input = (hu.modembed.model.textnotations.device.ui.DeviceDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (hu.modembed.model.textnotations.device.ui.DeviceBrowserInformationControl.isAvailable(parent)) {
				hu.modembed.model.textnotations.device.ui.DeviceBrowserInformationControl iControl = new hu.modembed.model.textnotations.device.ui.DeviceBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public DeviceTextHover(hu.modembed.model.textnotations.device.IDeviceResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new hu.modembed.model.textnotations.device.ui.DeviceUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((hu.modembed.model.textnotations.device.ui.DeviceDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private hu.modembed.model.textnotations.device.ui.DeviceDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private hu.modembed.model.textnotations.device.ui.DeviceDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, hu.modembed.model.textnotations.device.ui.DeviceDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				hu.modembed.model.textnotations.device.ui.DeviceHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			hu.modembed.model.textnotations.device.ui.DeviceHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			hu.modembed.model.textnotations.device.ui.DeviceHTMLPrinter.insertPageProlog(buffer, 0, hu.modembed.model.textnotations.device.ui.DeviceTextHover.getStyleSheet());
			hu.modembed.model.textnotations.device.ui.DeviceHTMLPrinter.addPageEpilog(buffer);
			return new hu.modembed.model.textnotations.device.ui.DeviceDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = hu.modembed.model.textnotations.device.ui.DeviceHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(hu.modembed.model.textnotations.device.ui.DeviceUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return hu.modembed.model.textnotations.device.util.DeviceStreamUtil.getContent(styleSheetURL.openStream());
