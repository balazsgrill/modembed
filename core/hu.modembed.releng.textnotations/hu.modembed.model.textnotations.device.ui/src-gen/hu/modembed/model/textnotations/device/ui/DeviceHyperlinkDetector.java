 ...
 * hovers, is a proxy.
 */
public class DeviceHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public DeviceHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (hu.modembed.model.textnotations.device.IDeviceTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new hu.modembed.model.textnotations.device.ui.DeviceHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
