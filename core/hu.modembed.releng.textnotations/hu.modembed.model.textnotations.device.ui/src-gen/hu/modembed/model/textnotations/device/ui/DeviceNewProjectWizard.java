 ...
 */
public class DeviceNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new hu.modembed.model.textnotations.device.mopp.DeviceMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("hu.modembed.model.textnotations.device.ui");
							...
							String natureID = hu.modembed.model.textnotations.device.mopp.DeviceNature.NATURE_ID;
							...
							for (String builderID : hu.modembed.model.textnotations.device.mopp.DeviceNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								hu.modembed.model.textnotations.device.mopp.DeviceMetaInformation info = new hu.modembed.model.textnotations.device.mopp.DeviceMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = hu.modembed.model.textnotations.device.ui.DeviceUIPlugin.getDefault().getBundle();
