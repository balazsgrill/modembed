...
/**
 * The DeviceAutoEditStrategy extends the default auto edit strategy such that an
 ...
 */
public class DeviceAutoEditStrategy extends org.eclipse.jface.text.DefaultIndentLineAutoEditStrategy {
	
	private hu.modembed.model.textnotations.device.ui.DeviceBracketSet bracketSet;
	
	public DeviceAutoEditStrategy() {
		super();
	 ...
	 */
	@Deprecated	
	public void setBracketSet(hu.modembed.model.textnotations.device.ui.DeviceBracketSet bracketSet) {
