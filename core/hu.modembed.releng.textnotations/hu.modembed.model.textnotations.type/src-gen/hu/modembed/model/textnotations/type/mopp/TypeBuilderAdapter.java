...
public class TypeBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "hu.modembed.model.textnotations.type.builder";
	
	private hu.modembed.model.textnotations.type.ITypeBuilder defaultBuilder = new hu.modembed.model.textnotations.type.mopp.TypeBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		hu.modembed.model.textnotations.type.ITypeBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			hu.modembed.model.textnotations.type.mopp.TypeResource customResource = (hu.modembed.model.textnotations.type.mopp.TypeResource) resourceSet.getResource(uri, true);
			new hu.modembed.model.textnotations.type.mopp.TypeMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public hu.modembed.model.textnotations.type.ITypeBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new hu.modembed.model.textnotations.type.mopp.TypeMarkerHelper().getMarkerID(hu.modembed.model.textnotations.type.TypeEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		hu.modembed.model.textnotations.type.mopp.TypeTaskItemBuilder taskItemBuilder = new hu.modembed.model.textnotations.type.mopp.TypeTaskItemBuilder();
		new hu.modembed.model.textnotations.type.mopp.TypeMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new hu.modembed.model.textnotations.type.mopp.TypeMetaInformation().getSyntaxName())) {
