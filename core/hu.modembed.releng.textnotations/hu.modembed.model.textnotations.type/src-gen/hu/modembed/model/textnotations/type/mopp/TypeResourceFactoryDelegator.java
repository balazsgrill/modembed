...
public class TypeResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public TypeResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (new hu.modembed.model.textnotations.type.util.TypeRuntimeUtil().isEclipsePlatformAvailable()) {
			new hu.modembed.model.textnotations.type.util.TypeEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new hu.modembed.model.textnotations.type.mopp.TypeResourceFactory());
		}
	}
