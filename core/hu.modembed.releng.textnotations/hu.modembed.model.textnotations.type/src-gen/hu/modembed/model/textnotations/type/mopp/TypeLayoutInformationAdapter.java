...
/**
 * A TypeLayoutInformationAdapter is used to store layout information that is
 ...
 * TypeLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class TypeLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<hu.modembed.model.textnotations.type.mopp.TypeLayoutInformation> layoutInformations = new java.util.ArrayList<hu.modembed.model.textnotations.type.mopp.TypeLayoutInformation>();
	...
	public java.util.List<hu.modembed.model.textnotations.type.mopp.TypeLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(hu.modembed.model.textnotations.type.mopp.TypeLayoutInformation layoutInformation) {
