 ...
 * to 4 bytes).
 */
public class TypeUnicodeConverter extends hu.modembed.model.textnotations.type.mopp.TypeInputStreamProcessor {
	 ...
	 */
	public TypeUnicodeConverter(java.io.InputStream inputStream) {
