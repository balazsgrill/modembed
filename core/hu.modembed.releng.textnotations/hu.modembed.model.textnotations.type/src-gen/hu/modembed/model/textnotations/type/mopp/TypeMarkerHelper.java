 ...
 * contains <code>hu.modembed.model.textnotations.type.ITypeTextDiagnostic</code>s
 * it uses the more precise information of this extended diagnostic type.
 */
public class TypeMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = hu.modembed.model.textnotations.type.mopp.TypePlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<hu.modembed.model.textnotations.type.ITypeCommand<Object>> commands = new java.util.ArrayList<hu.modembed.model.textnotations.type.ITypeCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(hu.modembed.model.textnotations.type.ITypeCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<hu.modembed.model.textnotations.type.ITypeCommand<Object>> commandsToProcess = new java.util.ArrayList<hu.modembed.model.textnotations.type.ITypeCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (hu.modembed.model.textnotations.type.ITypeCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, hu.modembed.model.textnotations.type.ITypeTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final hu.modembed.model.textnotations.type.ITypeTextDiagnostic diagnostic) {
		final hu.modembed.model.textnotations.type.ITypeProblem problem = diagnostic.getProblem();
		hu.modembed.model.textnotations.type.TypeEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new hu.modembed.model.textnotations.type.ITypeCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == hu.modembed.model.textnotations.type.TypeEProblemSeverity.ERROR) {
					...
					hu.modembed.model.textnotations.type.ITypeTextDiagnostic textDiagnostic = (hu.modembed.model.textnotations.type.ITypeTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof hu.modembed.model.textnotations.type.mopp.TypeResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((hu.modembed.model.textnotations.type.mopp.TypeResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<hu.modembed.model.textnotations.type.ITypeQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, hu.modembed.model.textnotations.type.util.TypeStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (hu.modembed.model.textnotations.type.TypeEProblemType nextType : hu.modembed.model.textnotations.type.TypeEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, hu.modembed.model.textnotations.type.TypeEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(hu.modembed.model.textnotations.type.TypeEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(hu.modembed.model.textnotations.type.TypeEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new hu.modembed.model.textnotations.type.util.TypeRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new hu.modembed.model.textnotations.type.ITypeCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					hu.modembed.model.textnotations.type.mopp.TypePlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
