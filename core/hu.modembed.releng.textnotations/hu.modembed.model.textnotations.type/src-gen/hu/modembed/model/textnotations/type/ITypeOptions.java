...
public interface ITypeOptions {
	 ...
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new hu.modembed.model.textnotations.type.mopp.TypeMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new hu.modembed.model.textnotations.type.mopp.TypeMetaInformation().getResourcePostProcessorProviderOptionKey();
