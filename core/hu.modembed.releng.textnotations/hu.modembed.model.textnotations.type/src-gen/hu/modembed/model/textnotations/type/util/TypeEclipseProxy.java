...
public class TypeEclipseProxy {
	...
	public void getDefaultLoadOptionProviderExtensions(java.util.Map<Object, Object> optionsMap) {
		if (org.eclipse.core.runtime.Platform.isRunning()) {
			...
			org.eclipse.core.runtime.IConfigurationElement configurationElements[] = extensionRegistry.getConfigurationElementsFor(hu.modembed.model.textnotations.type.mopp.TypePlugin.EP_DEFAULT_LOAD_OPTIONS_ID);
			for (org.eclipse.core.runtime.IConfigurationElement element : configurationElements) {
				try {
					hu.modembed.model.textnotations.type.ITypeOptionProvider provider = (hu.modembed.model.textnotations.type.ITypeOptionProvider) element.createExecutableExtension("class");
					final java.util.Map<?, ?> options = provider.getOptions();
					final java.util.Collection<?> keys = options.keySet();
					for (Object key : keys) {
						hu.modembed.model.textnotations.type.util.TypeMapUtil.putAndMergeKeys(optionsMap, key, options.get(key));
					}
				} catch (org.eclipse.core.runtime.CoreException ce) {
					new hu.modembed.model.textnotations.type.util.TypeRuntimeUtil().logError("Exception while getting default options.", ce);
				}
			}
		}
	}
	...
	public void getResourceFactoryExtensions(java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories) {
		if (org.eclipse.core.runtime.Platform.isRunning()) {
			org.eclipse.core.runtime.IExtensionRegistry extensionRegistry = org.eclipse.core.runtime.Platform.getExtensionRegistry();
			org.eclipse.core.runtime.IConfigurationElement configurationElements[] = extensionRegistry.getConfigurationElementsFor(hu.modembed.model.textnotations.type.mopp.TypePlugin.EP_ADDITIONAL_EXTENSION_PARSER_ID);
			for (org.eclipse.core.runtime.IConfigurationElement element : configurationElements) {
				try {
	 ...
	 */
	public hu.modembed.model.textnotations.type.mopp.TypeResource getResource(org.eclipse.core.resources.IFile file) {
	...
	public void checkEMFValidationConstraints(hu.modembed.model.textnotations.type.ITypeTextResource resource, org.eclipse.emf.ecore.EObject root, boolean includeBatchConstraints) {
		...
		hu.modembed.model.textnotations.type.util.TypeRuntimeUtil runtimeUtil = new hu.modembed.model.textnotations.type.util.TypeRuntimeUtil();
			...
			if (org.eclipse.emf.validation.internal.EMFModelValidationPlugin.getPlugin() != null) {
				try {
					...
					if (includeBatchConstraints) {
						...
						addStatus(status, resource, root, hu.modembed.model.textnotations.type.TypeEProblemType.BATCH_CONSTRAINT_PROBLEM);
					}
					...
					addStatus(status, resource, root, hu.modembed.model.textnotations.type.TypeEProblemType.LIVE_CONSTRAINT_PROBLEM);
				} catch (Throwable t) {
					new hu.modembed.model.textnotations.type.util.TypeRuntimeUtil().logError("Exception while checking contraints provided by EMF validator classes.", t);
				}
			}
		}
	}
	...
	public void addStatus(org.eclipse.core.runtime.IStatus status, hu.modembed.model.textnotations.type.ITypeTextResource resource, org.eclipse.emf.ecore.EObject root, hu.modembed.model.textnotations.type.TypeEProblemType problemType) {
	...
	public String getPlatformResourceEncoding(org.eclipse.emf.common.util.URI uri) {
		...
		if (!new hu.modembed.model.textnotations.type.util.TypeRuntimeUtil().isEclipsePlatformRunning()) {
			return null;
		}
		if (uri != null && uri.isPlatform()) {
			...
			if (platformResource instanceof org.eclipse.core.resources.IFile) {
				...
				try {
					...
					new hu.modembed.model.textnotations.type.util.TypeRuntimeUtil().logWarning("Could not determine encoding of platform resource: " + uri.toString(), ce);
				}
			}
		}
		return null;
