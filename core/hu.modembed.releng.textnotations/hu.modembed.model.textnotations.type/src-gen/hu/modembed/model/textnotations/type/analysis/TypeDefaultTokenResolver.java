 ...
 */
public class TypeDefaultTokenResolver implements hu.modembed.model.textnotations.type.ITypeTokenResolver {
	 ...
	 */
	public TypeDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public TypeDefaultTokenResolver(boolean escapeKeywords) {
		super();
		this.escapeKeywords = escapeKeywords;
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, hu.modembed.model.textnotations.type.ITypeTokenResolveResult result) {
		resolve(lexem, feature, result, null, null, null);
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, hu.modembed.model.textnotations.type.ITypeTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : hu.modembed.model.textnotations.type.grammar.TypeGrammarInformationProvider.INSTANCE.getKeywords()) {
