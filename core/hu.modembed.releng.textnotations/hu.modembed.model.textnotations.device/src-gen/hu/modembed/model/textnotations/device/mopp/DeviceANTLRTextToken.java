...
public class DeviceANTLRTextToken extends hu.modembed.model.textnotations.device.mopp.DeviceTextToken {
	
	private final static hu.modembed.model.textnotations.device.IDeviceMetaInformation metaInformation = new hu.modembed.model.textnotations.device.mopp.DeviceMetaInformation();
	
	public DeviceANTLRTextToken(org.antlr.runtime3_4_0.Token antlrToken) {
