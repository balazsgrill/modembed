...
public class DeviceFollowSetProvider {
	...
	public final static hu.modembed.model.textnotations.device.IDeviceExpectedElement TERMINALS[] = new hu.modembed.model.textnotations.device.IDeviceExpectedElement[68];
	
	public final static org.eclipse.emf.ecore.EStructuralFeature[] FEATURES = new org.eclipse.emf.ecore.EStructuralFeature[12];
	
	public final static hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature[] LINKS = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature[32];
	...
	public static void initializeTerminals0() {
		...
		TERMINALS[38] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.TYPE_1_0_0_0);
		TERMINALS[39] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedStructuralFeature(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.TYPE_2_0_0_0);
		TERMINALS[40] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_7_0_0_4);
		TERMINALS[41] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_7_0_0_3_0_0_1_0_0_0);
		TERMINALS[42] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_7_0_0_5);
		TERMINALS[43] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedStructuralFeature(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_9_0_0_0);
		TERMINALS[44] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_7_0_0_7);
		TERMINALS[45] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_8_0_0_1);
		TERMINALS[46] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedStructuralFeature(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_8_0_0_2);
		...
		TERMINALS[49] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedStructuralFeature(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_8_0_0_5);
		TERMINALS[50] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_9_0_0_1);
		TERMINALS[51] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedStructuralFeature(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_10_0_0_0);
		TERMINALS[52] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_9_0_0_3);
		TERMINALS[53] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_9_0_0_2_0_0_1_0_0_0);
		TERMINALS[54] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_9_0_0_4);
		TERMINALS[55] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_10_0_0_1_0_0_0);
		TERMINALS[56] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_10_0_0_2_0_0_0);
		TERMINALS[57] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_10_0_0_3_0_0_0);
		TERMINALS[58] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedStructuralFeature(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_10_0_0_1_0_0_1);
		TERMINALS[59] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedStructuralFeature(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_10_0_0_2_0_0_1);
		TERMINALS[60] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedStructuralFeature(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.DEVICE_10_0_0_3_0_0_1);
		TERMINALS[61] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.TYPE_0_0_0_0);
		TERMINALS[62] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedStructuralFeature(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.TYPE_0_0_0_1);
		TERMINALS[63] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.TYPE_0_0_0_2);
		TERMINALS[64] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.TYPE_0_0_0_4);
		TERMINALS[65] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.TYPE_1_0_0_1);
		TERMINALS[66] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedStructuralFeature(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.TYPE_1_0_0_2);
		TERMINALS[67] = new hu.modembed.model.textnotations.device.mopp.DeviceExpectedCsString(hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.TYPE_1_0_0_3);
	}
	...
	public static void initializeFeatures0() {
		...
		FEATURES[7] = hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getOperationArgument().getEStructuralFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.OPERATION_ARGUMENT__TYPE);
		FEATURES[8] = hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getOperationDefinition().getEStructuralFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.OPERATION_DEFINITION__ARGUMENTS);
		FEATURES[9] = hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getOperationDefinition().getEStructuralFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.OPERATION_DEFINITION__STEPS);
	...
	public static void initializeLinks0() {
		...
		LINKS[17] = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.types.TypesPackage.eINSTANCE.getUnsignedTypeDefinition(), FEATURES[7]);
		LINKS[18] = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getOperationArgument(), FEATURES[8]);
		LINKS[19] = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.types.TypesPackage.eINSTANCE.getReferenceTypeDefinition(), FEATURES[7]);
		LINKS[20] = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getOperationArgument(), FEATURES[8]);
		LINKS[21] = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.types.TypesPackage.eINSTANCE.getUnsignedTypeDefinition(), FEATURES[7]);
		LINKS[22] = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getOperationArgument(), FEATURES[8]);
		LINKS[23] = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.types.TypesPackage.eINSTANCE.getReferenceTypeDefinition(), FEATURES[7]);
		LINKS[24] = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getOperationArgument(), FEATURES[8]);
		LINKS[25] = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getInstructionCallOperationStep(), FEATURES[9]);
		LINKS[26] = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getInstructionCallOperationStep(), FEATURES[9]);
		LINKS[27] = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getInstructionParameterMapping(), FEATURES[10]);
		LINKS[28] = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getInstructionParameterMapping(), FEATURES[10]);
		LINKS[29] = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getInstructionCallOperationStep(), FEATURES[9]);
		LINKS[30] = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.types.TypesPackage.eINSTANCE.getUnsignedTypeDefinition(), FEATURES[11]);
		LINKS[31] = new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.types.TypesPackage.eINSTANCE.getReferenceTypeDefinition(), FEATURES[11]);
	}
	...
	public static void wire0() {
		...
		TERMINALS[37].addFollower(TERMINALS[38], new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature[] {new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.types.TypesPackage.eINSTANCE.getUnsignedTypeDefinition(), FEATURES[7]), new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getOperationArgument(), FEATURES[8]), });
		TERMINALS[37].addFollower(TERMINALS[39], new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature[] {new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.types.TypesPackage.eINSTANCE.getReferenceTypeDefinition(), FEATURES[7]), new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getOperationArgument(), FEATURES[8]), });
		TERMINALS[37].addFollower(TERMINALS[40], EMPTY_LINK_ARRAY);
		TERMINALS[41].addFollower(TERMINALS[38], new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature[] {new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.types.TypesPackage.eINSTANCE.getUnsignedTypeDefinition(), FEATURES[7]), new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getOperationArgument(), FEATURES[8]), });
		TERMINALS[41].addFollower(TERMINALS[39], new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature[] {new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.types.TypesPackage.eINSTANCE.getReferenceTypeDefinition(), FEATURES[7]), new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getOperationArgument(), FEATURES[8]), });
		TERMINALS[40].addFollower(TERMINALS[42], EMPTY_LINK_ARRAY);
		TERMINALS[42].addFollower(TERMINALS[43], new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature[] {new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getInstructionCallOperationStep(), FEATURES[9]), });
		TERMINALS[42].addFollower(TERMINALS[44], EMPTY_LINK_ARRAY);
		TERMINALS[44].addFollower(TERMINALS[10], EMPTY_LINK_ARRAY);
		...
		TERMINALS[49].addFollower(TERMINALS[40], EMPTY_LINK_ARRAY);
		TERMINALS[43].addFollower(TERMINALS[50], EMPTY_LINK_ARRAY);
		TERMINALS[50].addFollower(TERMINALS[51], new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature[] {new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getInstructionParameterMapping(), FEATURES[10]), });
		TERMINALS[50].addFollower(TERMINALS[52], EMPTY_LINK_ARRAY);
		TERMINALS[53].addFollower(TERMINALS[51], new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature[] {new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getInstructionParameterMapping(), FEATURES[10]), });
		TERMINALS[52].addFollower(TERMINALS[54], EMPTY_LINK_ARRAY);
		TERMINALS[54].addFollower(TERMINALS[43], new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature[] {new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.behavior.platform.PlatformPackage.eINSTANCE.getInstructionCallOperationStep(), FEATURES[9]), });
		TERMINALS[54].addFollower(TERMINALS[44], EMPTY_LINK_ARRAY);
		TERMINALS[51].addFollower(TERMINALS[55], EMPTY_LINK_ARRAY);
		TERMINALS[51].addFollower(TERMINALS[56], EMPTY_LINK_ARRAY);
		TERMINALS[51].addFollower(TERMINALS[57], EMPTY_LINK_ARRAY);
		...
		TERMINALS[59].addFollower(TERMINALS[52], EMPTY_LINK_ARRAY);
		...
		TERMINALS[63].addFollower(TERMINALS[38], new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature[] {new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.types.TypesPackage.eINSTANCE.getUnsignedTypeDefinition(), FEATURES[11]), });
		TERMINALS[63].addFollower(TERMINALS[39], new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature[] {new hu.modembed.model.textnotations.device.mopp.DeviceContainedFeature(hu.modembed.model.modembed.abstraction.types.TypesPackage.eINSTANCE.getReferenceTypeDefinition(), FEATURES[11]), });
		TERMINALS[38].addFollower(TERMINALS[65], EMPTY_LINK_ARRAY);
		...
		TERMINALS[67].addFollower(TERMINALS[64], EMPTY_LINK_ARRAY);
