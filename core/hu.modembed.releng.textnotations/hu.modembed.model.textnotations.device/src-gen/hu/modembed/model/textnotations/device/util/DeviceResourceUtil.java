...
public class DeviceResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new hu.modembed.model.textnotations.device.util.DeviceInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new hu.modembed.model.textnotations.device.util.DeviceInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static hu.modembed.model.textnotations.device.mopp.DeviceResource getResource(java.io.File file) {
	...
	public static hu.modembed.model.textnotations.device.mopp.DeviceResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new hu.modembed.model.textnotations.device.mopp.DeviceMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (hu.modembed.model.textnotations.device.mopp.DeviceResource) resource;
	}
	 ...
	 */
	public static hu.modembed.model.modembed.abstraction.DeviceAbstraction getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static hu.modembed.model.modembed.abstraction.DeviceAbstraction getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (hu.modembed.model.modembed.abstraction.DeviceAbstraction) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static hu.modembed.model.modembed.abstraction.DeviceAbstraction getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		hu.modembed.model.textnotations.device.IDeviceTextResource resource = (hu.modembed.model.textnotations.device.IDeviceTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (hu.modembed.model.textnotations.device.IDeviceTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		hu.modembed.model.textnotations.device.IDeviceTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
