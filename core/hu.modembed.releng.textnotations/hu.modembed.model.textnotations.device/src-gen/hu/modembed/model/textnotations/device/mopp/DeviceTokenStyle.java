...
public class DeviceTokenStyle implements hu.modembed.model.textnotations.device.IDeviceTokenStyle {
	...
	public DeviceTokenStyle(int[] colorAsRGB, int[] backgroundColorAsRGB, boolean bold, boolean italic, boolean striketrough, boolean underline) {
		super();
	...
	public DeviceTokenStyle(hu.modembed.model.textnotations.device.IDeviceTokenStyle styleToCopy) {
