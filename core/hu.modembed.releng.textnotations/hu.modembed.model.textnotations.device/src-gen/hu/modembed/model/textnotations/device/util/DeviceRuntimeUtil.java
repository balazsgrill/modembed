 ...
 */
public class DeviceRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			hu.modembed.model.textnotations.device.mopp.DevicePlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			hu.modembed.model.textnotations.device.mopp.DevicePlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
