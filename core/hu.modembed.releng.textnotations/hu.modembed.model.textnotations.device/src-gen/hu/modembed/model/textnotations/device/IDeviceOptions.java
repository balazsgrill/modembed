...
public interface IDeviceOptions {
	 ...
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new hu.modembed.model.textnotations.device.mopp.DeviceMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new hu.modembed.model.textnotations.device.mopp.DeviceMetaInformation().getResourcePostProcessorProviderOptionKey();
