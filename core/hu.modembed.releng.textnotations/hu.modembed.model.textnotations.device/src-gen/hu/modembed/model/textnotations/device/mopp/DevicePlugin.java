 ...
 */
public class DevicePlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "hu.modembed.model.textnotations.device";
	/**
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, DevicePlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, DevicePlugin.PLUGIN_ID, message);
		}
		final DevicePlugin pluginInstance = DevicePlugin.getDefault();
