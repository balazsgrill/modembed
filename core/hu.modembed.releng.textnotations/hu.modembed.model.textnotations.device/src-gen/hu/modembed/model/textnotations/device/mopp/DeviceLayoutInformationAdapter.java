...
/**
 * A DeviceLayoutInformationAdapter is used to store layout information that is
 ...
 * DeviceLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class DeviceLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<hu.modembed.model.textnotations.device.mopp.DeviceLayoutInformation> layoutInformations = new java.util.ArrayList<hu.modembed.model.textnotations.device.mopp.DeviceLayoutInformation>();
	...
	public java.util.List<hu.modembed.model.textnotations.device.mopp.DeviceLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(hu.modembed.model.textnotations.device.mopp.DeviceLayoutInformation layoutInformation) {
