...
/**
 * DeviceLayoutInformation objects are used to store layout information that is
 ...
 * DeviceLayoutInformations are aggregated in LayoutInformationAdapters. One
 * DeviceLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class DeviceLayoutInformation {
	 ...
	 */
	private final hu.modembed.model.textnotations.device.grammar.DeviceSyntaxElement syntaxElement;
	...
	public DeviceLayoutInformation(hu.modembed.model.textnotations.device.grammar.DeviceSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public hu.modembed.model.textnotations.device.grammar.DeviceSyntaxElement getSyntaxElement() {
