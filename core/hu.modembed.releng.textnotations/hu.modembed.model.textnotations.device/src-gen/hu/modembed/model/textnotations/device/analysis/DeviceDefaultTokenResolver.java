 ...
 */
public class DeviceDefaultTokenResolver implements hu.modembed.model.textnotations.device.IDeviceTokenResolver {
	 ...
	 */
	public DeviceDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public DeviceDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, hu.modembed.model.textnotations.device.IDeviceTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.INSTANCE.getKeywords()) {
