 ...
 * to 4 bytes).
 */
public class DeviceUnicodeConverter extends hu.modembed.model.textnotations.device.mopp.DeviceInputStreamProcessor {
	 ...
	 */
	public DeviceUnicodeConverter(java.io.InputStream inputStream) {
