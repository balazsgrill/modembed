 ...
 */
public class DeviceExpectedTerminal {
	...
	private hu.modembed.model.textnotations.device.IDeviceExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private hu.modembed.model.textnotations.device.grammar.DeviceContainmentTrace containmentTrace;
	
	public DeviceExpectedTerminal(org.eclipse.emf.ecore.EObject container, hu.modembed.model.textnotations.device.IDeviceExpectedElement terminal, int followSetID, hu.modembed.model.textnotations.device.grammar.DeviceContainmentTrace containmentTrace) {
		super();
	...
	public hu.modembed.model.textnotations.device.IDeviceExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		DeviceExpectedTerminal otherExpectedTerminal = (DeviceExpectedTerminal) o;
	...
	public hu.modembed.model.textnotations.device.grammar.DeviceContainmentTrace getContainmentTrace() {
