...
public class DeviceBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "hu.modembed.model.textnotations.device.builder";
	
	private hu.modembed.model.textnotations.device.IDeviceBuilder defaultBuilder = new hu.modembed.model.textnotations.device.mopp.DeviceBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		hu.modembed.model.textnotations.device.IDeviceBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			hu.modembed.model.textnotations.device.mopp.DeviceResource customResource = (hu.modembed.model.textnotations.device.mopp.DeviceResource) resourceSet.getResource(uri, true);
			new hu.modembed.model.textnotations.device.mopp.DeviceMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public hu.modembed.model.textnotations.device.IDeviceBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new hu.modembed.model.textnotations.device.mopp.DeviceMarkerHelper().getMarkerID(hu.modembed.model.textnotations.device.DeviceEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		hu.modembed.model.textnotations.device.mopp.DeviceTaskItemBuilder taskItemBuilder = new hu.modembed.model.textnotations.device.mopp.DeviceTaskItemBuilder();
		new hu.modembed.model.textnotations.device.mopp.DeviceMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new hu.modembed.model.textnotations.device.mopp.DeviceMetaInformation().getSyntaxName())) {
