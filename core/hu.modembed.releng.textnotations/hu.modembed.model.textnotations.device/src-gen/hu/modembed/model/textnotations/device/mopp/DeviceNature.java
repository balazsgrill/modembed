...
public class DeviceNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "hu.modembed.model.textnotations.device.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {hu.modembed.model.textnotations.device.mopp.DeviceBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(hu.modembed.model.textnotations.device.mopp.DeviceBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
