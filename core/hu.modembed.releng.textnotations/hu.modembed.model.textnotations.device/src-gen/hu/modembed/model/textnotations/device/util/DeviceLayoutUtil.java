...
public class DeviceLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<hu.modembed.model.textnotations.device.mopp.DeviceLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			hu.modembed.model.textnotations.device.mopp.DeviceLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				hu.modembed.model.textnotations.device.mopp.DeviceLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(hu.modembed.model.textnotations.device.mopp.DeviceLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		hu.modembed.model.textnotations.device.grammar.DeviceSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public hu.modembed.model.textnotations.device.mopp.DeviceLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		hu.modembed.model.textnotations.device.grammar.DeviceSyntaxElement syntaxElement = hu.modembed.model.textnotations.device.grammar.DeviceGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof hu.modembed.model.textnotations.device.grammar.DevicePlaceholder) {
			hu.modembed.model.textnotations.device.grammar.DevicePlaceholder placeholder = (hu.modembed.model.textnotations.device.grammar.DevicePlaceholder) syntaxElement;
			hu.modembed.model.textnotations.device.IDeviceTokenResolver tokenResolver = new hu.modembed.model.textnotations.device.mopp.DeviceTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			hu.modembed.model.textnotations.device.IDeviceTokenResolveResult result = new hu.modembed.model.textnotations.device.mopp.DeviceTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new hu.modembed.model.textnotations.device.mopp.DeviceLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public hu.modembed.model.textnotations.device.mopp.DeviceLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
	...
	public void removeLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
		hu.modembed.model.textnotations.device.mopp.DeviceLayoutInformationAdapter existingAdapter = getLayoutInformationAdapter(element);
