 ...
 */
public class InstructionsetTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private hu.modembed.model.textnotations.instructionset.IInstructionsetHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final hu.modembed.model.textnotations.instructionset.ui.InstructionsetBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(hu.modembed.model.textnotations.instructionset.ui.InstructionsetBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			hu.modembed.model.textnotations.instructionset.ui.InstructionsetDocBrowserInformationControlInput infoInput = (hu.modembed.model.textnotations.instructionset.ui.InstructionsetDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					hu.modembed.model.textnotations.instructionset.ui.InstructionsetHyperlink hyperlink = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (hu.modembed.model.textnotations.instructionset.ui.InstructionsetBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				hu.modembed.model.textnotations.instructionset.ui.InstructionsetBrowserInformationControl iControl = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof hu.modembed.model.textnotations.instructionset.ui.InstructionsetDocBrowserInformationControlInput) {
							hu.modembed.model.textnotations.instructionset.ui.InstructionsetDocBrowserInformationControlInput input = (hu.modembed.model.textnotations.instructionset.ui.InstructionsetDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (hu.modembed.model.textnotations.instructionset.ui.InstructionsetBrowserInformationControl.isAvailable(parent)) {
				hu.modembed.model.textnotations.instructionset.ui.InstructionsetBrowserInformationControl iControl = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public InstructionsetTextHover(hu.modembed.model.textnotations.instructionset.IInstructionsetResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((hu.modembed.model.textnotations.instructionset.ui.InstructionsetDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private hu.modembed.model.textnotations.instructionset.ui.InstructionsetDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private hu.modembed.model.textnotations.instructionset.ui.InstructionsetDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, hu.modembed.model.textnotations.instructionset.ui.InstructionsetDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				hu.modembed.model.textnotations.instructionset.ui.InstructionsetHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			hu.modembed.model.textnotations.instructionset.ui.InstructionsetHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			hu.modembed.model.textnotations.instructionset.ui.InstructionsetHTMLPrinter.insertPageProlog(buffer, 0, hu.modembed.model.textnotations.instructionset.ui.InstructionsetTextHover.getStyleSheet());
			hu.modembed.model.textnotations.instructionset.ui.InstructionsetHTMLPrinter.addPageEpilog(buffer);
			return new hu.modembed.model.textnotations.instructionset.ui.InstructionsetDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = hu.modembed.model.textnotations.instructionset.ui.InstructionsetHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(hu.modembed.model.textnotations.instructionset.ui.InstructionsetUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return hu.modembed.model.textnotations.instructionset.util.InstructionsetStreamUtil.getContent(styleSheetURL.openStream());
