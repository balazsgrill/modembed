 ...
 */
public class InstructionsetCompletionProposal implements java.lang.Comparable<InstructionsetCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private hu.modembed.model.textnotations.instructionset.mopp.InstructionsetExpectedTerminal expectedTerminal;
	...
	public InstructionsetCompletionProposal(hu.modembed.model.textnotations.instructionset.mopp.InstructionsetExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public InstructionsetCompletionProposal(hu.modembed.model.textnotations.instructionset.mopp.InstructionsetExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
	...
	public hu.modembed.model.textnotations.instructionset.mopp.InstructionsetExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof InstructionsetCompletionProposal) {
			InstructionsetCompletionProposal other = (InstructionsetCompletionProposal) object;
	...
	public int compareTo(InstructionsetCompletionProposal object) {
		if (object instanceof InstructionsetCompletionProposal) {
			InstructionsetCompletionProposal other = (InstructionsetCompletionProposal) object;
