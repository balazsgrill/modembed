...
public class InstructionsetBracketSet {
	 ...
	 */
	public InstructionsetBracketSet() {
		super();
	...
	public boolean addBracketPair(String opening, String closing, boolean closingEnabledInside, boolean closeAfterEnter) {
		...
		bracketPairs.add(new hu.modembed.model.textnotations.instructionset.mopp.InstructionsetBracketPair(opening, closing, closingEnabledInside, closeAfterEnter));
		return true;
	}
