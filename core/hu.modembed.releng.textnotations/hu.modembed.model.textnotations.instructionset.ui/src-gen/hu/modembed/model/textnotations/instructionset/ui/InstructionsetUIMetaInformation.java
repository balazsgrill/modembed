...
public class InstructionsetUIMetaInformation extends hu.modembed.model.textnotations.instructionset.mopp.InstructionsetMetaInformation {
	...
	public hu.modembed.model.textnotations.instructionset.ui.InstructionsetTokenScanner createTokenScanner(hu.modembed.model.textnotations.instructionset.ui.InstructionsetColorManager colorManager) {
		return (hu.modembed.model.textnotations.instructionset.ui.InstructionsetTokenScanner) createTokenScanner(null, colorManager);
	}
	
	public hu.modembed.model.textnotations.instructionset.ui.IInstructionsetTokenScanner createTokenScanner(hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource resource, hu.modembed.model.textnotations.instructionset.ui.InstructionsetColorManager colorManager) {
