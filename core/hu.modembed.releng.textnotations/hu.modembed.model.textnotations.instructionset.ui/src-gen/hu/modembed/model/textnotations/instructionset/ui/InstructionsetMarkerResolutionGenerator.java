...
public class InstructionsetMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(hu.modembed.model.textnotations.instructionset.IInstructionsetOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof hu.modembed.model.textnotations.instructionset.mopp.InstructionsetResource) {
					hu.modembed.model.textnotations.instructionset.mopp.InstructionsetResource customResource = (hu.modembed.model.textnotations.instructionset.mopp.InstructionsetResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<hu.modembed.model.textnotations.instructionset.IInstructionsetQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final hu.modembed.model.textnotations.instructionset.IInstructionsetQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									hu.modembed.model.textnotations.instructionset.ui.InstructionsetUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			hu.modembed.model.textnotations.instructionset.ui.InstructionsetUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<hu.modembed.model.textnotations.instructionset.IInstructionsetQuickFix> getQuickFixes(hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					hu.modembed.model.textnotations.instructionset.IInstructionsetQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
