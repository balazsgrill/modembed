 ...
 */
public class InstructionsetBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource resource, final hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource resource, final hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource resource, final hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof hu.modembed.model.textnotations.instructionset.mopp.InstructionsetResource) {
							hu.modembed.model.textnotations.instructionset.mopp.InstructionsetResource concreteResource = (hu.modembed.model.textnotations.instructionset.mopp.InstructionsetResource) resource;
