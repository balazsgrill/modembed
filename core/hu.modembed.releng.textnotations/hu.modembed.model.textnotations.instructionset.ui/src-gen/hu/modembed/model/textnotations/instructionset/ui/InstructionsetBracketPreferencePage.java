...
public class InstructionsetBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		...
		bracketsTmp = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetBracketSet();
	...
	private void handleMatchingBracketsSelection() {
		...
		initializeLanguage();
		bracketsTmp.deserialize(getPreferenceStore().getString(language + hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
	...
	private void addListenersToStyleButtons() {
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair bracketPair = getSelectedBracketPair();
				if (bracketPair == null) {
					removeBracketButton.setEnabled(false);
					return;
				}
	...
	protected void performDefaults() {
		...
		enableCheckbox.setSelection(preferenceStore.getDefaultBoolean(hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		String defaultBrackets = preferenceStore.getDefaultString(language + hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	private void updateActiveEditor() {
		...
		preferenceStore.setValue(hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		preferenceStore.setValue(language + hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
	...
	protected hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair getSelectedBracketPair() {
