 ...
 */
public class InstructionsetHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static hu.modembed.model.textnotations.instructionset.ui.InstructionsetPositionHelper positionHelper = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetPositionHelper();
	...
	private hu.modembed.model.textnotations.instructionset.ui.IInstructionsetTokenScanner scanner;
	...
	private hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private hu.modembed.model.textnotations.instructionset.ui.InstructionsetOccurrence occurrence;
	private hu.modembed.model.textnotations.instructionset.ui.InstructionsetBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, hu.modembed.model.textnotations.instructionset.IInstructionsetBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public InstructionsetHighlighting(hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, hu.modembed.model.textnotations.instructionset.ui.InstructionsetColorManager colorManager, hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = hu.modembed.model.textnotations.instructionset.ui.InstructionsetUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetUIMetaInformation().createTokenScanner(textResource, colorManager);
		occurrence = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetBracketSet();
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, hu.modembed.model.textnotations.instructionset.ui.InstructionsetPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, hu.modembed.model.textnotations.instructionset.ui.InstructionsetPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(hu.modembed.model.textnotations.instructionset.ui.InstructionsetPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new hu.modembed.model.textnotations.instructionset.ui.InstructionsetEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
