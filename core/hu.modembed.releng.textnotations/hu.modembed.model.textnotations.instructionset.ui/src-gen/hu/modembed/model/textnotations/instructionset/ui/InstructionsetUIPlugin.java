 ...
 */
public class InstructionsetUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "hu.modembed.model.textnotations.instructionset.ui";
	public static final String EDITOR_ID = "hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor";
	...
	private static InstructionsetUIPlugin plugin;
	
	public InstructionsetUIPlugin() {
		super();
	}
	...
	public static InstructionsetUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, InstructionsetUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, InstructionsetUIPlugin.PLUGIN_ID, message);
		}
		final InstructionsetUIPlugin pluginInstance = InstructionsetUIPlugin.getDefault();
