 ...
 */
public class InstructionsetCodeFoldingManager {
	
	private class FoldingUpdateListener implements hu.modembed.model.textnotations.instructionset.IInstructionsetBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor) {
				hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor editor = (hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor) workbenchPart;
	...
	protected hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor editor;
	 ...
	 */
	public InstructionsetCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor textEditor) {
	...
	private void addCloseListener(final hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			hu.modembed.model.textnotations.instructionset.ui.InstructionsetUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource textResource = (hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
