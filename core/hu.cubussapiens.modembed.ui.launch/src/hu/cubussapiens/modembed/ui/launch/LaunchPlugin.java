...
public class LaunchPlugin extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "hu.cubussapiens.modembed.ui.launch"; //$NON-NLS-1$

	public static final String LaunchConfigTypeID = "hu.cubussapiens.modembed.ui.launch";
