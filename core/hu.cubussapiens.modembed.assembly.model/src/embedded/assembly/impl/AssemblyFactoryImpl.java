...
public class AssemblyFactoryImpl extends EFactoryImpl implements AssemblyFactory {
	...
	public static AssemblyFactory init() {
		try {
			AssemblyFactory theAssemblyFactory = (AssemblyFactory)EPackage.Registry.INSTANCE.getEFactory("http://hu.gb/embedded/assembly"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case AssemblyPackage.INSTRUCTION_SET: return createInstructionSet();
			case AssemblyPackage.INSTRUCTION: return createInstruction();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case AssemblyPackage.FIELD_TYPE:
