 ...
 * @generated
 */
public class InstructionSetImpl extends EObjectImpl implements InstructionSet {
	/**
	...
	protected EClass eStaticClass() {
		return AssemblyPackage.Literals.INSTRUCTION_SET;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssemblyPackage.INSTRUCTION_SET__NAME, oldName, name));
	}
	...
	public EList<Instruction> getInstructions() {
		if (instructions == null) {
			instructions = new EObjectContainmentEList<Instruction>(Instruction.class, this, AssemblyPackage.INSTRUCTION_SET__INSTRUCTIONS);
		}
		return instructions;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssemblyPackage.INSTRUCTION_SET__NAME:
				return getName();
			case AssemblyPackage.INSTRUCTION_SET__INSTRUCTIONS:
