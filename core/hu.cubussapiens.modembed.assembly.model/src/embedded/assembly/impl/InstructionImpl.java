...
public class InstructionImpl extends EObjectImpl implements Instruction {
	...
	protected EClass eStaticClass() {
		return AssemblyPackage.Literals.INSTRUCTION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssemblyPackage.INSTRUCTION__NAME, oldName, name));
	}
	...
	public EList<Section> getSections() {
		if (sections == null) {
			sections = new EObjectContainmentEList<Section>(Section.class, this, AssemblyPackage.INSTRUCTION__SECTIONS);
		}
		return sections;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssemblyPackage.INSTRUCTION__NAME:
				return getName();
			case AssemblyPackage.INSTRUCTION__SECTIONS:
				return getSections();
			case AssemblyPackage.INSTRUCTION__PARAMETERS:
