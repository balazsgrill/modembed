...
public class InstructionsetStackFrame extends hu.modembed.model.textnotations.instructionset.debug.InstructionsetDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private hu.modembed.model.textnotations.instructionset.debug.InstructionsetDebugTarget target;
	private String name;
	private int id;
	...
	public InstructionsetStackFrame(hu.modembed.model.textnotations.instructionset.debug.InstructionsetDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = hu.modembed.model.textnotations.instructionset.util.InstructionsetStringUtil.decode(data, ',');
	...
	private hu.modembed.model.textnotations.instructionset.debug.InstructionsetDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		hu.modembed.model.textnotations.instructionset.debug.InstructionsetStackFrame other = (hu.modembed.model.textnotations.instructionset.debug.InstructionsetStackFrame) obj;
		if (name == null) {
