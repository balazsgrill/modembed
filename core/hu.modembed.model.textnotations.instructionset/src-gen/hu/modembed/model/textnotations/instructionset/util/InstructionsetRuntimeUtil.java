 ...
 */
public class InstructionsetRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			hu.modembed.model.textnotations.instructionset.mopp.InstructionsetPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			hu.modembed.model.textnotations.instructionset.mopp.InstructionsetPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
