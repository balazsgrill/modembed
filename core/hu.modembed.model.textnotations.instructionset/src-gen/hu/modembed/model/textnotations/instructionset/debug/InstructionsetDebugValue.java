...
public class InstructionsetDebugValue extends hu.modembed.model.textnotations.instructionset.debug.InstructionsetDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public InstructionsetDebugValue(hu.modembed.model.textnotations.instructionset.debug.InstructionsetDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
