 ...
 */
public class InstructionsetEObjectUtil {
	...
	public static Object invokeOperation(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EOperation o) {
		...
		try {
			...
			new hu.modembed.model.textnotations.instructionset.util.InstructionsetRuntimeUtil().logError("Exception while matching proxy URI.", e);
