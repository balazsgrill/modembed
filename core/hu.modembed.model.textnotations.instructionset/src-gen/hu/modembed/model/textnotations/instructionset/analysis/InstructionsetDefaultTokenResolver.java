 ...
 */
public class InstructionsetDefaultTokenResolver implements hu.modembed.model.textnotations.instructionset.IInstructionsetTokenResolver {
	 ...
	 */
	public InstructionsetDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public InstructionsetDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, hu.modembed.model.textnotations.instructionset.IInstructionsetTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : hu.modembed.model.textnotations.instructionset.grammar.InstructionsetGrammarInformationProvider.INSTANCE.getKeywords()) {
