...
public class InstructionsetEclipseProxy {
	...
	public void checkEMFValidationConstraints(hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource resource, org.eclipse.emf.ecore.EObject root) {
	...
	public void addStatus(org.eclipse.core.runtime.IStatus status, hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource resource, org.eclipse.emf.ecore.EObject root) {
		...
		if (!status.isMultiStatus() || !hasChildren) {
			if (status.getSeverity() == org.eclipse.core.runtime.IStatus.ERROR) {
				for (org.eclipse.emf.ecore.EObject cause : causes) {
					resource.addError(status.getMessage(), hu.modembed.model.textnotations.instructionset.InstructionsetEProblemType.ANALYSIS_PROBLEM, cause);
				}
			}
			if (status.getSeverity() == org.eclipse.core.runtime.IStatus.WARNING) {
				for (org.eclipse.emf.ecore.EObject cause : causes) {
					resource.addWarning(status.getMessage(), hu.modembed.model.textnotations.instructionset.InstructionsetEProblemType.ANALYSIS_PROBLEM, cause);
				}
			}
		}
