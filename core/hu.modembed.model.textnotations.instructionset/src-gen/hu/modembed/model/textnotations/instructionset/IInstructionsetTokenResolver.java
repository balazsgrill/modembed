 ...
 * instance of InstructionsetDefaultTokenResolver which performs a standard
 * conversion based on the EMF type conversion. This includes conversion of
 * registered EDataTypes.
 * 
 * @see
 * hu.modembed.model.textnotations.instructionset.analysis.InstructionsetDefaultTok
 * enResolver
 */
public interface IInstructionsetTokenResolver extends hu.modembed.model.textnotations.instructionset.IInstructionsetConfigurable {
