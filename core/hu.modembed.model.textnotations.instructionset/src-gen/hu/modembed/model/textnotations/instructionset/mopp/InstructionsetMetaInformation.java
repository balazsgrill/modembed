...
public class InstructionsetMetaInformation implements hu.modembed.model.textnotations.instructionset.IInstructionsetMetaInformation {
	...
	public String getPathToCSDefinition() {
		return "hu.modembed.model/textnotations/instructionset.cs";
	}
	...
	public void registerResourceFactory() {
		org.eclipse.emf.ecore.resource.Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put(getSyntaxName(), new hu.modembed.model.textnotations.instructionset.mopp.InstructionsetResourceFactory());
	}
