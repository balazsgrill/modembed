...
public class InstructionsetResource extends org.eclipse.emf.ecore.resource.impl.ResourceImpl implements hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource {
	...
	public boolean isMarkerCreationEnabled() {
		...
		return !loadOptions.containsKey(hu.modembed.model.textnotations.instructionset.IInstructionsetOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS);
	}
	...
	protected boolean isLocationMapEnabled() {
		...
		return !loadOptions.containsKey(hu.modembed.model.textnotations.instructionset.IInstructionsetOptions.DISABLE_LOCATION_MAP);
	}
	...
	protected boolean isLayoutInformationRecordingEnabled() {
		...
		return !loadOptions.containsKey(hu.modembed.model.textnotations.instructionset.IInstructionsetOptions.DISABLE_LAYOUT_INFORMATION_RECORDING);
	}
