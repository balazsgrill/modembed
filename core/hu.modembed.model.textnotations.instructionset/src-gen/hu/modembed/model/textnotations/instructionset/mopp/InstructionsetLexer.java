...
public class InstructionsetLexer extends Lexer {
    ...
    public final void mSL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Instructionset.g:1400:11: ( ( '//' (~ ( '\\n' | '\\r' | '\\uffff' ) )* ) )
            // Instructionset.g:1401:2: ( '//' (~ ( '\\n' | '\\r' | '\\uffff' ) )* )
            {
            // Instructionset.g:1401:2: ( '//' (~ ( '\\n' | '\\r' | '\\uffff' ) )* )
            // Instructionset.g:1401:3: '//' (~ ( '\\n' | '\\r' | '\\uffff' ) )*
            {
            match("//"); 



            // Instructionset.g:1401:7: (~ ( '\\n' | '\\r' | '\\uffff' ) )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Instructionset.g:1404:11: ( ( '/*' ( . )* '*/' ) )
            // Instructionset.g:1405:2: ( '/*' ( . )* '*/' )
            {
            // Instructionset.g:1405:2: ( '/*' ( . )* '*/' )
            // Instructionset.g:1405:3: '/*' ( . )* '*/'
            {
            match("/*"); 



            // Instructionset.g:1405:7: ( . )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mIDENTIFIER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Instructionset.g:1408:11: ( ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )* ) )
            // Instructionset.g:1409:2: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )* )
            {
            // Instructionset.g:1409:2: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )* )
            // Instructionset.g:1409:3: ( 'a' .. 'z' | 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )*
            {
            ...
            // Instructionset.g:1409:22: ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mQUALIFIEDID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Instructionset.g:1411:12: ( ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )* ( '\\.' ( 'a' .. 'z' | 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )* )* ) )
            // Instructionset.g:1412:2: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )* ( '\\.' ( 'a' .. 'z' | 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )* )* )
            {
            // Instructionset.g:1412:2: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )* ( '\\.' ( 'a' .. 'z' | 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )* )* )
            // Instructionset.g:1412:3: ( 'a' .. 'z' | 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )* ( '\\.' ( 'a' .. 'z' | 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )* )*
            {
            if ( (input.LA(1) >= 'A' && input.LA(1) <= 'Z')||(input.LA(1) >= 'a' && input.LA(1) <= 'z') ) {
                input.consume();
            }
            ...
            // Instructionset.g:1412:22: ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )*
            loop4:
            do {
                int alt4=2;
            ...
            // Instructionset.g:1412:55: ( '\\.' ( 'a' .. 'z' | 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )* )*
            loop6:
            do {
                int alt6=2;
                ...
                switch (alt6) {
            	case 1 :
            	    // Instructionset.g:1412:56: '\\.' ( 'a' .. 'z' | 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )*
            	    {
            	    match('.'); 
            	    ...
            	    // Instructionset.g:1412:79: ( ( 'a' .. 'z' | 'A' .. 'Z' ) | ( '0' .. '9' ) )*
            	    loop5:
            	    do {
            	        int alt5=2;
    ...
    public final void mINT() throws RecognitionException {
        try {
            int _type = INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Instructionset.g:1414:4: ( ( ( ( '0' .. '9' ) )+ ) )
            // Instructionset.g:1415:2: ( ( ( '0' .. '9' ) )+ )
            {
            // Instructionset.g:1415:2: ( ( ( '0' .. '9' ) )+ )
            // Instructionset.g:1415:3: ( ( '0' .. '9' ) )+
            {
            // Instructionset.g:1415:3: ( ( '0' .. '9' ) )+
            int cnt7=0;
            loop7:
    ...
    public final void mBINARY() throws RecognitionException {
        try {
            int _type = BINARY;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Instructionset.g:1417:7: ( ( '0b' ( '0' | '1' )* ) )
            // Instructionset.g:1418:2: ( '0b' ( '0' | '1' )* )
            {
            // Instructionset.g:1418:2: ( '0b' ( '0' | '1' )* )
            // Instructionset.g:1418:3: '0b' ( '0' | '1' )*
            {
            match("0b"); 



            // Instructionset.g:1418:7: ( '0' | '1' )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mWHITESPACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Instructionset.g:1420:11: ( ( ( ' ' | '\\t' | '\\f' | '\\r' | '\\n' )+ ) )
            // Instructionset.g:1421:2: ( ( ' ' | '\\t' | '\\f' | '\\r' | '\\n' )+ )
            {
            // Instructionset.g:1421:2: ( ( ' ' | '\\t' | '\\f' | '\\r' | '\\n' )+ )
            // Instructionset.g:1421:3: ( ' ' | '\\t' | '\\f' | '\\r' | '\\n' )+
            {
            // Instructionset.g:1421:3: ( ' ' | '\\t' | '\\f' | '\\r' | '\\n' )+
            int cnt9=0;
            loop9:
