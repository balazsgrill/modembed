...
/**
 * A InstructionsetLayoutInformationAdapter is used to store layout information
 ...
 * other tokens. InstructionsetLayoutInformationAdapters are attached to EObjects
 ...
 */
public class InstructionsetLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<hu.modembed.model.textnotations.instructionset.mopp.InstructionsetLayoutInformation> layoutInformations = new java.util.ArrayList<hu.modembed.model.textnotations.instructionset.mopp.InstructionsetLayoutInformation>();
	...
	public java.util.List<hu.modembed.model.textnotations.instructionset.mopp.InstructionsetLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(hu.modembed.model.textnotations.instructionset.mopp.InstructionsetLayoutInformation layoutInformation) {
