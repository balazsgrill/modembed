...
public abstract class InstructionsetANTLRParserBase extends org.antlr.runtime3_4_0.Parser implements hu.modembed.model.textnotations.instructionset.IInstructionsetTextParser {
	...
	public void setOptions(java.util.Map<?,?> options) {
		...
		if (this.options.containsKey(hu.modembed.model.textnotations.instructionset.IInstructionsetOptions.DISABLE_LOCATION_MAP)) {
			this.disableLocationMap = true;
		}
		if (this.options.containsKey(hu.modembed.model.textnotations.instructionset.IInstructionsetOptions.DISABLE_LAYOUT_INFORMATION_RECORDING)) {
