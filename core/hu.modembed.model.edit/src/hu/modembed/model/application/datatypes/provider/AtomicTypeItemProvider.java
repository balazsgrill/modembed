...
/**
 * This is the item provider adapter for a {@link hu.modembed.model.application.datatypes.AtomicType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AtomicTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AtomicType_qualifiedName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AtomicType_qualifiedName_feature", "_UI_AtomicType_type"),
				 DatatypesPackage.Literals.ATOMIC_TYPE__QUALIFIED_NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AtomicType.class)) {
			case DatatypesPackage.ATOMIC_TYPE__QUALIFIED_NAME:
