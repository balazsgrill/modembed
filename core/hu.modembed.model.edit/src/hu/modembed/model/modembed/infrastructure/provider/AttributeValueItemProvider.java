...
/**
 * This is the item provider adapter for a {@link hu.modembed.model.modembed.infrastructure.AttributeValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeValueItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_AttributeValue_definition_feature", "_UI_AttributeValue_type"),
				 InfrastructurePackage.Literals.ATTRIBUTE_VALUE__DEFINITION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InfrastructurePackage.Literals.ATTRIBUTE_VALUE__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((AttributeValue)object).getDescription();
