...
/**
 * This is the item provider adapter for a {@link hu.modembed.model.modembed.structured.ExpressionOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExpressionOperationItemProvider
	 ...
	 * @generated
	 */
	public ExpressionOperationItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructuredPackage.Literals.EXPRESSION_OPERATION__EXPRESSION);
		}
	...
	/**
	 * This returns ExpressionOperation.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExpressionOperation"));
	}
	...
	public String getText(Object object) {
		String label = ((ExpressionOperation)object).getDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_ExpressionOperation_type") :
			getString("_UI_ExpressionOperation_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ExpressionOperation.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StructuredPackage.Literals.EXPRESSION_OPERATION__EXPRESSION,
