...
/**
 * This is the item provider adapter for a {@link hu.modembed.model.modembed.structured.StructuredFunction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StructuredFunctionItemProvider
	 ...
	 * @generated
	 */
	public StructuredFunctionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StructuredFunction_global_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StructuredFunction_global_feature", "_UI_StructuredFunction_type"),
				 StructuredPackage.Literals.STRUCTURED_FUNCTION__GLOBAL,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructuredPackage.Literals.STRUCTURED_FUNCTION__RESULT_TYPE);
			childrenFeatures.add(StructuredPackage.Literals.STRUCTURED_FUNCTION__PARAMETERS);
			childrenFeatures.add(StructuredPackage.Literals.STRUCTURED_FUNCTION__IMPLEMENTATION);
		}
	...
	/**
	 * This returns StructuredFunction.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StructuredFunction"));
	}
	...
	public String getText(Object object) {
		String label = ((StructuredFunction)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_StructuredFunction_type") :
			getString("_UI_StructuredFunction_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StructuredFunction.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StructuredPackage.Literals.STRUCTURED_FUNCTION__RESULT_TYPE,
		...
		newChildDescriptors.add
			(createChildParameter
				(StructuredPackage.Literals.STRUCTURED_FUNCTION__PARAMETERS,
				 StructuredFactory.eINSTANCE.createVariableDeclaration()));

		newChildDescriptors.add
			(createChildParameter
				(StructuredPackage.Literals.STRUCTURED_FUNCTION__IMPLEMENTATION,
