...
/**
 * This is the item provider adapter for a {@link hu.modembed.model.modembed.abstraction.behavior.SequentialAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequentialActionItemProvider
	 ...
	 * @generated
	 */
	public SequentialActionItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SequentialAction)object).getDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_SequentialAction_type") :
			getString("_UI_SequentialAction_type") + " " + label;
	}
