...
/**
 * This is the item provider adapter for a {@link hu.modembed.model.modembed.abstraction.types.ArrayDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayDefinitionItemProvider
	extends ArrayTypeDefinitionItemProvider
	implements
	 ...
	 * @generated
	 */
	public ArrayDefinitionItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TypesPackage.Literals.ARRAY_DEFINITION__SIZE);
		}
	...
	/**
	 * This returns ArrayDefinition.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ArrayDefinition"));
	}
	...
	public String getText(Object object) {
		String label = ((ArrayDefinition)object).getDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_ArrayDefinition_type") :
			getString("_UI_ArrayDefinition_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ArrayDefinition.class)) {
			case TypesPackage.ARRAY_DEFINITION__SIZE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TypesPackage.Literals.ARRAY_DEFINITION__SIZE,
