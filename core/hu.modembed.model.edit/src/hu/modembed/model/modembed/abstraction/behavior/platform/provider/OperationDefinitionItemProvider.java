...
/**
 * This is the item provider adapter for a {@link hu.modembed.model.modembed.abstraction.behavior.platform.OperationDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationDefinitionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperationDefinition_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperationDefinition_operation_feature", "_UI_OperationDefinition_type"),
				 PlatformPackage.Literals.OPERATION_DEFINITION__OPERATION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlatformPackage.Literals.OPERATION_DEFINITION__ARGUMENTS);
			childrenFeatures.add(PlatformPackage.Literals.OPERATION_DEFINITION__STEPS);
		}
	...
	public String getText(Object object) {
		String label = ((OperationDefinition)object).getDescription();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PlatformPackage.Literals.OPERATION_DEFINITION__ARGUMENTS,
				 PlatformFactory.eINSTANCE.createOperationArgument()));

		newChildDescriptors.add
			(createChildParameter
				(PlatformPackage.Literals.OPERATION_DEFINITION__STEPS,
				 PlatformFactory.eINSTANCE.createInstructionCallOperationStep()));

		newChildDescriptors.add
			(createChildParameter
				(PlatformPackage.Literals.OPERATION_DEFINITION__STEPS,
				 PlatformFactory.eINSTANCE.createOperationLocalLabel()));

		newChildDescriptors.add
			(createChildParameter
				(PlatformPackage.Literals.OPERATION_DEFINITION__STEPS,
				 PlatformFactory.eINSTANCE.createConditionalOperation()));
	}
