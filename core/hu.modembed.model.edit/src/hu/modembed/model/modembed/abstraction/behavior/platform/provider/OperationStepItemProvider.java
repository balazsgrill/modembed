...
/**
 * This is the item provider adapter for a {@link hu.modembed.model.modembed.abstraction.behavior.platform.OperationStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationStepItemProvider
	 ...
	 * @generated
	 */
	public OperationStepItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((OperationStep)object).getDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_OperationStep_type") :
			getString("_UI_OperationStep_type") + " " + label;
	}
