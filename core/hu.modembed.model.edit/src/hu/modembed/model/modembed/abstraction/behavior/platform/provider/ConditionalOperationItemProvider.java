...
/**
 * This is the item provider adapter for a {@link hu.modembed.model.modembed.abstraction.behavior.platform.ConditionalOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionalOperationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlatformPackage.Literals.CONDITIONAL_OPERATION__CONDITION);
			childrenFeatures.add(PlatformPackage.Literals.CONDITIONAL_OPERATION__STEPS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConditionalOperation.class)) {
			case PlatformPackage.CONDITIONAL_OPERATION__CONDITION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PlatformPackage.Literals.CONDITIONAL_OPERATION__CONDITION,
		...
		newChildDescriptors.add
			(createChildParameter
				(PlatformPackage.Literals.CONDITIONAL_OPERATION__STEPS,
