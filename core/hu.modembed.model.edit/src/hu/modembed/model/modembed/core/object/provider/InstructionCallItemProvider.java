...
/**
 * This is the item provider adapter for a {@link hu.modembed.model.modembed.core.object.InstructionCall} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstructionCallItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ObjectPackage.Literals.INSTRUCTION_CALL__INSTRUCTION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ObjectPackage.Literals.INSTRUCTION_CALL__PARAMETERS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InstructionCall.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ObjectPackage.Literals.INSTRUCTION_CALL__PARAMETERS,
				 ObjectFactory.eINSTANCE.createInstructionCallParameter()));
	}
