 ...
 * $Id$
 */
package hu.modembed.model.network.provider;
...
/**
 * This is the item provider adapter for a {@link hu.modembed.model.network.NetworkNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworkNodeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NetworkPackage.Literals.NETWORK_NODE__INTERFACES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NetworkNode"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NetworkNode.class)) {
			case NetworkPackage.NETWORK_NODE__INTERFACES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NetworkPackage.Literals.NETWORK_NODE__INTERFACES,
				 Rs232Factory.eINSTANCE.createRS232Interface()));
	}
