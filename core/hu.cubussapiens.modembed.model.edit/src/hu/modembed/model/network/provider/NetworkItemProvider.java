...
/**
 * This is the item provider adapter for a {@link hu.modembed.model.network.Network} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworkItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NetworkPackage.Literals.NETWORK__NODES);
			childrenFeatures.add(NetworkPackage.Literals.NETWORK__CONNECTIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Network.class)) {
			...
			case NetworkPackage.NETWORK__CONNECTIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NetworkPackage.Literals.NETWORK__NODES,
				 NetworkFactory.eINSTANCE.createNetworkNode()));

		newChildDescriptors.add
			(createChildParameter
				(NetworkPackage.Literals.NETWORK__CONNECTIONS,
				 Rs232Factory.eINSTANCE.createRS232Connection()));
	}
