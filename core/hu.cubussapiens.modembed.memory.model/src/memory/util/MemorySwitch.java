...
public class MemorySwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MemoryPackage.RAM_MODEL: {
				RAMModel ramModel = (RAMModel)theEObject;
				T result = caseRAMModel(ramModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MemoryPackage.MEMORY_MODEL: {
				MemoryModel memoryModel = (MemoryModel)theEObject;
				T result = caseMemoryModel(memoryModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseMemoryModel(MemoryModel object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Prog Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Prog Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProgModel(ProgModel object) {
		return null;
	}
