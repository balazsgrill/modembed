 ...
 * </ul>
 */
public class InstructionsetBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new hu.modembed.model.textnotations.instructionset.mopp.InstructionsetMetaInformation().getSyntaxName();
	
	private hu.modembed.model.textnotations.instructionset.ui.InstructionsetBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public InstructionsetBracketPreferencePage() {
		super();
		
		hu.modembed.model.textnotations.instructionset.IInstructionsetMetaInformation metaInformation = new hu.modembed.model.textnotations.instructionset.mopp.InstructionsetMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(hu.modembed.model.textnotations.instructionset.ui.InstructionsetUIPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(language + hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor) {
			((hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor) editor).invalidateTextRepresentation();
		}
	}
