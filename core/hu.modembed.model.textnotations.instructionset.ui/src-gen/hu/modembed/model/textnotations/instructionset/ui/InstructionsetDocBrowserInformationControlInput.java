 ...
 * olInput</code>.
 */
public class InstructionsetDocBrowserInformationControlInput {
	
	private final InstructionsetDocBrowserInformationControlInput fPrevious;
	private InstructionsetDocBrowserInformationControlInput fNext;
	 ...
	 */
	public InstructionsetDocBrowserInformationControlInput(InstructionsetDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public InstructionsetDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public InstructionsetDocBrowserInformationControlInput getNext() {
		return fNext;
	}
