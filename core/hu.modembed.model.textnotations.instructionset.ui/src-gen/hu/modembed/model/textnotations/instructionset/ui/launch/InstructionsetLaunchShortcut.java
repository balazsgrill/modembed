 ...
 */
public class InstructionsetLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new hu.modembed.model.textnotations.instructionset.mopp.InstructionsetMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(hu.modembed.model.textnotations.instructionset.launch.InstructionsetLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			hu.modembed.model.textnotations.instructionset.mopp.InstructionsetPlugin.logError("Exception while launching selection", e);
		}
	}
