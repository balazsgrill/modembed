...
public class InstructionsetAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new hu.modembed.model.textnotations.instructionset.mopp.InstructionsetMetaInformation().getSyntaxName())) {
					return new hu.modembed.model.textnotations.instructionset.ui.debug.InstructionsetLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof hu.modembed.model.textnotations.instructionset.debug.InstructionsetDebugVariable) {
			final hu.modembed.model.textnotations.instructionset.debug.InstructionsetDebugVariable variable = (hu.modembed.model.textnotations.instructionset.debug.InstructionsetDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof hu.modembed.model.textnotations.instructionset.debug.InstructionsetDebugVariable) {
			final hu.modembed.model.textnotations.instructionset.debug.InstructionsetDebugVariable variable = (hu.modembed.model.textnotations.instructionset.debug.InstructionsetDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							hu.modembed.model.textnotations.instructionset.debug.InstructionsetDebugValue castedValue = (hu.modembed.model.textnotations.instructionset.debug.InstructionsetDebugValue) value;
