 ...
 * a specified depth.
 */
public class InstructionsetOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public InstructionsetOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = hu.modembed.model.textnotations.instructionset.util.InstructionsetStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof hu.modembed.model.textnotations.instructionset.ui.InstructionsetEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			hu.modembed.model.textnotations.instructionset.mopp.InstructionsetPlugin.logError("Exception while refreshing outline view", e);
		}
	}
