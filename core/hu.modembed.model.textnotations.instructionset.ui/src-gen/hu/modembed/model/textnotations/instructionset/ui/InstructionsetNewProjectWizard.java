 ...
 */
public class InstructionsetNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new hu.modembed.model.textnotations.instructionset.mopp.InstructionsetMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public InstructionsetNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("hu.modembed.model.textnotations.instructionset.ui");
							...
							String natureID = hu.modembed.model.textnotations.instructionset.mopp.InstructionsetNature.NATURE_ID;
							...
							for (String builderID : hu.modembed.model.textnotations.instructionset.mopp.InstructionsetNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								hu.modembed.model.textnotations.instructionset.mopp.InstructionsetMetaInformation info = new hu.modembed.model.textnotations.instructionset.mopp.InstructionsetMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = hu.modembed.model.textnotations.instructionset.ui.InstructionsetUIPlugin.getDefault().getBundle();
