...
public class InstructionsetPreferenceInitializer extends org.eclipse.core.runtime.preferences.AbstractPreferenceInitializer {
	...
	private void initializeDefaultBrackets(org.eclipse.jface.preference.IPreferenceStore store, hu.modembed.model.textnotations.instructionset.IInstructionsetMetaInformation metaInformation) {
		String languageId = metaInformation.getSyntaxName();
		// set default brackets for ITextResource bracket set
		hu.modembed.model.textnotations.instructionset.ui.InstructionsetBracketSet bracketSet = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetBracketSet(null, null);
		...
		store.setDefault(languageId + hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSet.getBracketString());
	}
	
	private void initializeDefaultSyntaxHighlighting(org.eclipse.jface.preference.IPreferenceStore store, hu.modembed.model.textnotations.instructionset.mopp.InstructionsetMetaInformation metaInformation) {
		String languageId = metaInformation.getSyntaxName();
