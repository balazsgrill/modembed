 ...
 */
public class InstructionsetNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public InstructionsetNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new instructionset file");
