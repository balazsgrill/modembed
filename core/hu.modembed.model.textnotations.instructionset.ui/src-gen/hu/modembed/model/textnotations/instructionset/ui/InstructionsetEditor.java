...
/**
 * A text editor for 'instructionset' models.
 * <p>
 * This editor has id
 * <code>hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor</co
 * de>
 * The editor's context menu has id
 * <code>hu.modembed.model.textnotations.instructionset.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>hu.modembed.model.textnotations.instructionset.EditorRuler</code>.
 * </p>
 */
public class InstructionsetEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, hu.modembed.model.textnotations.instructionset.IInstructionsetResourceProvider, hu.modembed.model.textnotations.instructionset.ui.IInstructionsetBracketHandlerProvider, hu.modembed.model.textnotations.instructionset.ui.IInstructionsetAnnotationModelProvider {
	
	private hu.modembed.model.textnotations.instructionset.ui.InstructionsetHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private hu.modembed.model.textnotations.instructionset.ui.InstructionsetCodeFoldingManager codeFoldingManager;
	private hu.modembed.model.textnotations.instructionset.ui.InstructionsetBackgroundParsingStrategy bgParsingStrategy = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetBackgroundParsingStrategy();
	private java.util.Collection<hu.modembed.model.textnotations.instructionset.IInstructionsetBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<hu.modembed.model.textnotations.instructionset.IInstructionsetBackgroundParsingListener>();
	private hu.modembed.model.textnotations.instructionset.ui.InstructionsetColorManager colorManager = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetColorManager();
	private hu.modembed.model.textnotations.instructionset.ui.InstructionsetOutlinePage outlinePage;
	...
	private hu.modembed.model.textnotations.instructionset.ui.InstructionsetPropertySheetPage propertySheetPage;
	...
	private hu.modembed.model.textnotations.instructionset.ui.IInstructionsetBracketHandler bracketHandler;
	...
	public InstructionsetEditor() {
		super();
		setSourceViewerConfiguration(new hu.modembed.model.textnotations.instructionset.ui.InstructionsetSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), InstructionsetEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource currentResource = getResource();
				...
				hu.modembed.model.textnotations.instructionset.ui.InstructionsetUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("hu.modembed.model.textnotations.instructionset.EditorContext");
		setRulerContextMenuId("hu.modembed.model.textnotations.instructionset.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource loadedResource = (hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource) {
					setResource((hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					hu.modembed.model.textnotations.instructionset.ui.InstructionsetUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the InstructionsetEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				hu.modembed.model.textnotations.instructionset.ui.InstructionsetUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource textResource = (hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource) element.eResource();
			...
			hu.modembed.model.textnotations.instructionset.IInstructionsetTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				hu.modembed.model.textnotations.instructionset.IInstructionsetTextToken token = lexer.getNextToken();
			...
			hu.modembed.model.textnotations.instructionset.ui.InstructionsetUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!InstructionsetEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(hu.modembed.model.textnotations.instructionset.IInstructionsetBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (hu.modembed.model.textnotations.instructionset.IInstructionsetBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public hu.modembed.model.textnotations.instructionset.ui.IInstructionsetBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(hu.modembed.model.textnotations.instructionset.ui.IInstructionsetBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource)) {
					return false;
				}
				hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource textResource = (hu.modembed.model.textnotations.instructionset.IInstructionsetTextResource) resource;
				hu.modembed.model.textnotations.instructionset.IInstructionsetLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
