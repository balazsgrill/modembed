...
public class InstructionsetCodeCompletionHelper {
		...
		if (mappings != null) {
			...
			for (hu.modembed.model.textnotations.instructionset.IInstructionsetReferenceMapping<org.eclipse.emf.ecore.EObject> mapping : mappings) {
				...
				if (mapping instanceof hu.modembed.model.textnotations.instructionset.mopp.InstructionsetElementMapping<?>) {
					...
					resultSet.add(new hu.modembed.model.textnotations.instructionset.ui.InstructionsetCompletionProposal(expectedTerminal, identifier, prefix, matchesPrefix, reference, container, image));
				}
			}
			return resultSet;
		}
	 ...
	 */
	protected java.util.Collection<hu.modembed.model.textnotations.instructionset.ui.InstructionsetCompletionProposal> handleKeyword(hu.modembed.model.textnotations.instructionset.mopp.InstructionsetExpectedTerminal expectedTerminal, hu.modembed.model.textnotations.instructionset.mopp.InstructionsetExpectedCsString csString, String prefix) {
		String proposal = csString.getValue();
		boolean matchesPrefix = matches(proposal, prefix);
		return java.util.Collections.singleton(new hu.modembed.model.textnotations.instructionset.ui.InstructionsetCompletionProposal(expectedTerminal, proposal, prefix, matchesPrefix, null, null));
	}
