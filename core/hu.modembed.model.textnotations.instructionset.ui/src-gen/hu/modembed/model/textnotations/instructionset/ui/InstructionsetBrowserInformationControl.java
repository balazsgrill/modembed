 ...
 * @since 3.2
 */
public class InstructionsetBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private hu.modembed.model.textnotations.instructionset.ui.InstructionsetDocBrowserInformationControlInput fInput;
	 ...
	 */
	public InstructionsetBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public InstructionsetBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public InstructionsetBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof hu.modembed.model.textnotations.instructionset.ui.InstructionsetDocBrowserInformationControlInput);
		...
		fInput= (hu.modembed.model.textnotations.instructionset.ui.InstructionsetDocBrowserInformationControlInput) input;
		...
		hu.modembed.model.textnotations.instructionset.ui.InstructionsetHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = hu.modembed.model.textnotations.instructionset.ui.InstructionsetHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public hu.modembed.model.textnotations.instructionset.ui.InstructionsetDocBrowserInformationControlInput getInput() {
		return fInput;
	}
