 ...
 */
public class InstructionsetBracketSet {
	...
	private java.util.ArrayList<hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair {
	 ...
	 */
	private class ClosingListener implements hu.modembed.model.textnotations.instructionset.ui.IInstructionsetBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public InstructionsetBracketSet(hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new hu.modembed.model.textnotations.instructionset.mopp.InstructionsetMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair>();
	 ...
	 */
	public hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair getBracketPair(String opening, String closing) {
		for (hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair bracketPair : bracketPairs) {
	...
	public hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + hu.modembed.model.textnotations.instructionset.ui.InstructionsetPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair remove(String opening, String closing) {
		for (hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<hu.modembed.model.textnotations.instructionset.IInstructionsetBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, hu.modembed.model.textnotations.instructionset.ui.InstructionsetPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, hu.modembed.model.textnotations.instructionset.ui.InstructionsetPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
