...
public class InstructionsetLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(hu.modembed.model.textnotations.instructionset.mopp.InstructionsetPlugin.DEBUG_MODEL_ID);
			...
			hu.modembed.model.textnotations.instructionset.debug.InstructionsetLineBreakpoint lineBreakpoint = new hu.modembed.model.textnotations.instructionset.debug.InstructionsetLineBreakpoint(resource, lineNumber + 1);
	...
	private org.eclipse.ui.texteditor.ITextEditor getEditor(org.eclipse.ui.IWorkbenchPart part) {
		if (part instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new hu.modembed.model.textnotations.instructionset.mopp.InstructionsetMetaInformation().getSyntaxName())) {
					return editorPart;
				}
			}
		}
