 ...
 */
public class InstructionsetSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public InstructionsetSyntaxColoringPreferencePage() {
		super();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = hu.modembed.model.textnotations.instructionset.ui.InstructionsetSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.instructionset.ui.InstructionsetSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = hu.modembed.model.textnotations.instructionset.ui.InstructionsetSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.instructionset.ui.InstructionsetSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = hu.modembed.model.textnotations.instructionset.ui.InstructionsetSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.instructionset.ui.InstructionsetSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = hu.modembed.model.textnotations.instructionset.ui.InstructionsetSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.instructionset.ui.InstructionsetSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = hu.modembed.model.textnotations.instructionset.ui.InstructionsetSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.instructionset.ui.InstructionsetSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = hu.modembed.model.textnotations.instructionset.ui.InstructionsetSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hu.modembed.model.textnotations.instructionset.ui.InstructionsetSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		hu.modembed.model.textnotations.instructionset.ui.InstructionsetPixelConverter pixelConverter = new hu.modembed.model.textnotations.instructionset.ui.InstructionsetPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor) {
			hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor emfTextEditor = (hu.modembed.model.textnotations.instructionset.ui.InstructionsetEditor) editor;
