		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOperationSignatureAccess().getGroup(), "rule__OperationSignature__Group__0");
					put(grammarAccess.getOperationSignatureAccess().getGroup_3(), "rule__OperationSignature__Group_3__0");
					put(grammarAccess.getOperationSignatureAccess().getGroup_3_1(), "rule__OperationSignature__Group_3_1__0");
					...
					put(grammarAccess.getFunctionBinarySectionAccess().getGroup_20(), "rule__FunctionBinarySection__Group_20__0");
					put(grammarAccess.getFunctionBinarySectionAccess().getGroup_23(), "rule__FunctionBinarySection__Group_23__0");
					put(grammarAccess.getOptimizerCallAccess().getGroup(), "rule__OptimizerCall__Group__0");
					...
					put(grammarAccess.getXExpression3Access().getGroup_2(), "rule__XExpression3__Group_2__0");
					...
					put(grammarAccess.getOperationSignatureAccess().getNameAssignment_1(), "rule__OperationSignature__NameAssignment_1");
					put(grammarAccess.getOperationSignatureAccess().getParamsAssignment_3_0(), "rule__OperationSignature__ParamsAssignment_3_0");
					put(grammarAccess.getOperationSignatureAccess().getParamsAssignment_3_1_1(), "rule__OperationSignature__ParamsAssignment_3_1_1");
					...
					put(grammarAccess.getFunctionBinarySectionAccess().getOptimizercallsAssignment_20_0(), "rule__FunctionBinarySection__OptimizercallsAssignment_20_0");
					put(grammarAccess.getFunctionBinarySectionAccess().getLibAssignment_23_1(), "rule__FunctionBinarySection__LibAssignment_23_1");
					put(grammarAccess.getFunctionBinarySectionAccess().getDoAssignment_26(), "rule__FunctionBinarySection__DoAssignment_26");
					put(grammarAccess.getOptimizerCallAccess().getOptimizerAssignment_1(), "rule__OptimizerCall__OptimizerAssignment_1");
					...
					put(grammarAccess.getXExpression3Access().getOpAssignment_0(), "rule__XExpression3__OpAssignment_0");
					put(grammarAccess.getXExpression3Access().getAAssignment_1(), "rule__XExpression3__AAssignment_1");
					put(grammarAccess.getXExpression3Access().getOpAssignment_2_0(), "rule__XExpression3__OpAssignment_2_0");
					put(grammarAccess.getXExpression3Access().getBAssignment_2_1(), "rule__XExpression3__BAssignment_2_1");
