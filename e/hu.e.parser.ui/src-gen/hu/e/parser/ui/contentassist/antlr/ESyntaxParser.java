		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getParameterVariableAccess().getGroup_5(), "rule__ParameterVariable__Group_5__0");
					...
					put(grammarAccess.getParameterVariableAccess().getTypeAssignment_3(), "rule__ParameterVariable__TypeAssignment_3");
					put(grammarAccess.getParameterVariableAccess().getNameAssignment_4(), "rule__ParameterVariable__NameAssignment_4");
					put(grammarAccess.getParameterVariableAccess().getDefaultAssignment_5_1(), "rule__ParameterVariable__DefaultAssignment_5_1");
