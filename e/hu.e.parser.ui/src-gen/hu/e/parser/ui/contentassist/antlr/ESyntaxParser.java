		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFunctionBinarySectionAccess().getAlternatives_9(), "rule__FunctionBinarySection__Alternatives_9");
					put(grammarAccess.getFunctionBinarySectionAccess().getAlternatives_9_1_2_0(), "rule__FunctionBinarySection__Alternatives_9_1_2_0");
					...
					put(grammarAccess.getFunctionBinarySectionAccess().getGroup_6(), "rule__FunctionBinarySection__Group_6__0");
					put(grammarAccess.getFunctionBinarySectionAccess().getGroup_9_0(), "rule__FunctionBinarySection__Group_9_0__0");
					put(grammarAccess.getFunctionBinarySectionAccess().getGroup_9_1(), "rule__FunctionBinarySection__Group_9_1__0");
					put(grammarAccess.getFunctionBinarySectionAccess().getGroup_9_1_2(), "rule__FunctionBinarySection__Group_9_1_2__0");
					...
					put(grammarAccess.getFunctionBinarySectionAccess().getMemsAssignment_6_0(), "rule__FunctionBinarySection__MemsAssignment_6_0");
					put(grammarAccess.getFunctionBinarySectionAccess().getLibAssignment_9_0_1(), "rule__FunctionBinarySection__LibAssignment_9_0_1");
					put(grammarAccess.getFunctionBinarySectionAccess().getInstancesAssignment_9_1_0(), "rule__FunctionBinarySection__InstancesAssignment_9_1_0");
					put(grammarAccess.getFunctionBinarySectionAccess().getLinksAssignment_9_1_2_0_0(), "rule__FunctionBinarySection__LinksAssignment_9_1_2_0_0");
					put(grammarAccess.getFunctionBinarySectionAccess().getConfsAssignment_9_1_2_0_1(), "rule__FunctionBinarySection__ConfsAssignment_9_1_2_0_1");
					put(grammarAccess.getFunctionBinarySectionAccess().getOpinsAssignment_11(), "rule__FunctionBinarySection__OpinsAssignment_11");
					put(grammarAccess.getFunctionBinarySectionAccess().getOpAssignment_12(), "rule__FunctionBinarySection__OpAssignment_12");
