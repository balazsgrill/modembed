...
:
(
{ before(grammarAccess.getModuleAccess().getItemsClassItemParserRuleCall_5_0()); }
	ruleClassItem{ after(grammarAccess.getModuleAccess().getItemsClassItemParserRuleCall_5_0()); }
)
