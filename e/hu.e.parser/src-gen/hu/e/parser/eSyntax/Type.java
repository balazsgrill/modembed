 ...
 * <ul>
 *   <li>{@link hu.e.parser.eSyntax.Type#getName <em>Name</em>}</li>
...
public interface Type extends LibraryItem
{
   ...
   * @see #setName(String)
   * @see hu.e.parser.eSyntax.ESyntaxPackage#getType_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link hu.e.parser.eSyntax.Type#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
