 ...
 * @generated
 */
public class VariableImpl extends TopLevelItemImpl implements Variable
{
  /**
    ...
    if (type != null && type.eIsProxy())
    {
      ...
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESyntaxPackage.VARIABLE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(Type newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ESyntaxPackage.VARIABLE__TYPE, oldType, type));
  }
