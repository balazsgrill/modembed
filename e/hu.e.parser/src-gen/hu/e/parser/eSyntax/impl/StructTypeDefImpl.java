...
public class StructTypeDefImpl extends TypeDefImpl implements StructTypeDef
{
   ...
   * @ordered
   */
  protected EList<StructTypeDefMember> members;
   ...
   * @generated
   */
  public EList<StructTypeDefMember> getMembers()
  {
    if (members == null)
    {
      members = new EObjectContainmentEList<StructTypeDefMember>(StructTypeDefMember.class, this, ESyntaxPackage.STRUCT_TYPE_DEF__MEMBERS);
    }
    return members;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case ESyntaxPackage.STRUCT_TYPE_DEF__MEMBERS:
        getMembers().clear();
        getMembers().addAll((Collection<? extends StructTypeDefMember>)newValue);
        return;
    }
