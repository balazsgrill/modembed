...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Workflow Step Notation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class WorkflowStepNotationImpl extends MinimalEObjectImpl.Container implements WorkflowStepNotation
{
   ...
   * @ordered
   */
  protected EList<WorkflowStepParameterNotation> params;
   ...
   * @generated
   */
  protected WorkflowStepNotationImpl()
  {
    super();
  }
  ...
  {
    return ESyntaxPackage.Literals.WORKFLOW_STEP_NOTATION;
  }
   ...
   * @generated
   */
  public EList<WorkflowStepParameterNotation> getParams()
  {
    if (params == null)
    {
      params = new EObjectContainmentEList<WorkflowStepParameterNotation>(WorkflowStepParameterNotation.class, this, ESyntaxPackage.WORKFLOW_STEP_NOTATION__PARAMS);
    }
    return params;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case ESyntaxPackage.WORKFLOW_STEP_NOTATION__PARAMS:
        getParams().clear();
        getParams().addAll((Collection<? extends WorkflowStepParameterNotation>)newValue);
        return;
    }
