...
import instructionset.ConstantSection;
...
import instructionset.InstructionsetFactory;
import instructionset.InstructionsetPackage;
import instructionset.ParameterSection;
...
public class InstructionsetPackageImpl extends EPackageImpl implements InstructionsetPackage {
	 ...
	 * @see instructionset.InstructionsetPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getInstructionParameter_Words() {
		return (EReference)instructionParameterEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(instructionParameterEClass, INSTRUCTION_PARAMETER__WORDS);
	...
	public void initializePackageContents() {
		...
		initEReference(getInstructionParameter_Words(), this.getInstructionWord(), null, "words", null, 0, -1, InstructionParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
