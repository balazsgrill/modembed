/**
 */
package hu.modembed.assembler.code.util;
...
public class CodeAdapterFactory extends AdapterFactoryImpl {
	...
	protected CodeSwitch<Adapter> modelSwitch =
		new CodeSwitch<Adapter>() {
			...
			@Override
			public Adapter caseInstructionCallArgument(InstructionCallArgument object) {
				return createInstructionCallArgumentAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.modembed.assembler.code.AssemblerObject <em>Assembler Object</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.modembed.assembler.code.InstructionCall <em>Instruction Call</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.modembed.assembler.code.InstructionCallArgument <em>Instruction Call Argument</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createInstructionCallArgumentAdapter() {
		return null;
	}
