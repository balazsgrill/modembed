 ...
 * <ul>
 *   <li>{@link hu.cubussapiens.modembed.modularasm.modularASM.impl.FunctionImpl#getName <em>Name</em>}</li>
...
public class FunctionImpl extends ModuleItemImpl implements Function
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModularASMPackage.FUNCTION__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ModularASMPackage.FUNCTION__NAME:
        return getName();
      case ModularASMPackage.FUNCTION__STEP:
        return getStep();
    }
