...
public class ElfAdapterFactory extends AdapterFactoryImpl {
	...
	protected ElfSwitch<Adapter> modelSwitch =
		new ElfSwitch<Adapter>() {
			@Override
			public Adapter caseELF(ELF object) {
				return createELFAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link elf.ELF <em>ELF</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createELFAdapter() {
		return null;
	}
